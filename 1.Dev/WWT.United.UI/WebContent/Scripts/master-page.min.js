 ...
 * Released under the MIT license
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery"],n):typeof exports=="object"?n(require("jquery")):n(jQuery)})(function(n){function i(n){return t.raw?n:encodeURIComponent(n)}function f(n){return t.raw?n:decodeURIComponent(n)}function e(n){return i(t.json?JSON.stringify(n):String(n))}function o(n){n.indexOf('"')===0&&(n=n.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return n=decodeURIComponent(n.replace(u," ")),t.json?JSON.parse(n):n}catch(i){}}function r(i,r){var u=t.raw?i:o(i);return n.isFunction(r)?r(u):u}var u=/\+/g,t=n.cookie=function(u,o,s){var y,a,h,v,c,p;if(arguments.length>1&&!n.isFunction(o))return s=n.extend({},t.defaults,s),typeof s.expires=="number"&&(y=s.expires,a=s.expires=new Date,a.setTime(+a+y*864e5)),document.cookie=[i(u),"=",e(o),s.expires?"; expires="+s.expires.toUTCString():"",s.path?"; path="+s.path:"",s.domain?"; domain="+s.domain:"",s.secure?"; secure":""].join("");for(h=u?undefined:{},v=document.cookie?document.cookie.split("; "):[],c=0,p=v.length;c<p;c++){var w=v[c].split("="),b=f(w.shift()),l=w.join("=");if(u&&u===b){h=r(l,o);break}u||(l=r(l))===undefined||(h[b]=l)}return h};t.defaults={};n.removeCookie=function(t,i){return n.cookie(t)===undefined?!1:(n.cookie(t,"",n.extend({},i,{expires:-1})),!n.cookie(t))}}),function(n){var t=0;n.widget("ech.multiselect",{options:{header:!0,height:175,minWidth:225,classes:"",checkAllText:"Check all",uncheckAllText:"Uncheck all",noneSelectedText:"Select options",selectedText:"# selected",selectedList:0,show:null,hide:null,autoOpen:!1,multiple:!0,position:{}},_create:function(){var t=this.element.hide(),i=this.options,r;this.speed=n.fx.speeds._default;this._isOpen=!1;t=(this.button=n('<button type="button"><span class="ui-icon ui-icon-triangle-2-n-s"><\/span><\/button>')).addClass("ui-multiselect ui-widget ui-state-default ui-corner-all").addClass(i.classes).attr({title:t.attr("title"),"aria-haspopup":!0,tabIndex:t.attr("tabIndex")}).insertAfter(t);(this.buttonlabel=n("<span />")).html(i.noneSelectedText).appendTo(t);t=(this.menu=n("<div />")).addClass("ui-multiselect-menu ui-widget ui-widget-content ui-corner-all").addClass(i.classes).appendTo(document.body);r=(this.header=n("<div />")).addClass("ui-widget-header ui-corner-all ui-multiselect-header ui-helper-clearfix").appendTo(t);(this.headerLinkContainer=n("<ul />")).addClass("ui-helper-reset").html(function(){return!0===i.header?'<li><a class="ui-multiselect-all" href="#"><span class="ui-icon ui-icon-check"><\/span><span>'+i.checkAllText+'<\/span><\/a><\/li><li><a class="ui-multiselect-none" href="#"><span class="ui-icon ui-icon-closethick"><\/span><span>'+i.uncheckAllText+"<\/span><\/a><\/li>":"string"==typeof i.header?"<li>"+i.header+"<\/li>":""}).append('<li class="ui-multiselect-close"><a href="#" class="ui-multiselect-close"><span class="ui-icon ui-icon-circle-close"><\/span><\/a><\/li>').appendTo(r);(this.checkboxContainer=n("<ul />")).addClass("ui-multiselect-checkboxes ui-helper-reset").appendTo(t);this._bindEvents();this.refresh(!0);i.multiple||t.addClass("ui-multiselect-single")},_init:function(){!1===this.options.header&&this.header.hide();this.options.multiple||this.headerLinkContainer.find(".ui-multiselect-all, .ui-multiselect-none").hide();this.options.autoOpen&&this.open();this.element.is(":disabled")&&this.disable()},refresh:function(i){var u=this.element,f=this.options,s=this.menu,h=this.checkboxContainer,e=[],r="",o=u.attr("id")||t++;u.find("option").each(function(t){n(this);var u=this.parentNode,c=this.innerHTML,a=this.title,v=this.value,t="ui-multiselect-"+(this.id||o+"-option-"+t),s=this.disabled,l=this.selected,h=["ui-corner-all"],y=(s?"ui-multiselect-disabled ":" ")+this.className,i;"OPTGROUP"===u.tagName&&(i=u.getAttribute("label"),-1===n.inArray(i,e)&&(r+='<li class="ui-multiselect-optgroup-label '+u.className+'"><a href="#">'+i+"<\/a><\/li>",e.push(i)));s&&h.push("ui-state-disabled");l&&!f.multiple&&h.push("ui-state-active");r+='<li class="'+y+'">';r+='<label for="'+t+'" title="'+a+'" class="'+h.join(" ")+'">';r+='<input id="'+t+'" name="multiselect_'+o+'" type="'+(f.multiple?"checkbox":"radio")+'" value="'+v+'" title="'+c+'"';l&&(r+=' checked="checked"',r+=' aria-selected="true"');s&&(r+=' disabled="disabled"',r+=' aria-disabled="true"');r+=" /><span>"+c+"<\/span><\/label><\/li>"});h.html(r);this.labels=s.find("label");this.inputs=this.labels.children("input");this._setButtonWidth();this._setMenuWidth();this.button[0].defaultValue=this.update();i||this._trigger("refresh")},update:function(){var t=this.options,r=this.inputs,u=r.filter(":checked"),i=u.length,t=0===i?t.noneSelectedText:n.isFunction(t.selectedText)?t.selectedText.call(this,i,r.length,u.get()):/\d/.test(t.selectedList)&&0<t.selectedList&&i<=t.selectedList?u.map(function(){return n(this).next().html()}).get().join(", "):t.selectedText.replace("#",i).replace("#",r.length);return this.buttonlabel.html(t),t},_bindEvents:function(){function r(){return t[t._isOpen?"close":"open"](),!1}var t=this,i=this.button;i.find("span").bind("click.multiselect",r);i.bind({click:r,keypress:function(n){switch(n.which){case 27:case 38:case 37:t.close();break;case 39:case 40:t.open()}},mouseenter:function(){i.hasClass("ui-state-disabled")||n(this).addClass("ui-state-hover")},mouseleave:function(){n(this).removeClass("ui-state-hover")},focus:function(){i.hasClass("ui-state-disabled")||n(this).addClass("ui-state-focus")},blur:function(){n(this).removeClass("ui-state-focus")}});this.header.delegate("a","click.multiselect",function(i){n(this).hasClass("ui-multiselect-close")?t.close():t[n(this).hasClass("ui-multiselect-all")?"checkAll":"uncheckAll"]();i.preventDefault()});this.menu.delegate("li.ui-multiselect-optgroup-label a","click.multiselect",function(i){i.preventDefault();var r=n(this),u=r.parent().nextUntil("li.ui-multiselect-optgroup-label").find("input:visible:not(:disabled)"),f=u.get(),r=r.parent().text();!1!==t._trigger("beforeoptgrouptoggle",i,{inputs:f,label:r})&&(t._toggleChecked(u.filter(":checked").length!==u.length,u),t._trigger("optgrouptoggle",i,{inputs:f,label:r,checked:f[0].checked}))}).delegate("label","mouseenter.multiselect",function(){n(this).hasClass("ui-state-disabled")||(t.labels.removeClass("ui-state-hover"),n(this).addClass("ui-state-hover").find("input").focus())}).delegate("label","keydown.multiselect",function(i){i.preventDefault();switch(i.which){case 9:case 27:t.close();break;case 38:case 40:case 37:case 39:t._traverse(i.which,this);break;case 13:n(this).find("input")[0].click()}}).delegate('input[type="checkbox"], input[type="radio"]',"click.multiselect",function(i){var u=n(this),f=this.value,r=this.checked,e=t.element.find("option");this.disabled||!1===t._trigger("click",i,{value:f,text:this.title,checked:r})?i.preventDefault():(u.focus(),u.attr("aria-selected",r),e.each(function(){this.value===f?this.selected=r:t.options.multiple||(this.selected=!1)}),t.options.multiple||(t.labels.removeClass("ui-state-active"),u.closest("label").toggleClass("ui-state-active",r),t.close()),t.element.trigger("change"),setTimeout(n.proxy(t.update,t),10))});n(document).bind("mousedown.multiselect",function(i){!t._isOpen||n.contains(t.menu[0],i.target)||n.contains(t.button[0],i.target)||i.target===t.button[0]||t.close()});n(this.element[0].form).bind("reset.multiselect",function(){setTimeout(n.proxy(t.refresh,t),10)})},_setButtonWidth:function(){var n=this.element.outerWidth(),t=this.options;/\d/.test(t.minWidth)&&n<t.minWidth&&(n=t.minWidth);this.button.width(n)},_setMenuWidth:function(){var n=this.menu,t=this.button.outerWidth()-parseInt(n.css("padding-left"),10)-parseInt(n.css("padding-right"),10)-parseInt(n.css("border-right-width"),10)-parseInt(n.css("border-left-width"),10);n.width(t||this.button.outerWidth())},_traverse:function(t,i){var r=n(i),u=38===t||37===t,r=r.parent()[u?"prevAll":"nextAll"]("li:not(.ui-multiselect-disabled, .ui-multiselect-optgroup-label)")[u?"last":"first"]();r.length?r.find("label").trigger("mouseover"):(r=this.menu.find("ul").last(),this.menu.find("label")[u?"last":"first"]().trigger("mouseover"),r.scrollTop(u?r.height():0))},_toggleState:function(n,t){return function(){this.disabled||(this[n]=t);t?this.setAttribute("aria-selected",!0):this.removeAttribute("aria-selected")}},_toggleChecked:function(t,i){var r=i&&i.length?i:this.inputs,f=this,u;r.each(this._toggleState("checked",t));r.eq(0).focus();this.update();u=r.map(function(){return this.value}).get();this.element.find("option").each(function(){!this.disabled&&-1<n.inArray(this.value,u)&&f._toggleState("selected",t).call(this)});r.length&&this.element.trigger("change")},_toggleDisabled:function(t){this.button.attr({disabled:t,"aria-disabled":t})[t?"addClass":"removeClass"]("ui-state-disabled");var i=this.menu.find("input"),i=t?i.filter(":enabled").data("ech-multiselect-disabled",!0):i.filter(function(){return!0===n.data(this,"ech-multiselect-disabled")}).removeData("ech-multiselect-disabled");i.attr({disabled:t,"arial-disabled":t}).parent()[t?"addClass":"removeClass"]("ui-state-disabled");this.element.attr({disabled:t,"aria-disabled":t})},open:function(){var i=this.button,r=this.menu,f=this.speed,t=this.options,e=[];if(!(!1===this._trigger("beforeopen")||i.hasClass("ui-state-disabled")||this._isOpen)){var s=r.find("ul").last(),u=t.show,o=i.offset();n.isArray(t.show)&&(u=t.show[0],f=t.show[1]||this.speed);u&&(e=[u,f]);s.scrollTop(0).height(t.height);n.ui.position&&!n.isEmptyObject(t.position)?(t.position.of=t.position.of||i,r.show().position(t.position).hide()):r.css({top:o.top+i.outerHeight(),left:o.left});n.fn.show.apply(r,e);this.labels.eq(0).trigger("mouseover").trigger("mouseenter").find("input").trigger("focus");i.addClass("ui-state-active");this._isOpen=!0;this._trigger("open")}},close:function(){if(!1!==this._trigger("beforeclose")){var t=this.options,i=t.hide,r=this.speed,u=[];n.isArray(t.hide)&&(i=t.hide[0],r=t.hide[1]||this.speed);i&&(u=[i,r]);n.fn.hide.apply(this.menu,u);this.button.removeClass("ui-state-active").trigger("blur").trigger("mouseleave");this._isOpen=!1;this._trigger("close")}},enable:function(){this._toggleDisabled(!1)},disable:function(){this._toggleDisabled(!0)},checkAll:function(){this._toggleChecked(!0);this._trigger("checkAll")},uncheckAll:function(){this._toggleChecked(!1);this._trigger("uncheckAll")},getChecked:function(){return this.menu.find("input").filter(":checked")},destroy:function(){return n.Widget.prototype.destroy.call(this),this.button.remove(),this.menu.remove(),this.element.show(),this},isOpen:function(){return this._isOpen},widget:function(){return this.menu},getButton:function(){return this.button},_setOption:function(t,i){var r=this.menu;switch(t){case"header":r.find("div.ui-multiselect-header")[i?"show":"hide"]();break;case"checkAllText":r.find("a.ui-multiselect-all span").eq(-1).text(i);break;case"uncheckAllText":r.find("a.ui-multiselect-none span").eq(-1).text(i);break;case"height":r.find("ul").last().height(parseInt(i,10));break;case"minWidth":this.options[t]=parseInt(i,10);this._setButtonWidth();this._setMenuWidth();break;case"selectedText":case"selectedList":case"noneSelectedText":this.options[t]=i;this.update();break;case"classes":r.add(this.button).removeClass(this.options.classes).addClass(i);break;case"multiple":r.toggleClass("ui-multiselect-single",!i);this.options.multiple=i;this.element[0].multiple=i;this.refresh()}n.Widget.prototype._setOption.apply(this,arguments)}})}(jQuery),function(n){"use strict";function ut(t,i){var f="",u,s=null,o,h,l,a,v=i.Obj.data("SPCascadeDropdownsChildColumns");n(v).each(function(){var t=this.opt,v=this.childSelect,b=this.childColumnStatic,p=this.childColumnRequired,w,k,y,d;if(u=wt(i,t.matchOnId),w=u.join(";#"),i.Obj.data("SPCascadeDropdown_Selected_"+b)!==w){if(i.Obj.data("SPCascadeDropdown_Selected_"+b,w),s=wt(v,!0),k=t.relationshipListSortColumn.length>0?t.relationshipListSortColumn:t.relationshipListChildColumn,y="<Query><OrderBy><FieldRef Name='"+k+"'/><\/OrderBy><Where><And>",t.CAMLQuery.length>0&&(y+="<And>"),u.length===0)y+="<Eq><FieldRef Name='"+t.relationshipListParentColumn+"'/><Value Type='Text'><\/Value><\/Eq>";else if(u.length===1)y+="<Eq><FieldRef Name='"+t.relationshipListParentColumn+(t.matchOnId?"' LookupId='True'/><Value Type='Integer'>":"'/><Value Type='Text'>")+ft(u[0])+"<\/Value><\/Eq>";else{for(d=u.length>2?!0:!1,r=0;r<u.length-1;r++)y+="<Or>";for(r=0;r<u.length;r++)y+="<Eq><FieldRef Name='"+t.relationshipListParentColumn+(t.matchOnId?"' LookupId='True'/><Value Type='Integer'>":"'/><Value Type='Text'>")+ft(u[r])+"<\/Value><\/Eq>",r>0&&r<u.length-1&&d&&(y+="<\/Or>");y+="<\/Or>"}t.CAMLQuery.length>0&&(y+=t.CAMLQuery+"<\/And>");y+="<IsNotNull><FieldRef Name='"+t.relationshipListChildColumn+"' /><\/IsNotNull>";y+="<\/And><\/Where><\/Query>";n().SPServices({operation:"GetListItems",async:!1,webURL:t.relationshipWebURL,listName:t.relationshipList,CAMLQuery:y,CAMLViewFields:"<ViewFields><FieldRef Name='"+t.relationshipListParentColumn+"' /><FieldRef Name='"+t.relationshipListChildColumn+"' /><\/ViewFields>",CAMLRowLimit:0,CAMLQueryOptions:t.CAMLQueryOptions,completefunc:function(i){n(i.responseXML).find("errorstring").each(function(){var i="SPServices.SPCascadeDropdowns",r=n(this).text();t.debug&&r==="One or more field types are not installed properly. Go to the list settings page to delete these fields."?c(i,"relationshipListParentColumn: "+t.relationshipListParentColumn+" or relationshipListChildColumn: "+t.relationshipListChildColumn,"Not found in relationshipList "+t.relationshipList):t.debug&&r==="Guid should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx)."&&c(i,"relationshipList: "+t.relationshipList,"List not found");return});switch(v.Type){case e.simple:n(v.Obj).find("option").remove();!p&&t.promptText.length>0?v.Obj.append("<option value='0'>"+t.promptText.replace(/\{0\}/g,t.childColumn)+"<\/option>"):p||v.Obj.append("<option value='0'>"+t.noneText+"<\/option>");break;case e.complex:f=p?"":t.noneText+"|0";v.Obj.val("");break;case e.multiSelect:n(v.master.candidateControl).find("option").remove();o=""}h=parseFloat(n(i.responseXML).SPFilterNode("rs:data").attr("ItemCount"));n(i.responseXML).SPFilterNode("z:row").each(function(){var i={},r=n(this).attr("ows_"+t.relationshipListChildColumn),u;typeof r!="undefined"&&r.indexOf(";#")>0?i=new kt(r):(i.id=n(this).attr("ows_ID"),i.value=r);isNaN(i.id)&&(i.id=n(this).attr("ows_ID"));l=i.id;a=i.value;switch(v.Type){case e.simple:u=n(this).attr("ows_ID")===s[0]?" selected='selected'":"";v.Obj.append("<option"+u+" value='"+i.id+"'>"+i.value+"<\/option>");break;case e.complex:i.id===s[0]&&v.Obj.val(i.value);f=f+(f.length>0?"|":"")+i.value+"|"+i.id;break;case e.multiSelect:n(v.master.candidateControl).append("<option value='"+i.id+"'>"+i.value+"<\/option>");o+=i.id+"|t"+i.value+"|t |t |t"}});switch(v.Type){case e.simple:v.Obj.trigger("change");h===1&&t.selectSingleOption===!0&&n(v.Obj).find("option[value!='0']:first").attr("selected","selected");break;case e.complex:v.Obj.attr("choices",f);h===1&&t.selectSingleOption===!0&&(n(v.Obj).val(a),v.optHid.val(l));v.Obj.val()===""&&v.optHid.val("");break;case e.multiSelect:v.master.data="";v.MultiLookupPickerdata.val(o);n(v.master.resultControl).find("option").each(function(){var t=n(this);t.prop("selected",!0);n(v.master.candidateControl).find("option[value='"+t.val()+"']").each(function(){t.prop("selected",!1)})});GipRemoveSelectedItems(v.master);n(v.master.candidateControl).find("option").each(function(){var t=n(this);n(v.master.resultControl).find("option[value='"+t.val()+"']").each(function(){t.remove()})});GipAddSelectedItems(v.master);v.master.data=GipGetGroupData(o);n(v.master.candidateControl).trigger("dblclick")}}});t.completefunc!==null&&t.completefunc()}})}function ti(t,i,u,f){var o=null,l="SPServices.SPDisplayRelatedInfo",h=n().SPServices.SPDropdownCtl({displayName:t.columnName}),s,v,a;if((o=wt(h,t.matchOnId),h.Type!==e.complex||!(t.numChars>0)||!(o[0].length<t.numChars))&&h.Obj.attr("showRelatedSelected")!==o[0]){for(h.Obj.attr("showRelatedSelected",o[0]),n("#"+i).remove(),h.Obj.parent().append("<div id="+i+"><\/div>"),s="<Query><Where>",t.CAMLQuery.length>0&&(s+="<And>"),v=f[t.relatedListColumn].attr("Type"),s+=v==="Lookup"?"<Eq><FieldRef Name='"+t.relatedListColumn+(t.matchOnId?"' LookupId='True'/><Value Type='Integer'>":"'/><Value Type='Text'>")+ft(o[0])+"<\/Value><\/Eq>":"<Eq><FieldRef Name='"+(t.matchOnId?"ID' /><Value Type='Counter'>":t.relatedListColumn+"'/><Value Type='Text'>")+ft(o[0])+"<\/Value><\/Eq>",t.CAMLQuery.length>0&&(s+=t.CAMLQuery+"<\/And>"),s+="<\/Where><\/Query>",a=" ",r=0;r<t.relatedColumns.length;r++)a+="<FieldRef Name='"+t.relatedColumns[r]+"' />";n().SPServices({operation:"GetListItems",async:!1,webURL:t.relatedWebURL,listName:t.relatedList,CAMLQuery:s,CAMLViewFields:"<ViewFields>"+a+"<\/ViewFields>",CAMLRowLimit:0,completefunc:function(e){n(e.responseXML).find("errorstring").each(function(){var i=n(this).text();t.debug&&i==="One or more field types are not installed properly. Go to the list settings page to delete these fields."?c(l,"relatedListColumn: "+t.relatedListColumn,"Column not found in relatedList "+t.relatedList):t.debug&&i==="Guid should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx)."&&c(l,"relatedList: "+t.relatedList,"List not found");return});var o;switch(t.displayFormat){case"table":for(o="<table>",o+="<tr>",r=0;r<t.relatedColumns.length;r++){if(typeof f[t.relatedColumns[r]]=="undefined"&&t.debug){c(l,"columnName: "+t.relatedColumns[r],"Column not found in relatedList");return}o+="<th class='"+t.headerCSSClass+"'>"+f[t.relatedColumns[r]].attr("DisplayName")+"<\/th>"}o+="<\/tr>";n(e.responseXML).SPFilterNode("z:row").each(function(){for(o+="<tr>",r=0;r<t.relatedColumns.length;r++)o+="<td class='"+t.rowCSSClass+"'>"+ki(u,f[t.relatedColumns[r]],n(this).attr("ows_"+t.relatedColumns[r]),t)+"<\/td>";o+="<\/tr>"});o+="<\/table>";break;case"list":o="<table>";n(e.responseXML).SPFilterNode("z:row").each(function(){for(r=0;r<t.relatedColumns.length;r++){if(typeof f[t.relatedColumns[r]]=="undefined"&&t.debug){c(l,"columnName: "+t.relatedColumns[r],"Column not found in relatedList");return}o+="<tr>";o+="<th class='"+t.headerCSSClass+"'>"+f[t.relatedColumns[r]].attr("DisplayName")+"<\/th>";o+="<td class='"+t.rowCSSClass+"'>"+ki(u,f[t.relatedColumns[r]],n(this).attr("ows_"+t.relatedColumns[r]),t)+"<\/td>";o+="<\/tr>"}});o+="<\/table>"}n("#"+i).html(o)}});t.completefunc!==null&&t.completefunc()}}function pt(t,i,r,u,f){var o=0,h=0,e={},s;e.type=[];e.src=[];e.script=[];s=RegExp("<script[\\s\\S]*?/script>","gi");n.ajax({type:"GET",url:f,dataType:"text",async:!1,success:function(c){for(var v,w,a,b;v=s.exec(c);){var p=ii(v,"language"),k=ii(v,"type"),y=ii(v,"src");y!==null&&y.length>0&&!ur(y)&&(e.type.push(p!==null&&p.length>0?p:k),e.src.push(y),h++)}if(!t.showNoScript&&e.type.length>0||t.showNoScript){if(w=f.substring(0,f.lastIndexOf(l)+1),a="<tr class=ms-alternating><td class=ms-vb-icon><a href='"+i.attr("DefaultViewUrl")+"'><IMG border=0 src='"+i.attr("ImageUrl")+"'width=16 height=16><\/A><\/TD><td class=ms-vb2><a href='"+i.attr("DefaultViewUrl")+"'>"+i.attr("Title")+(i.attr("Hidden")==="True"?"(Hidden)":"")+"<\/td><td class=ms-vb2>"+r+"<\/td><td class=ms-vb2>"+u+"<\/td><td class=ms-vb2><a href='"+f+"'>"+st(f)+"<\/td>",t.showSrc){for(a+="<td valign='top'><table width='100%' style='border-collapse: collapse;' border=0 cellSpacing=0 cellPadding=1>",o=0;o<e.type.length;o++)b=e.src[o].substr(0,1)!==l?w+e.src[o]:e.src[o],a+="<tr><td class=ms-vb2 width='30%'>"+e.type[o]+"<\/td>",a+="<td class=ms-vb2 width='70%'><a href='"+b+"'>"+st(e.src[o])+"<\/td><\/tr>";a+="<\/table><\/td>"}n("#SPScriptAudit").append(a)}}})}function ii(n,t){var i,r=RegExp(t+"=(\"([^\"]*)\")|('([^']*)')","gi");return(i=r.exec(n))?i[2]:null}function ur(n){for(var i=["WebResource.axd","_layouts"],t=0;t<i.length;t++)if(n.indexOf(i[t])>-1)return!0;return!1}function yi(n,t){var i;switch(t){case"Text":i=pi(n);break;case"DateTime":case"datetime":i=or(n);break;case"User":i=bi(n);break;case"UserMulti":i=sr(n);break;case"Lookup":i=ri(n);break;case"LookupMulti":i=hr(n);break;case"Boolean":i=er(n);break;case"Integer":i=wi(n);break;case"Counter":i=wi(n);break;case"MultiChoice":i=cr(n);break;case"Number":case"Currency":case"float":i=fr(n);break;case"Calculated":i=lr(n);break;case"Attachments":i=ri(n);break;case"JSON":i=ar(n);break;default:i=pi(n)}return i}function pi(n){return n}function wi(n){return parseInt(n,10)}function fr(n){return parseFloat(n)}function er(n){return n==="0"?!1:!0}function or(n){var r=n.split("T")[0]!==n?n.split("T"):n.split(" "),t=r[0].split("-"),i=r[1].split(":"),u=i[2].split("Z");return new Date(t[0],t[1]-1,t[2],i[0],i[1],u[0])}function bi(n){if(n.length===0)return null;var i=new kt(n),t=i.value.split(",#");return t.length===1?{userId:i.id,userName:i.value}:{userId:i.id,userName:t[0].replace(/(,,)/g,","),loginName:t[1].replace(/(,,)/g,","),email:t[2].replace(/(,,)/g,","),sipAddress:t[3].replace(/(,,)/g,","),title:t[4].replace(/(,,)/g,",")}}function sr(n){var i,t,u;if(n.length===0)return null;for(i=[],t=n.split(";#"),r=0;r<t.length;r=r+2)u=bi(t[r]+";#"+t[r+1]),i.push(u);return i}function ri(n){if(n.length===0)return null;var t=new kt(n);return{lookupId:t.id,lookupValue:t.value}}function hr(n){var i,t,u;if(n.length===0)return null;for(i=[],t=n.split(";#"),r=0;r<t.length;r=r+2)u=ri(t[r]+";#"+t[r+1]),i.push(u);return i}function cr(n){if(n.length===0)return null;var i=[],t=n.split(";#");for(r=0;r<t.length;r++)t[r].length!==0&&i.push(t[r]);return i}function lr(n){if(n.length===0)return null;var t=n.split(";#");return yi(t[1],t[0])}function ar(t){return t.length===0?null:n.parseJSON(t)}function vr(){typeof _spPageContextInfo!="undefined"?(this.thisSite=_spPageContextInfo.webServerRelativeUrl,this.thisList=_spPageContextInfo.pageListId,this.thisUserId=_spPageContextInfo.userId):(this.thisSite=typeof L_Menu_BaseUrl!="undefined"?L_Menu_BaseUrl:"",this.thisList="",this.thisUserId=typeof _spUserId!="undefined"?_spUserId:undefined)}function ki(t,i,r,u){var c,v,a;if(typeof r=="undefined")return"";var e,f="",o,s,h=[],y=u.relatedWebURL.length>0?u.relatedWebURL:n().SPServices.SPGetCurrentSite();switch(i.attr("Type")){case"Text":f=r;break;case"URL":switch(i.attr("Format")){case"Hyperlink":f="<a href='"+r.substring(0,r.search(","))+"'>"+r.substring(r.search(",")+1)+"<\/a>";break;case"Image":f="<img alt='"+r.substring(r.search(",")+1)+"' src='"+r.substring(0,r.search(","))+"'/>";break;default:f=r}break;case"User":case"UserMulti":for(c=r.split(";#"),e=0;e<c.length;e=e+2)h.push("<a href='/_layouts/userdisp.aspx?ID="+c[e]+"&Source="+ct(location.href)+"'>"+c[e+1]+"<\/a>");f=h.join(", ");break;case"Calculated":v=r.split(";#");f=v[1];break;case"Number":s=i.attr("Decimals");f=typeof s=="undefined"?parseFloat(r).toString():parseFloat(r).toFixed(s).toString();break;case"Currency":s=i.attr("Decimals");f=typeof s=="undefined"?parseFloat(r).toFixed(2).toString():parseFloat(r).toFixed(s).toString();break;case"Lookup":switch(i.attr("Name")){case"FileRef":o=t.attr("BaseType")==="1"?t.attr("RootFolder")+l+"Forms/DispForm.aspx":t.attr("RootFolder")+l+"DispForm.aspx";f="<a href='"+o+"?ID="+r.substring(0,r.search(";#"))+"&RootFolder=*&Source="+ct(location.href)+"'>"+r.substring(r.search(";#")+2)+"<\/a>";break;case"FileDirRef":o=l+r.substring(r.search(";#")+2);f="<a href='"+o+"'>"+r.substring(r.search(";#")+2)+"<\/a>";break;default:o=ui(i.attr("List"),"DisplayForm");f="<a href='"+u.relatedWebURL+l+o+"?ID="+r.substring(0,r.search(";#"))+"&RootFolder=*&Source="+ct(location.href)+"'>"+r.substring(r.search(";#")+2)+"<\/a>"}break;case"LookupMulti":if(o=ui(i.attr("List"),"DisplayForm"),f="",r.length>0)for(a=r.split(";#"),e=0;e<a.length/2;e++)h.push("<a href='"+y+l+o+"?ID="+a[e*2]+"&RootFolder=*&Source="+ct(location.href)+"'>"+a[e*2+1]+"<\/a>");f=h.join(", ");break;case"File":st=r.substring(r.search(";#")+2);f="<a href='"+t.attr("RootFolder")+l+st+"'>"+st+"<\/a>";break;case"Counter":f=r;break;case"DateTime":f=r;break;default:f=r}return f}function di(n){for(var i="<table class='ms-vb' width='100%'>",t=0;t<n.attributes.length;t++)i+="<tr><td width='10px' style='font-weight:bold;'>"+t+"<\/td><td width='100px'>"+n.attributes.item(t).nodeName+"<\/td><td>"+fi(n.attributes.item(t).nodeValue)+"<\/td><\/tr>";return i+"<\/table>"}function wt(t,i){var r=[];switch(t.Type){case e.simple:i?r.push(t.Obj.find("option:selected").val()||[]):r.push(t.Obj.find("option:selected").text()||[]);break;case e.complex:i?r.push(t.optHid.val()||[]):r.push(t.Obj.val()||[]);break;case e.multiSelect:n(t.master.resultControl).find("option").each(function(){i?r.push(n(this).val()):r.push(n(this).html())})}return r}function c(n,t,i){var r="<b>Error in function<\/b><br/>"+n+"<br/><b>Parameter<\/b><br/>"+t+"<br/><b>Message<\/b><br/>"+i+"<br/><br/><span onmouseover='this.style.cursor=\"hand\";' onmouseout='this.style.cursor=\"inherit\";' style='width=100%;text-align:right;'>Click to continue<\/span><\/div>";yr(r)}function yr(t){n("#aspnetForm").parent().append("<div id='SPServices_msgBox' style=position:absolute;width:300px;height:150px;padding:10px;background-color:#000000;color:#ffffff;z-index:30;font-family:'Arial';font-size:12px;display:none;>"+t);var i=n("#SPServices_msgBox").height(),r=n("#SPServices_msgBox").width(),u=n(window).width()/2-r/2+"px",f=n(window).height()/2-i/2-100+"px";n("#SPServices_msgBox").css({border:"5px #C02000 solid",left:u,top:f}).show().fadeTo("slow",.75).click(function(){n(this).fadeOut("3000",function(){n(this).remove()})})}function bt(t,i){return t+"_"+n().SPServices.SPGetStaticFromDisplay({listName:n().SPServices.SPListNameFromUrl(),columnDisplayName:i})}function ui(t,i){var r;return n().SPServices({operation:"GetFormCollection",async:!1,listName:t,completefunc:function(t){r=n(t.responseXML).find("Form[Type='"+i+"']").attr("Url")}}),r}function i(t,i){for(var r=0;r<i.length;r++)typeof i[r]=="string"?u.payload+=w(i[r],t[i[r]]):n.isArray(i[r])&&i[r].length===2?u.payload+=w(i[r][0],t[i[r][1]]):typeof i[r]=="object"&&i[r].sendNull!==undefined?u.payload+=t[i[r].name]===undefined||t[i[r].name].length===0?"":w(i[r].name,t[i[r].name]):c(t.operation,"paramArray["+r+"]: "+i[r],"Invalid paramArray element passed to addToPayload()")}function gi(t){var i,r=RegExp('FieldName="'+t.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")+'"',"gi");return n("td.ms-formbody, td.ms-formbodysurvey").each(function(){if(r.test(n(this).html()))return i=n(this),!1}),i}function ot(n,t){var i=t.substring(8);return n.opheader=n.opheader.replace(t,i),n.opfooter=n.opfooter.replace(t,i),n}function w(n,t){var i=typeof t!="undefined"?t:"";return"<"+n+">"+i+"<\/"+n+">"}function pr(){return Math.round(Math.random())-.5}function fi(n){return n.indexOf("http")===0||n.indexOf(l)===0?"<a href='"+n+"'>"+n+"<\/a>":n}function st(n){return n.substring(n.lastIndexOf(l)+1,n.length)}function ht(n){return n.replace(/([\&"<>])/g,function(n,t){return nr[t]})}function ft(n){return typeof n=="string"?n.replace(/&(?![a-zA-Z]{1,8};)/g,"&amp;"):n}function ct(n){return n.replace(/&/g,"%26")}function kt(n){var t=n.split(";#");this.id=t[0];this.value=t[1]}function lt(n){return n<10?"0"+n:n}var ir="2014.01",l="/",d="Column not found on page",y="http://schemas.microsoft.com/sharepoint",ei="MultiLookupPicker",oi="MultiLookup",e={simple:"S",complex:"C",multiSelect:"M"},rr=["Text","DateTime","datetime","User","UserMulti","Lookup","LookupMulti","Boolean","Integer","Counter","MultiChoice","Currency","float","Calc","Attachments","Calculated","ContentTypeId","Note","URL","Number","Choice","ModStat","Guid","File"],dt={},gt="Alerts",si="Authentication",ni="Copy",hi="Forms",h="Lists",et="Meetings",ci="People",g="Permissions",li="PublishedLinksService",b="Search",ai="SharePointDiagnostics",nt="SiteData",at="Sites",o="SocialDataService",vi="SpellCheck",tt="TaxonomyClientService",f="usergroup",s="UserProfileService",vt="Versions",it="Views",rt="WebPartPages",p="Webs",k="Workflow",v=new vr,r=0,yt=["listName","description"],t=[],u,a,nr,tr;t.GetAlerts=[gt,!1];t.DeleteAlerts=[gt,!0];t.Mode=[si,!1];t.Login=[si,!1];t.CopyIntoItems=[ni,!0];t.CopyIntoItemsLocal=[ni,!0];t.GetItem=[ni,!1];t.GetForm=[hi,!1];t.GetFormCollection=[hi,!1];t.AddAttachment=[h,!0];t.AddDiscussionBoardItem=[h,!0];t.AddList=[h,!0];t.AddListFromFeature=[h,!0];t.ApplyContentTypeToList=[h,!0];t.CheckInFile=[h,!0];t.CheckOutFile=[h,!0];t.CreateContentType=[h,!0];t.DeleteAttachment=[h,!0];t.DeleteContentType=[h,!0];t.DeleteContentTypeXmlDocument=[h,!0];t.DeleteList=[h,!0];t.GetAttachmentCollection=[h,!1];t.GetList=[h,!1];t.GetListAndView=[h,!1];t.GetListCollection=[h,!1];t.GetListContentType=[h,!1];t.GetListContentTypes=[h,!1];t.GetListItemChanges=[h,!1];t.GetListItemChangesSinceToken=[h,!1];t.GetListItems=[h,!1];t.GetVersionCollection=[h,!1];t.UndoCheckOut=[h,!0];t.UpdateContentType=[h,!0];t.UpdateContentTypesXmlDocument=[h,!0];t.UpdateContentTypeXmlDocument=[h,!0];t.UpdateList=[h,!0];t.UpdateListItems=[h,!0];t.AddMeeting=[et,!0];t.CreateWorkspace=[et,!0];t.RemoveMeeting=[et,!0];t.SetWorkSpaceTitle=[et,!0];t.ResolvePrincipals=[ci,!1];t.SearchPrincipals=[ci,!1];t.AddPermission=[g,!0];t.AddPermissionCollection=[g,!0];t.GetPermissionCollection=[g,!0];t.RemovePermission=[g,!0];t.RemovePermissionCollection=[g,!0];t.UpdatePermission=[g,!0];t.GetLinks=[li,!0];t.GetPortalSearchInfo=[b,!1];t.GetQuerySuggestions=[b,!1];t.GetSearchMetadata=[b,!1];t.Query=[b,!1];t.QueryEx=[b,!1];t.Registration=[b,!1];t.Status=[b,!1];t.SendClientScriptErrorReport=[ai,!0];t.GetAttachments=[nt,!1];t.EnumerateFolder=[nt,!1];t.SiteDataGetList=[nt,!1];t.SiteDataGetListCollection=[nt,!1];t.SiteDataGetSite=[nt,!1];t.SiteDataGetSiteUrl=[nt,!1];t.SiteDataGetWeb=[nt,!1];t.CreateWeb=[at,!0];t.DeleteWeb=[at,!0];t.GetSite=[at,!1];t.GetSiteTemplates=[at,!1];t.AddComment=[o,!0];t.AddTag=[o,!0];t.AddTagByKeyword=[o,!0];t.CountCommentsOfUser=[o,!1];t.CountCommentsOfUserOnUrl=[o,!1];t.CountCommentsOnUrl=[o,!1];t.CountRatingsOnUrl=[o,!1];t.CountTagsOfUser=[o,!1];t.DeleteComment=[o,!0];t.DeleteRating=[o,!0];t.DeleteTag=[o,!0];t.DeleteTagByKeyword=[o,!0];t.DeleteTags=[o,!0];t.GetAllTagTerms=[o,!1];t.GetAllTagTermsForUrlFolder=[o,!1];t.GetAllTagUrls=[o,!1];t.GetAllTagUrlsByKeyword=[o,!1];t.GetCommentsOfUser=[o,!1];t.GetCommentsOfUserOnUrl=[o,!1];t.GetCommentsOnUrl=[o,!1];t.GetRatingAverageOnUrl=[o,!1];t.GetRatingOfUserOnUrl=[o,!1];t.GetRatingOnUrl=[o,!1];t.GetRatingsOfUser=[o,!1];t.GetRatingsOnUrl=[o,!1];t.GetSocialDataForFullReplication=[o,!1];t.GetTags=[o,!0];t.GetTagsOfUser=[o,!0];t.GetTagTerms=[o,!0];t.GetTagTermsOfUser=[o,!0];t.GetTagTermsOnUrl=[o,!0];t.GetTagUrlsOfUser=[o,!0];t.GetTagUrlsOfUserByKeyword=[o,!0];t.GetTagUrls=[o,!0];t.GetTagUrlsByKeyword=[o,!0];t.SetRating=[o,!0];t.UpdateComment=[o,!0];t.SpellCheck=[vi,!1];t.AddTerms=[tt,!0];t.GetChildTermsInTerm=[tt,!1];t.GetChildTermsInTermSet=[tt,!1];t.GetKeywordTermsByGuids=[tt,!1];t.GetTermsByLabel=[tt,!1];t.GetTermSets=[tt,!1];t.AddGroup=[f,!0];t.AddGroupToRole=[f,!0];t.AddRole=[f,!0];t.AddRoleDef=[f,!0];t.AddUserCollectionToGroup=[f,!0];t.AddUserCollectionToRole=[f,!0];t.AddUserToGroup=[f,!0];t.AddUserToRole=[f,!0];t.GetAllUserCollectionFromWeb=[f,!1];t.GetGroupCollection=[f,!1];t.GetGroupCollectionFromRole=[f,!1];t.GetGroupCollectionFromSite=[f,!1];t.GetGroupCollectionFromUser=[f,!1];t.GetGroupCollectionFromWeb=[f,!1];t.GetGroupInfo=[f,!1];t.GetRoleCollection=[f,!1];t.GetRoleCollectionFromGroup=[f,!1];t.GetRoleCollectionFromUser=[f,!1];t.GetRoleCollectionFromWeb=[f,!1];t.GetRoleInfo=[f,!1];t.GetRolesAndPermissionsForCurrentUser=[f,!1];t.GetRolesAndPermissionsForSite=[f,!1];t.GetUserCollection=[f,!1];t.GetUserCollectionFromGroup=[f,!1];t.GetUserCollectionFromRole=[f,!1];t.GetUserCollectionFromSite=[f,!1];t.GetUserCollectionFromWeb=[f,!1];t.GetUserInfo=[f,!1];t.GetUserLoginFromEmail=[f,!1];t.RemoveGroup=[f,!0];t.RemoveGroupFromRole=[f,!0];t.RemoveRole=[f,!0];t.RemoveUserCollectionFromGroup=[f,!0];t.RemoveUserCollectionFromRole=[f,!0];t.RemoveUserCollectionFromSite=[f,!0];t.RemoveUserFromGroup=[f,!0];t.RemoveUserFromRole=[f,!0];t.RemoveUserFromSite=[f,!0];t.RemoveUserFromWeb=[f,!0];t.UpdateGroupInfo=[f,!0];t.UpdateRoleDefInfo=[f,!0];t.UpdateRoleInfo=[f,!0];t.UpdateUserInfo=[f,!0];t.AddColleague=[s,!0];t.AddLink=[s,!0];t.AddMembership=[s,!0];t.AddPinnedLink=[s,!0];t.CreateMemberGroup=[s,!0];t.CreateUserProfileByAccountName=[s,!0];t.GetCommonColleagues=[s,!1];t.GetCommonManager=[s,!1];t.GetCommonMemberships=[s,!1];t.GetInCommon=[s,!1];t.GetPropertyChoiceList=[s,!1];t.GetUserColleagues=[s,!1];t.GetUserLinks=[s,!1];t.GetUserMemberships=[s,!1];t.GetUserPinnedLinks=[s,!1];t.GetUserProfileByGuid=[s,!1];t.GetUserProfileByIndex=[s,!1];t.GetUserProfileByName=[s,!1];t.GetUserProfileCount=[s,!1];t.GetUserProfileSchema=[s,!1];t.GetUserPropertyByAccountName=[s,!1];t.ModifyUserPropertyByAccountName=[s,!0];t.RemoveAllColleagues=[s,!0];t.RemoveAllLinks=[s,!0];t.RemoveAllMemberships=[s,!0];t.RemoveAllPinnedLinks=[s,!0];t.RemoveColleague=[s,!0];t.RemoveLink=[s,!0];t.RemoveMembership=[s,!0];t.RemovePinnedLink=[s,!0];t.UpdateColleaguePrivacy=[s,!0];t.UpdateLink=[s,!0];t.UpdateMembershipPrivacy=[s,!0];t.UpdatePinnedLink=[s,!0];t.DeleteAllVersions=[vt,!0];t.DeleteVersion=[vt,!0];t.GetVersions=[vt,!1];t.RestoreVersion=[vt,!0];t.AddView=[it,!0];t.DeleteView=[it,!0];t.GetView=[it,!1];t.GetViewHtml=[it,!1];t.GetViewCollection=[it,!1];t.UpdateView=[it,!0];t.UpdateViewHtml=[it,!0];t.AddWebPart=[rt,!0];t.AddWebPartToZone=[rt,!0];t.GetWebPart2=[rt,!1];t.GetWebPartPage=[rt,!1];t.GetWebPartProperties=[rt,!1];t.GetWebPartProperties2=[rt,!1];t.CreateContentType=[p,!0];t.GetColumns=[p,!1];t.GetContentType=[p,!1];t.GetContentTypes=[p,!1];t.GetCustomizedPageStatus=[p,!1];t.GetListTemplates=[p,!1];t.GetObjectIdFromUrl=[p,!1];t.GetWeb=[p,!1];t.GetWebCollection=[p,!1];t.GetAllSubWebCollection=[p,!1];t.UpdateColumns=[p,!0];t.UpdateContentType=[p,!0];t.WebUrlFromPageUrl=[p,!1];t.AlterToDo=[k,!0];t.ClaimReleaseTask=[k,!0];t.GetTemplatesForItem=[k,!1];t.GetToDosForItem=[k,!1];t.GetWorkflowDataForItem=[k,!1];t.GetWorkflowTaskData=[k,!1];t.StartWorkflow=[k,!0];u={};u.header="<soap:Envelope xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'><soap:Body>";u.footer="<\/soap:Body><\/soap:Envelope>";u.payload="";n.fn.SPServices=function(r){for(var c,p,v,d,e=n.extend({},n.fn.SPServices.defaults,r),h=0;h<yt.length;h++)typeof e[yt[h]]=="string"&&(e[yt[h]]=ht(e[yt[h]]));u.opheader="<"+e.operation+" ";switch(t[e.operation][0]){case gt:u.opheader+="xmlns='"+y+"/soap/2002/1/alerts/' >";a=y+"/soap/2002/1/alerts/";break;case et:u.opheader+="xmlns='"+y+"/soap/meetings/' >";a=y+"/soap/meetings/";break;case g:u.opheader+="xmlns='"+y+"/soap/directory/' >";a=y+"/soap/directory/";break;case li:u.opheader+="xmlns='http://microsoft.com/webservices/SharePointPortalServer/PublishedLinksService/' >";a="http://microsoft.com/webservices/SharePointPortalServer/PublishedLinksService/";break;case b:u.opheader+="xmlns='urn:Microsoft.Search' >";a="urn:Microsoft.Search/";break;case ai:u.opheader+="xmlns='"+y+"/diagnostics/' >";a="http://schemas.microsoft.com/sharepoint/diagnostics/";break;case o:u.opheader+="xmlns='http://microsoft.com/webservices/SharePointPortalServer/SocialDataService' >";a="http://microsoft.com/webservices/SharePointPortalServer/SocialDataService/";break;case vi:u.opheader+="xmlns='http://schemas.microsoft.com/sharepoint/publishing/spelling/' >";a="http://schemas.microsoft.com/sharepoint/publishing/spelling/SpellCheck";break;case tt:u.opheader+="xmlns='"+y+"/taxonomy/soap/' >";a=y+"/taxonomy/soap/";break;case f:u.opheader+="xmlns='"+y+"/soap/directory/' >";a=y+"/soap/directory/";break;case s:u.opheader+="xmlns='http://microsoft.com/webservices/SharePointPortalServer/UserProfileService' >";a="http://microsoft.com/webservices/SharePointPortalServer/UserProfileService/";break;case rt:u.opheader+="xmlns='http://microsoft.com/sharepoint/webpartpages' >";a="http://microsoft.com/sharepoint/webpartpages/";break;case k:u.opheader+="xmlns='"+y+"/soap/workflow/' >";a=y+"/soap/workflow/";break;default:u.opheader+="xmlns='"+y+"/soap/'>";a=y+"/soap/"}a+=e.operation;u.opfooter="<\/"+e.operation+">";c="_vti_bin/"+t[e.operation][0]+".asmx";p=n().SPServices.SPGetCurrentSite();c=e.webURL.charAt(e.webURL.length-1)===l?e.webURL+c:e.webURL.length>0?e.webURL+l+c:p+(p.charAt(p.length-1)===l?c:l+c);u.payload="";switch(e.operation){case"DeleteAlerts":for(u.payload+="<IDs>",h=0;h<e.IDs.length;h++)u.payload+=w("string",e.IDs[h]);u.payload+="<\/IDs>";break;case"Login":i(e,["username","password"]);break;case"CopyIntoItems":for(i(e,["SourceUrl"]),u.payload+="<DestinationUrls>",h=0;h<e.DestinationUrls.length;h++)u.payload+=w("string",e.DestinationUrls[h]);u.payload+="<\/DestinationUrls>";i(e,["Fields","Stream","Results"]);break;case"CopyIntoItemsLocal":for(i(e,["SourceUrl"]),u.payload+="<DestinationUrls>",h=0;h<e.DestinationUrls.length;h++)u.payload+=w("string",e.DestinationUrls[h]);u.payload+="<\/DestinationUrls>";break;case"GetItem":i(e,["Url","Fields","Stream"]);break;case"GetForm":i(e,["listName","formUrl"]);break;case"GetFormCollection":i(e,["listName"]);break;case"AddAttachment":i(e,["listName","listItemID","fileName","attachment"]);break;case"AddDiscussionBoardItem":i(e,["listName","message"]);break;case"AddList":i(e,["listName","description","templateID"]);break;case"AddListFromFeature":i(e,["listName","description","featureID","templateID"]);break;case"ApplyContentTypeToList":i(e,["webUrl","contentTypeId","listName"]);break;case"CheckInFile":i(e,["pageUrl","comment","CheckinType"]);break;case"CheckOutFile":i(e,["pageUrl","checkoutToLocal","lastmodified"]);break;case"CreateContentType":i(e,["listName","displayName","parentType","fields","contentTypeProperties","addToView"]);break;case"DeleteAttachment":i(e,["listName","listItemID","url"]);break;case"DeleteContentType":i(e,["listName","contentTypeId"]);break;case"DeleteContentTypeXmlDocument":i(e,["listName","contentTypeId","documentUri"]);break;case"DeleteList":i(e,["listName"]);break;case"GetAttachmentCollection":i(e,["listName",["listItemID","ID"]]);break;case"GetList":i(e,["listName"]);break;case"GetListAndView":i(e,["listName","viewName"]);break;case"GetListContentType":i(e,["listName","contentTypeId"]);break;case"GetListContentTypes":i(e,["listName"]);break;case"GetListItems":i(e,["listName","viewName",["query","CAMLQuery"],["viewFields","CAMLViewFields"],["rowLimit","CAMLRowLimit"],["queryOptions","CAMLQueryOptions"]]);break;case"GetListItemChanges":i(e,["listName","viewFields","since","contains"]);break;case"GetListItemChangesSinceToken":i(e,["listName","viewName",["query","CAMLQuery"],["viewFields","CAMLViewFields"],["rowLimit","CAMLRowLimit"],["queryOptions","CAMLQueryOptions"],{name:"changeToken",sendNull:!1},{name:"contains",sendNull:!1}]);break;case"GetVersionCollection":i(e,["strlistID","strlistItemID","strFieldName"]);break;case"UndoCheckOut":i(e,["pageUrl"]);break;case"UpdateContentType":i(e,["listName","contentTypeId","contentTypeProperties","newFields","updateFields","deleteFields","addToView"]);break;case"UpdateContentTypesXmlDocument":i(e,["listName","newDocument"]);break;case"UpdateContentTypeXmlDocument":i(e,["listName","contentTypeId","newDocument"]);break;case"UpdateList":i(e,["listName","listProperties","newFields","updateFields","deleteFields","listVersion"]);break;case"UpdateListItems":if(i(e,["listName"]),typeof e.updates!="undefined"&&e.updates.length>0)i(e,["updates"]);else{for(u.payload+="<updates><Batch OnError='Continue'><Method ID='1' Cmd='"+e.batchCmd+"'>",h=0;h<e.valuepairs.length;h++)u.payload+="<Field Name='"+e.valuepairs[h][0]+"'>"+ft(e.valuepairs[h][1])+"<\/Field>";e.batchCmd!=="New"&&(u.payload+="<Field Name='ID'>"+e.ID+"<\/Field>");u.payload+="<\/Method><\/Batch><\/updates>"}break;case"AddMeeting":i(e,["organizerEmail","uid","sequence","utcDateStamp","title","location","utcDateStart","utcDateEnd","nonGregorian"]);break;case"CreateWorkspace":i(e,["title","templateName","lcid","timeZoneInformation"]);break;case"RemoveMeeting":i(e,["recurrenceId","uid","sequence","utcDateStamp","cancelMeeting"]);break;case"SetWorkspaceTitle":i(e,["title"]);break;case"ResolvePrincipals":i(e,["principalKeys","principalType","addToUserInfoList"]);break;case"SearchPrincipals":i(e,["searchText","maxResults","principalType"]);break;case"AddPermission":i(e,["objectName","objectType","permissionIdentifier","permissionType","permissionMask"]);break;case"AddPermissionCollection":i(e,["objectName","objectType","permissionsInfoXml"]);break;case"GetPermissionCollection":i(e,["objectName","objectType"]);break;case"RemovePermission":i(e,["objectName","objectType","permissionIdentifier","permissionType"]);break;case"RemovePermissionCollection":i(e,["objectName","objectType","memberIdsXml"]);break;case"UpdatePermission":i(e,["objectName","objectType","permissionIdentifier","permissionType","permissionMask"]);break;case"GetPortalSearchInfo":u.opheader="<"+e.operation+" xmlns='http://microsoft.com/webservices/OfficeServer/QueryService'>";a="http://microsoft.com/webservices/OfficeServer/QueryService/"+e.operation;break;case"GetQuerySuggestions":u.opheader="<"+e.operation+" xmlns='http://microsoft.com/webservices/OfficeServer/QueryService'>";a="http://microsoft.com/webservices/OfficeServer/QueryService/"+e.operation;u.payload+=w("queryXml",ht(e.queryXml));break;case"GetSearchMetadata":u.opheader="<"+e.operation+" xmlns='http://microsoft.com/webservices/OfficeServer/QueryService'>";a="http://microsoft.com/webservices/OfficeServer/QueryService/"+e.operation;break;case"Query":u.payload+=w("queryXml",ht(e.queryXml));break;case"QueryEx":u.opheader="<"+e.operation+" xmlns='http://microsoft.com/webservices/OfficeServer/QueryService'>";a="http://microsoft.com/webservices/OfficeServer/QueryService/"+e.operation;u.payload+=w("queryXml",ht(e.queryXml));break;case"Registration":u.payload+=w("registrationXml",ht(e.registrationXml));break;case"SendClientScriptErrorReport":i(e,["message","file","line","client","stack","team","originalFile"]);break;case"EnumerateFolder":i(e,["strFolderUrl"]);break;case"GetAttachments":i(e,["strListName","strItemId"]);break;case"SiteDataGetList":i(e,["strListName"]);u=ot(u,e.operation);break;case"SiteDataGetListCollection":u=ot(u,e.operation);break;case"SiteDataGetSite":u=ot(u,e.operation);break;case"SiteDataGetSiteUrl":i(e,["Url"]);u=ot(u,e.operation);break;case"SiteDataGetWeb":u=ot(u,e.operation);break;case"CreateWeb":i(e,["url","title","description","templateName","language","languageSpecified","locale","localeSpecified","collationLocale","collationLocaleSpecified","uniquePermissions","uniquePermissionsSpecified","anonymous","anonymousSpecified","presence","presenceSpecified"]);break;case"DeleteWeb":i(e,["url"]);break;case"GetSite":i(e,["SiteUrl"]);break;case"GetSiteTemplates":i(e,["LCID","TemplateList"]);break;case"AddComment":i(e,["url","comment","isHighPriority","title"]);break;case"AddTag":i(e,["url","termID","title","isPrivate"]);break;case"AddTagByKeyword":i(e,["url","keyword","title","isPrivate"]);break;case"CountCommentsOfUser":i(e,["userAccountName"]);break;case"CountCommentsOfUserOnUrl":i(e,["userAccountName","url"]);break;case"CountCommentsOnUrl":i(e,["url"]);break;case"CountRatingsOnUrl":i(e,["url"]);break;case"CountTagsOfUser":i(e,["userAccountName"]);break;case"DeleteComment":i(e,["url","lastModifiedTime"]);break;case"DeleteRating":i(e,["url"]);break;case"DeleteTag":i(e,["url","termID"]);break;case"DeleteTagByKeyword":i(e,["url","keyword"]);break;case"DeleteTags":i(e,["url"]);break;case"GetAllTagTerms":i(e,["maximumItemsToReturn"]);break;case"GetAllTagTermsForUrlFolder":i(e,["urlFolder","maximumItemsToReturn"]);break;case"GetAllTagUrls":i(e,["termID"]);break;case"GetAllTagUrlsByKeyword":i(e,["keyword"]);break;case"GetCommentsOfUser":i(e,["userAccountName","maximumItemsToReturn","startIndex"]);break;case"GetCommentsOfUserOnUrl":i(e,["userAccountName","url"]);break;case"GetCommentsOnUrl":i(e,["url","maximumItemsToReturn","startIndex"]);typeof e.excludeItemsTime!="undefined"&&e.excludeItemsTime.length>0&&(u.payload+=w("excludeItemsTime",e.excludeItemsTime));break;case"GetRatingAverageOnUrl":i(e,["url"]);break;case"GetRatingOfUserOnUrl":i(e,["userAccountName","url"]);break;case"GetRatingOnUrl":i(e,["url"]);break;case"GetRatingsOfUser":i(e,["userAccountName"]);break;case"GetRatingsOnUrl":i(e,["url"]);break;case"GetSocialDataForFullReplication":i(e,["userAccountName"]);break;case"GetTags":i(e,["url"]);break;case"GetTagsOfUser":i(e,["userAccountName","maximumItemsToReturn","startIndex"]);break;case"GetTagTerms":i(e,["maximumItemsToReturn"]);break;case"GetTagTermsOfUser":i(e,["userAccountName","maximumItemsToReturn"]);break;case"GetTagTermsOnUrl":i(e,["url","maximumItemsToReturn"]);break;case"GetTagUrls":i(e,["termID"]);break;case"GetTagUrlsByKeyword":i(e,["keyword"]);break;case"GetTagUrlsOfUser":i(e,["termID","userAccountName"]);break;case"GetTagUrlsOfUserByKeyword":i(e,["keyword","userAccountName"]);break;case"SetRating":i(e,["url","rating","title","analysisDataEntry"]);break;case"UpdateComment":i(e,["url","lastModifiedTime","comment","isHighPriority"]);break;case"SpellCheck":i(e,["chunksToSpell","declaredLanguage","useLad"]);break;case"AddTerms":i(e,["sharedServiceId","termSetId","lcid","newTerms"]);break;case"GetChildTermsInTerm":i(e,["sspId","lcid","termId","termSetId"]);break;case"GetChildTermsInTermSet":i(e,["sspId","lcid","termSetId"]);break;case"GetKeywordTermsByGuids":i(e,["termIds","lcid"]);break;case"GetTermsByLabel":i(e,["label","lcid","matchOption","resultCollectionSize","termIds","addIfNotFound"]);break;case"GetTermSets":i(e,["sharedServiceId","termSetId","lcid","clientTimeStamps","clientVersions"]);break;case"AddGroup":i(e,["groupName","ownerIdentifier","ownerType","defaultUserLoginName","description"]);break;case"AddGroupToRole":i(e,["groupName","roleName"]);break;case"AddRole":i(e,["roleName","description","permissionMask"]);break;case"AddRoleDef":i(e,["roleName","description","permissionMask"]);break;case"AddUserCollectionToGroup":i(e,["groupName","usersInfoXml"]);break;case"AddUserCollectionToRole":i(e,["roleName","usersInfoXml"]);break;case"AddUserToGroup":i(e,["groupName","userName","userLoginName","userEmail","userNotes"]);break;case"AddUserToRole":i(e,["roleName","userName","userLoginName","userEmail","userNotes"]);break;case"GetGroupCollection":i(e,["groupNamesXml"]);break;case"GetGroupCollectionFromRole":i(e,["roleName"]);break;case"GetGroupCollectionFromUser":i(e,["userLoginName"]);break;case"GetGroupInfo":i(e,["groupName"]);break;case"GetRoleCollection":i(e,["roleNamesXml"]);break;case"GetRoleCollectionFromGroup":i(e,["groupName"]);break;case"GetRoleCollectionFromUser":i(e,["userLoginName"]);break;case"GetRoleInfo":i(e,["roleName"]);break;case"GetUserCollection":i(e,["userLoginNamesXml"]);break;case"GetUserCollectionFromGroup":i(e,["groupName"]);break;case"GetUserCollectionFromRole":i(e,["roleName"]);break;case"GetUserInfo":i(e,["userLoginName"]);break;case"GetUserLoginFromEmail":i(e,["emailXml"]);break;case"RemoveGroup":i(e,["groupName"]);break;case"RemoveGroupFromRole":i(e,["roleName","groupName"]);break;case"RemoveRole":i(e,["roleName"]);break;case"RemoveUserCollectionFromGroup":i(e,["groupName","userLoginNamesXml"]);break;case"RemoveUserCollectionFromRole":i(e,["roleName","userLoginNamesXml"]);break;case"RemoveUserCollectionFromSite":i(e,["userLoginNamesXml"]);break;case"RemoveUserFromGroup":i(e,["groupName","userLoginName"]);break;case"RemoveUserFromRole":i(e,["roleName","userLoginName"]);break;case"RemoveUserFromSite":i(e,["userLoginName"]);break;case"RemoveUserFromWeb":i(e,["userLoginName"]);break;case"UpdateGroupInfo":i(e,["oldGroupName","groupName","ownerIdentifier","ownerType","description"]);break;case"UpdateRoleDefInfo":i(e,["oldRoleName","roleName","description","permissionMask"]);break;case"UpdateRoleInfo":i(e,["oldRoleName","roleName","description","permissionMask"]);break;case"UpdateUserInfo":i(e,["userLoginName","userName","userEmail","userNotes"]);break;case"AddColleague":i(e,["accountName","colleagueAccountName","group","privacy","isInWorkGroup"]);break;case"AddLink":i(e,["accountName","name","url","group","privacy"]);break;case"AddMembership":i(e,["accountName","membershipInfo","group","privacy"]);break;case"AddPinnedLink":i(e,["accountName","name","url"]);break;case"CreateMemberGroup":i(e,["membershipInfo"]);break;case"CreateUserProfileByAccountName":i(e,["accountName"]);break;case"GetCommonColleagues":i(e,["accountName"]);break;case"GetCommonManager":i(e,["accountName"]);break;case"GetCommonMemberships":i(e,["accountName"]);break;case"GetInCommon":i(e,["accountName"]);break;case"GetPropertyChoiceList":i(e,["propertyName"]);break;case"GetUserColleagues":i(e,["accountName"]);break;case"GetUserLinks":i(e,["accountName"]);break;case"GetUserMemberships":i(e,["accountName"]);break;case"GetUserPinnedLinks":i(e,["accountName"]);break;case"GetUserProfileByGuid":i(e,["guid"]);break;case"GetUserProfileByIndex":i(e,["index"]);break;case"GetUserProfileByName":typeof e.accountName!="undefined"&&e.accountName.length>0?i(e,[["AccountName","accountName"]]):i(e,["AccountName"]);break;case"GetUserPropertyByAccountName":i(e,["accountName","propertyName"]);break;case"ModifyUserPropertyByAccountName":i(e,["accountName","newData"]);break;case"RemoveAllColleagues":i(e,["accountName"]);break;case"RemoveAllLinks":i(e,["accountName"]);break;case"RemoveAllMemberships":i(e,["accountName"]);break;case"RemoveAllPinnedLinks":i(e,["accountName"]);break;case"RemoveColleague":i(e,["accountName","colleagueAccountName"]);break;case"RemoveLink":i(e,["accountName","id"]);break;case"RemoveMembership":i(e,["accountName","sourceInternal","sourceReference"]);break;case"RemovePinnedLink":i(e,["accountName","id"]);break;case"UpdateColleaguePrivacy":i(e,["accountName","colleagueAccountName","newPrivacy"]);break;case"UpdateLink":i(e,["accountName","data"]);break;case"UpdateMembershipPrivacy":i(e,["accountName","sourceInternal","sourceReference","newPrivacy"]);break;case"UpdatePinnedLink ":i(e,["accountName","data"]);break;case"DeleteAllVersions":i(e,["fileName"]);break;case"DeleteVersion":i(e,["fileName","fileVersion"]);break;case"GetVersions":i(e,["fileName"]);break;case"RestoreVersion":i(e,["fileName","fileVersion"]);break;case"AddView":i(e,["listName","viewName","viewFields","query","rowLimit","rowLimit","type","makeViewDefault"]);break;case"DeleteView":i(e,["listName","viewName"]);break;case"GetView":i(e,["listName","viewName"]);break;case"GetViewCollection":i(e,["listName"]);break;case"GetViewHtml":i(e,["listName","viewName"]);break;case"UpdateView":i(e,["listName","viewName","viewProperties","query","viewFields","aggregations","formats","rowLimit"]);break;case"UpdateViewHtml":i(e,["listName","viewName","viewProperties","toolbar","viewHeader","viewBody","viewFooter","viewEmpty","rowLimitExceeded","query","viewFields","aggregations","formats","rowLimit"]);break;case"AddWebPart":i(e,["pageUrl","webPartXml","storage"]);break;case"AddWebPartToZone":i(e,["pageUrl","webPartXml","storage","zoneId","zoneIndex"]);break;case"GetWebPart2":i(e,["pageUrl","storageKey","storage","behavior"]);break;case"GetWebPartPage":i(e,["documentName","behavior"]);break;case"GetWebPartProperties":i(e,["pageUrl","storage"]);break;case"GetWebPartProperties2":i(e,["pageUrl","storage","behavior"]);break;case"Webs.CreateContentType":i(e,["displayName","parentType","newFields","contentTypeProperties"]);break;case"GetColumns":i(e,["webUrl"]);break;case"GetContentType":i(e,["contentTypeId"]);break;case"GetCustomizedPageStatus":i(e,["fileUrl"]);break;case"GetObjectIdFromUrl":i(e,["objectUrl"]);break;case"GetWeb":i(e,[["webUrl","webURL"]]);break;case"UpdateColumns":i(e,["newFields","updateFields","deleteFields"]);break;case"Webs.UpdateContentType":i(e,["contentTypeId","contentTypeProperties","newFields","updateFields","deleteFields"]);break;case"WebUrlFromPageUrl":i(e,[["pageUrl","pageURL"]]);break;case"AlterToDo":i(e,["item","todoId","todoListId","taskData"]);break;case"ClaimReleaseTask":i(e,["item","taskId","listId","fClaim"]);break;case"GetTemplatesForItem":i(e,["item"]);break;case"GetToDosForItem":i(e,["item"]);break;case"GetWorkflowDataForItem":i(e,["item"]);break;case"GetWorkflowTaskData":i(e,["item","listId","taskId"]);break;case"StartWorkflow":i(e,["item","templateId","workflowParameters"])}return v=u.header+u.opheader+u.payload+u.opfooter+u.footer,e.cacheXML&&(d=dt[v]),typeof d=="undefined"?(dt[v]=n.ajax({url:c,async:e.async,beforeSend:function(n){t[e.operation][1]&&n.setRequestHeader("SOAPAction",a)},type:"POST",data:v,dataType:"xml",contentType:"text/xml;charset='utf-8'",complete:function(t,i){n.isFunction(e.completefunc)&&e.completefunc(t,i)}}),dt[v]):(n.isFunction(e.completefunc)&&e.completefunc(d,null),d)};n.fn.SPServices.defaults={cacheXML:!1,operation:"",webURL:"",makeViewDefault:!1,CAMLViewName:"",CAMLQuery:"",CAMLViewFields:"",CAMLRowLimit:0,CAMLQueryOptions:"<QueryOptions><\/QueryOptions>",batchCmd:"Update",valuepairs:[],DestinationUrls:[],behavior:"Version3",storage:"Shared",objectType:"List",cancelMeeting:!0,nonGregorian:!1,fClaim:!1,recurrenceId:0,sequence:0,maximumItemsToReturn:0,startIndex:0,isHighPriority:!1,isPrivate:!1,rating:1,maxResults:10,principalType:"User",async:!0,completefunc:null};n.fn.SPServices.SPGetCurrentSite=function(){if(v.thisSite.length>0)return v.thisSite;var t=u.header+"<WebUrlFromPageUrl xmlns='"+y+"/soap/' ><pageUrl>"+(location.href.indexOf("?")>0?location.href.substr(0,location.href.indexOf("?")):location.href)+"<\/pageUrl><\/WebUrlFromPageUrl>"+u.footer;return n.ajax({async:!1,url:"/_vti_bin/Webs.asmx",type:"POST",data:t,dataType:"xml",contentType:'text/xml;charset="utf-8"',complete:function(t){v.thisSite=n(t.responseXML).find("WebUrlFromPageUrlResult").text()}}),v.thisSite};n.fn.SPServices.SPCascadeDropdowns=function(t){var i=n.extend({},{relationshipWebURL:"",relationshipList:"",relationshipListParentColumn:"",relationshipListChildColumn:"",relationshipListSortColumn:"",parentColumn:"",childColumn:"",listName:n().SPServices.SPListNameFromUrl(),CAMLQuery:"",CAMLQueryOptions:"<QueryOptions><IncludeMandatoryColumns>FALSE<\/IncludeMandatoryColumns><\/QueryOptions>",promptText:"",noneText:"(None)",simpleChild:!1,selectSingleOption:!1,matchOnId:!1,completefunc:null,debug:!1},t),s=!1,h="SPServices.SPCascadeDropdowns",r=n().SPServices.SPDropdownCtl({displayName:i.parentColumn}),u,l,a,o,f;if(r.Obj.html()===null&&i.debug){c(h,"parentColumn: "+i.parentColumn,d);return}if(u=n().SPServices.SPDropdownCtl({displayName:i.childColumn}),u.Obj.html()===null&&i.debug){c(h,"childColumn: "+i.childColumn,d);return}if(i.simpleChild===!0&&u.Type===e.complex&&(n().SPServices.SPComplexToSimpleDropdown({columnName:i.childColumn}),u=n().SPServices.SPDropdownCtl({displayName:i.childColumn})),n().SPServices({operation:"GetList",async:!1,cacheXML:!0,listName:i.listName,completefunc:function(t){n(t.responseXML).find("Fields").each(function(){n(this).find("Field[DisplayName='"+i.childColumn+"']").each(function(){return l=n(this).attr("Required")==="TRUE"?!0:!1,a=n(this).attr("StaticName"),!1})})}}),o={opt:i,childSelect:u,childColumnStatic:a,childColumnRequired:l},f=r.Obj.data("SPCascadeDropdownsChildColumns"),typeof f=="undefined"?r.Obj.data("SPCascadeDropdownsChildColumns",[o]):(f.push(o),r.Obj.data("SPCascadeDropdownsChildColumns",f),s=!0),!s)switch(r.Type){case e.simple:r.Obj.bind("change",function(){ut(i.parentColumn,r)});break;case e.complex:r.optHid.bind("propertychange",function(){ut(i.parentColumn,r)});break;case e.multiSelect:n(r.master.candidateControl).bind("dblclick",function(){ut(i.parentColumn,r)});n(r.master.resultControl).bind("dblclick",function(){ut(i.parentColumn,r)});n(r.master.addControl).bind("click",function(){ut(i.parentColumn,r)});n(r.master.removeControl).bind("click",function(){ut(i.parentColumn,r)})}ut(i.parentColumn,r)};n.fn.SPServices.SPComplexToSimpleDropdown=function(t){var u=n.extend({},{columnName:"",completefunc:null,debug:!1},t),i=n().SPServices.SPDropdownCtl({displayName:u.columnName}),h;if(i.Obj.html()===null&&u.debug){c("SPServices.SPComplexToSimpleDropdown","columnName: "+u.columnName,d);return}if(i.Type===e.complex){var f=n(i.Obj).attr("choices").split("|"),l=i.optHid.val(),o=bt("SPComplexToSimpleDropdown",u.columnName),s="<select id='"+o+"' title='"+u.columnName+"'>";for(r=0;r<f.length;r=r+2)h=f[r+1]===l?" selected='selected' ":" ",s+="<option"+h+"value='"+f[r+1]+"'>"+f[r]+"<\/option>";s+="<\/select>";n(i.Obj).closest("td").prepend(s);n(i.Obj).closest("span").find("img").remove();n(i.Obj).closest("span").find("input").hide();n("#"+o).change(function(){var t=n(this).val();i.optHid.val(t);n(i.Obj).val(n(this).find("option[value='"+(t!=="0"?t:"")+"']").html())});n("#"+o).trigger("change");u.completefunc!==null&&u.completefunc()}};n.fn.SPServices.SPDisplayRelatedInfo=function(t){var i=n.extend({},{columnName:"",relatedWebURL:"",relatedList:"",relatedListColumn:"",relatedColumns:[],displayFormat:"table",headerCSSClass:"ms-vh2",rowCSSClass:"ms-vb",CAMLQuery:"",numChars:0,matchType:"Eq",matchOnId:!1,completefunc:null,debug:!1},t),f,u=[],o,h="SPServices.SPDisplayRelatedInfo",s=n().SPServices.SPDropdownCtl({displayName:i.columnName});if(s.Obj.html()===null&&i.debug){c(h,"columnName: "+i.columnName,d);return}f=bt("SPDisplayRelatedInfo",i.columnName);n().SPServices({operation:"GetList",async:!1,cacheXML:!0,webURL:i.relatedWebURL,listName:i.relatedList,completefunc:function(t){for(n(t.responseXML).find("faultcode").each(function(){if(i.debug){c(h,"relatedList: "+i.relatedList,"List not found");return}}),o=n(t.responseXML).find("List"),r=0;r<i.relatedColumns.length;r++)u[i.relatedColumns[r]]=n(t.responseXML).find("Fields > Field[Name='"+i.relatedColumns[r]+"']");u[i.relatedListColumn]=n(t.responseXML).find("Fields > Field[Name='"+i.relatedListColumn+"']")}});switch(s.Type){case e.simple:s.Obj.bind("change",function(){ti(i,f,o,u)});break;case e.complex:s.optHid.bind("propertychange",function(){ti(i,f,o,u)});break;case e.multiSelect:i.debug&&c(h,"columnName: "+i.columnName,"Multi-select columns not supported by this function")}ti(i,f,o,u)};n.fn.SPServices.SPFilterDropdown=function(t){var i=n.extend({},{relationshipWebURL:"",relationshipList:"",relationshipListColumn:"",relationshipListSortColumn:"",relationshipListSortAscending:!0,columnName:"",listName:n().SPServices.SPListNameFromUrl(),promptText:"",noneText:"(None)",CAMLQuery:"",CAMLQueryOptions:"<QueryOptions><IncludeMandatoryColumns>FALSE<\/IncludeMandatoryColumns><ViewAttributes Scope='RecursiveAll'/><\/QueryOptions>",completefunc:null,debug:!1},t),u="",s=null,f,o,h="SPServices.SPFilterDropdown",r=n().SPServices.SPDropdownCtl({displayName:i.columnName});if(r.Obj.html()===null&&i.debug){c(h,"columnName: "+i.columnName,d);return}s=wt(r,!0);var a=i.relationshipListSortColumn.length>0?i.relationshipListSortColumn:i.relationshipListColumn,v=i.relationshipListSortAscending===!0?"":"Ascending='FALSE'",l="<Query><OrderBy><FieldRef Name='"+a+"' "+v+"/><\/OrderBy><Where>";i.CAMLQuery.length>0&&(l+=i.CAMLQuery);l+="<\/Where><\/Query>";n().SPServices({operation:"GetList",async:!1,cacheXML:!0,listName:i.listName,completefunc:function(t){n(t.responseXML).find("Fields").each(function(){n(this).find("Field[DisplayName='"+i.columnName+"']").each(function(){return o=n(this).attr("Required")==="TRUE"?!0:!1,!1})})}});n().SPServices({operation:"GetListItems",async:!1,webURL:i.relationshipWebURL,listName:i.relationshipList,CAMLQuery:l,CAMLViewFields:"<ViewFields><FieldRef Name='"+i.relationshipListColumn+"' /><\/ViewFields>",CAMLRowLimit:0,CAMLQueryOptions:i.CAMLQueryOptions,completefunc:function(t){n(t.responseXML).find("errorstring").each(function(){var t=n(this).text();i.debug&&t==="One or more field types are not installed properly. Go to the list settings page to delete these fields."?c(h,"relationshipListColumn: "+i.relationshipListColumn,"Not found in relationshipList "+i.relationshipList):i.debug&&t==="Guid should contain 32 digits with 4 dashes (xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx)."&&c(h,"relationshipList: "+i.relationshipList,"List not found");return});switch(r.Type){case e.simple:n(r.Obj).find("option").remove();!o&&i.promptText.length>0?r.Obj.append("<option value='0'>"+i.promptText.replace(/\{0\}/g,i.columnName)+"<\/option>"):o||r.Obj.append("<option value='0'>"+i.noneText+"<\/option>");break;case e.complex:u=o?"":i.noneText+"|0";r.Obj.val("");break;case e.multiSelect:n(r.master.candidateControl).find("option").remove();f=""}n(t.responseXML).SPFilterNode("z:row").each(function(){var t={},o=n(this).attr("ows_"+i.relationshipListColumn),h;typeof o!="undefined"&&o.indexOf(";#")>0?t=new kt(o):(t.id=n(this).attr("ows_ID"),t.value=o);isNaN(t.id)&&(t.id=n(this).attr("ows_ID"));switch(r.Type){case e.simple:h=n(this).attr("ows_ID")===s[0]?" selected='selected'":"";r.Obj.append("<option"+h+" value='"+t.id+"'>"+t.value+"<\/option>");break;case e.complex:t.id===s[0]&&r.Obj.val(t.value);u=u+(u.length>0?"|":"")+t.value+"|"+t.id;break;case e.multiSelect:n(r.master.candidateControl).append("<option value='"+t.id+"'>"+t.value+"<\/option>");f+=t.id+"|t"+t.value+"|t |t |t"}});switch(r.Type){case e.simple:r.Obj.trigger("change");break;case e.complex:r.Obj.attr("choices",u);r.Obj.trigger("propertychange");break;case e.multiSelect:r.master.data="";r.MultiLookupPickerdata.val(f);n(r.master.resultControl).find("option").each(function(){var t=n(this);n(this).attr("selected","selected");n(r.master.candidateControl).find("option").each(function(){n(this).html()===t.html()&&t.removeAttr("selected")})});GipRemoveSelectedItems(r.master);n(r.master.candidateControl).find("option").each(function(){var t=n(this);n(r.master.resultControl).find("option").each(function(){n(this).html()===t.html()&&t.remove()})});GipAddSelectedItems(r.master);r.master.data=GipGetGroupData(f);n(r.master.candidateControl).trigger("dblclick")}}});i.completefunc!==null&&i.completefunc()};n.fn.SPServices.SPDebugXMLHttpResult=function(t){var i=n.extend({},{node:null,indent:0},t),u,r="";if(r+="<table class='ms-vb' style='margin-left:"+i.indent*3+"px;' width='100%'>",i.node.nodeName==="DisplayPattern")r+="<tr><td width='100px' style='font-weight:bold;'>"+i.node.nodeName+"<\/td><td><textarea readonly='readonly' rows='5' cols='50'>"+i.node.xml+"<\/textarea><\/td><\/tr>";else if(i.node.hasChildNodes())if(i.node.hasChildNodes()&&i.node.firstChild.nodeType===4)r+="<tr><td width='100px' style='font-weight:bold;'>"+i.node.nodeName+"<\/td><td><textarea readonly='readonly' rows='5' cols='50'>"+i.node.parentNode.text+"<\/textarea><\/td><\/tr>";else if(i.node.hasChildNodes()&&i.node.firstChild.nodeType===3)r+="<tr><td width='100px' style='font-weight:bold;'>"+i.node.nodeName+"<\/td><td>"+fi(i.node.firstChild.nodeValue)+"<\/td><\/tr>";else{for(r+="<tr><td width='100px' style='font-weight:bold;' colspan='99'>"+i.node.nodeName+"<\/td><\/tr>",i.node.attributes&&(r+="<tr><td colspan='99'>"+di(i.node)+"<\/td><\/tr>"),r+="<tr><td>",u=0;u<i.node.childNodes.length;u++)r+=n().SPServices.SPDebugXMLHttpResult({node:i.node.childNodes.item(u),indent:i.indent+1});r+="<\/td><\/tr>"}else r+="<tr><td width='100px' style='font-weight:bold;'>"+i.node.nodeName+"<\/td><td>"+(i.node.nodeValue!==null?fi(i.node.nodeValue):"&nbsp;")+"<\/td><\/tr>",i.node.attributes&&(r+="<tr><td colspan='99'>"+di(i.node)+"<\/td><\/tr>");return r+"<\/table>"};n.fn.SPServices.SPGetCurrentUser=function(t){var i=n.extend({},{webURL:"",fieldName:"Name",fieldNames:{},debug:!1},t),s;if(i.fieldName==="ID"&&typeof v.thisUserId!="undefined")return v.thisUserId;var u="",e={},f=i.fieldNames.length>0?i.fieldNames.length:1,o,h=i.webURL.length>0?i.webURL:n().SPServices.SPGetCurrentSite();for(n.ajax({async:!1,url:h+"/_layouts/userdisp.aspx?Force=True&"+(new Date).getTime(),complete:function(n){o=n}}),r=0;r<f;r++)i.fieldNames[r]==="ID"?u=v.thisUserId:(s=f>1?RegExp('FieldInternalName="'+i.fieldNames[r]+'"',"gi"):RegExp('FieldInternalName="'+i.fieldName+'"',"gi"),n(o.responseText).find("table.ms-formtable td[id^='SPField']").each(function(){if(s.test(n(this).html())){switch(n(this).attr("id")){case"SPFieldText":u=n(this).text();break;case"SPFieldNote":u=n(this).find("div").html();break;case"SPFieldURL":u=n(this).find("img").attr("src");break;default:u=n(this).text()}return!1}})),i.fieldNames[r]!=="ID"&&(u=typeof u!="undefined"?u.replace(/(^[\s\xA0]+|[\s\xA0]+$)/g,""):null),f>1&&(e[i.fieldNames[r]]=u);return f>1?e:u};n.fn.SPServices.SPLookupAddNew=function(t){var i=n.extend({},{lookupColumn:"",promptText:"Add new {0}",newWindow:!1,ContentTypeID:"",completefunc:null,debug:!1},t),u="SPServices.SPLookupAddNew",o=n().SPServices.SPDropdownCtl({displayName:i.lookupColumn}),e,h;if(o.Obj.html()===null&&i.debug){c(u,"lookupColumn: "+i.lookupColumn,d);return}var f="",r="",s="";if(n().SPServices({operation:"GetList",async:!1,cacheXML:!0,listName:n().SPServices.SPListNameFromUrl(),completefunc:function(t){n(t.responseXML).find("Field[DisplayName='"+i.lookupColumn+"']").each(function(){return s=n(this).attr("StaticName"),n().SPServices({operation:"GetList",async:!1,cacheXML:!0,listName:n(this).attr("List"),completefunc:function(t){n(t.responseXML).find("List").each(function(){r=n(this).attr("WebFullUrl");r=r!==l?r+l:r})}}),f=ui(n(this).attr("List"),"NewForm"),!1})}}),r.length===0&&i.debug){c(u,"lookupColumn: "+i.lookupColumn,"This column does not appear to be a lookup column");return}if(f.length>0)e=r+f,e+=i.newWindow?(i.ContentTypeID.length>0?"?ContentTypeID="+i.ContentTypeID:"")+"' target='_blank'":"?"+(i.ContentTypeID.length>0?"ContentTypeID="+i.ContentTypeID+"&":"")+"Source="+ct(location.href)+"'",h="<div id='SPLookupAddNew_"+s+"'><a href='"+e+">"+i.promptText.replace(/\{0\}/g,i.lookupColumn)+"<\/a><\/div>",n(o.Obj).parents("td.ms-formbody").append(h);else if(i.debug){c(u,"lookupColumn: "+i.lookupColumn,"NewForm cannot be found");return}i.completefunc!==null&&i.completefunc()};n.fn.SPServices.SPGetLastItemId=function(t){var i=n.extend({},{webURL:"",listName:"",userAccount:"",CAMLQuery:""},t),u,f=0,r;return n().SPServices({operation:"GetUserInfo",webURL:i.webURL,async:!1,userLoginName:i.userAccount!==""?i.userAccount:n().SPServices.SPGetCurrentUser(),completefunc:function(t){n(t.responseXML).find("User").each(function(){u=n(this).attr("ID")})}}),r="<Query><Where>",i.CAMLQuery.length>0&&(r+="<And>"),r+="<Eq><FieldRef Name='Author' LookupId='TRUE'/><Value Type='Integer'>"+u+"<\/Value><\/Eq>",i.CAMLQuery.length>0&&(r+=i.CAMLQuery+"<\/And>"),r+="<\/Where><OrderBy><FieldRef Name='Created_x0020_Date' Ascending='FALSE'/><\/OrderBy><\/Query>",n().SPServices({operation:"GetListItems",async:!1,webURL:i.webURL,listName:i.listName,CAMLQuery:r,CAMLViewFields:"<ViewFields><FieldRef Name='ID'/><\/ViewFields>",CAMLRowLimit:1,CAMLQueryOptions:"<QueryOptions><ViewAttributes Scope='Recursive' /><\/QueryOptions>",completefunc:function(t){n(t.responseXML).SPFilterNode("z:row").each(function(){f=n(this).attr("ows_ID")})}}),f};n.fn.SPServices.SPRequireUnique=function(t){var i=n.extend({},{columnStaticName:"Title",duplicateAction:0,ignoreCase:!1,initMsg:"This value must be unique.",initMsgCSSClass:"ms-vb",errMsg:"This value is not unique.",errMsgCSSClass:"ms-formvalidation",showDupes:!1,completefunc:null},t),f=n().SPServices.SPGetQueryString(),e=f.ID;v.thisList=n().SPServices.SPListNameFromUrl();var o="<span id='SPRequireUnique"+i.columnStaticName+"' class='{0}'>{1}<\/span><br/>",s=o.replace(/\{0\}/g,i.initMsgCSSClass).replace(/\{1\}/g,i.initMsg),h=n().SPServices.SPGetDisplayFromStatic({listName:v.thisList,columnStaticName:i.columnStaticName}),u=n("input[Title='"+h+"']");n(u).parent().append(s);n(u).blur(function(){var t=[],f=n(this).val(),u,o;if(f.length===0)return!1;if(n().SPServices({operation:"GetListItems",async:!1,listName:v.thisList,CAMLQuery:"<Query><Where><IsNotNull><FieldRef Name='"+i.columnStaticName+"'/><\/IsNotNull><\/Where><\/Query>",CAMLViewFields:"<ViewFields><FieldRef Name='ID' /><FieldRef Name='"+i.columnStaticName+"' /><\/ViewFields>",CAMLRowLimit:0,completefunc:function(r){var u=i.ignoreCase?f.toUpperCase():f;n(r.responseXML).SPFilterNode("z:row").each(function(){var r=i.ignoreCase?n(this).attr("ows_"+i.columnStaticName).toUpperCase():n(this).attr("ows_"+i.columnStaticName);u===r&&n(this).attr("ows_ID")!==e&&t.push([n(this).attr("ows_ID"),n(this).attr("ows_"+i.columnStaticName)])})}}),u=i.initMsg,n("span#SPRequireUnique"+i.columnStaticName).html(u).attr("class",i.initMsgCSSClass),n("input[value='OK']:disabled, input[value='Save']:disabled").removeAttr("disabled"),t.length>0&&(u=i.errMsg,n("span#SPRequireUnique"+i.columnStaticName).html(u).attr("class",i.errMsgCSSClass),i.duplicateAction===1&&(n("input[Title='"+i.columnDisplayName+"']").focus(),n("input[value='OK'], input[value='Save']").attr("disabled","disabled")),i.showDupes)){for(o=" "+t.length+" duplicate item"+(t.length>1?"s":"")+": ",r=0;r<t.length;r++)o+="<a href='DispForm.aspx?ID="+t[r][0]+"&Source="+location.href+"'>"+t[r][1]+"<\/a> ";n("span#SPRequireUnique"+i.columnStaticName).append(o)}});i.completefunc!==null&&i.completefunc()};n.fn.SPServices.SPGetDisplayFromStatic=function(t){var i=n.extend({},{webURL:"",listName:"",columnStaticName:"",columnStaticNames:{}},t),f="",e={},u=i.columnStaticNames.length>0?i.columnStaticNames.length:1;return n().SPServices({operation:"GetList",async:!1,cacheXML:!0,webURL:i.webURL,listName:i.listName,completefunc:function(t){if(u>1)for(r=0;r<u;r++)e[i.columnStaticNames[r]]=n(t.responseXML).find("Field[StaticName='"+i.columnStaticNames[r]+"']").attr("DisplayName");else f=n(t.responseXML).find("Field[StaticName='"+i.columnStaticName+"']").attr("DisplayName")}}),u>1?e:f};n.fn.SPServices.SPGetStaticFromDisplay=function(t){var i=n.extend({},{webURL:"",listName:"",columnDisplayName:"",columnDisplayNames:{}},t),f="",e={},u=i.columnDisplayNames.length>0?i.columnDisplayNames.length:1;return n().SPServices({operation:"GetList",async:!1,cacheXML:!0,webURL:i.webURL,listName:i.listName,completefunc:function(t){if(u>1)for(r=0;r<u;r++)e[i.columnDisplayNames[r]]=n(t.responseXML).find("Field[DisplayName='"+i.columnDisplayNames[r]+"']").attr("StaticName");else f=n(t.responseXML).find("Field[DisplayName='"+i.columnDisplayName+"']").attr("StaticName")}}),u>1?e:f};n.fn.SPServices.SPRedirectWithID=function(t){var u=n.extend({},{redirectUrl:"",qsParamName:"ID"},t),s;v.thisList=n().SPServices.SPListNameFromUrl();var i=n().SPServices.SPGetQueryString(),r=i.ID,f=i.List,e=i.RootFolder,o=i.ContentTypeId;if(typeof i.ID=="undefined")r=n().SPServices.SPGetLastItemId({listName:v.thisList}),n("form[name='aspnetForm']").each(function(){var u=location.href.indexOf("?")>0?location.href.substring(0,location.href.indexOf("?")):location.href,h=typeof i.Source=="string"?"Source="+i.Source.replace(/\//g,"%2f").replace(/:/g,"%3a"):"",t=[],s;typeof f!="undefined"&&t.push("List="+f);typeof e!="undefined"&&t.push("RootFolder="+e);typeof o!="undefined"&&t.push("ContentTypeId="+o);s=u+(t.length>0?"?"+t.join("&")+"&":"?")+"Source="+u+"?ID="+r+(h.length>0?"%26RealSource="+i.Source:"")+(typeof i.RedirectURL=="string"?"%26RedirectURL="+i.RedirectURL:"");n(this).attr("action",s)});else{while(i.ID===r)r=n().SPServices.SPGetLastItemId({listName:v.thisList});s=typeof i.RedirectURL=="string"?i.RedirectURL:u.redirectUrl;location.href=s+"?"+u.qsParamName+"="+r+(typeof i.RealSource=="string"?"&Source="+i.RealSource:"")}};n.fn.SPServices.SPSetMultiSelectSizes=function(t){var i=n.extend({},{multiSelectColumn:"",minWidth:0,maxWidth:0,debug:!1},t),h="SPServices.SPSetMultiSelectSizes",r=n().SPServices.SPDropdownCtl({displayName:i.multiSelectColumn}),l,f,o,u,s;if(r.Obj.html()===null&&i.debug){c(h,"multiSelectColumn: "+i.multiSelectColumn,d);return}if(r.Type!==e.multiSelect&&i.debug){c(h,"multiSelectColumn: "+i.multiSelectColumn,"Column is not multi-select.");return}l=bt("SPSetMultiSelectSizes",i.multiSelectColumn);f=n("<select id='"+l+"' ><\/select>").appendTo(r.container);f.css({width:"auto",height:0,visibility:"hidden"});n(r.master.candidateControl).find("option").each(function(){f.append("<option value='"+n(this).html()+"'>"+n(this).html()+"<\/option>")});n(r.master.resultControl).find("option").each(function(){f.append("<option value='"+n(this).val()+"'>"+n(this).html()+"<\/option>")});o=f.width()+5;u=o;(i.minWidth>0||i.maxWidth>0)&&(o<i.minWidth&&(o=i.minWidth),u<i.minWidth&&(u=i.minWidth),u>i.maxWidth&&(u=i.maxWidth));s=o;n(r.master.candidateControl).css("width",s+"px").parent().css("width",u+"px");n(r.master.resultControl).css("width",s+"px").parent().css("width",u+"px");f.remove()};n.fn.SPServices.SPScriptAudit=function(t){var i=n.extend({},{webURL:"",listName:"",outputId:"",auditForms:!0,auditViews:!0,auditPages:!0,auditPagesListName:"Pages",showHiddenLists:!1,showNoScript:!1,showSrc:!0},t),f=[["New","NewForm.aspx",!1],["Display","DispForm.aspx",!1],["Edit","EditForm.aspx",!1]],u,o,e;if(n("#"+i.outputId).append("<table id='SPScriptAudit' width='100%' style='border-collapse: collapse;' border=0 cellSpacing=0 cellPadding=1><tr><th><\/th><th>List<\/th><th>Page Class<\/th><th>Page Type<\/th><th>Page<\/th>"+(i.showSrc?"<th>Script References<\/th>":"")+"<\/tr><\/table>"),n("#SPScriptAudit th").attr("class","ms-vh2-nofilter"),(i.auditForms||i.auditViews)&&n().SPServices({operation:"GetListCollection",webURL:i.webURL,async:!1,completefunc:function(t){n(t.responseXML).find("List").each(function(){u=n(this);(i.listName.length===0||u.attr("Title")===i.listName)&&(i.showHiddenLists&&u.attr("Hidden")==="False"||!i.showHiddenLists)&&(i.auditForms&&n().SPServices({operation:"GetListContentTypes",webURL:i.webURL,listName:u.attr("ID"),async:!1,completefunc:function(t){n(t.responseXML).find("ContentType").each(function(){var e,t;if(n(this).attr("ID").substring(0,6)!=="0x0120"){for(e=n(this).find("FormUrls"),r=0;r<f.length;r++)n(e).find(f[r][0]).each(function(){pt(i,u,"Form",this.nodeName,(i.webURL.length>0?i.webURL:n().SPServices.SPGetCurrentSite())+l+n(this).text());f[r][2]=!0}),f[r][2]||(t=u.attr("DefaultViewUrl"),pt(i,u,"Form",f[r][0],t.substring(0,t.lastIndexOf(l)+1)+f[r][1]));for(r=0;r<f.length;r++)f[r][2]=!1}})}}),i.auditViews&&n().SPServices({operation:"GetViewCollection",webURL:i.webURL,listName:u.attr("ID"),async:!1,completefunc:function(t){n(t.responseXML).find("View").each(function(){pt(i,u,"View",n(this).attr("DisplayName"),n(this).attr("Url"))})}}))})}}),o=0,e=[],typeof i.auditPagesListName=="string"?(o=1,e.push(i.auditPagesListName)):(o=i.auditPagesListName.length,e=i.auditPagesListName),i.auditPages)for(r=0;r<o;r++)n().SPServices({operation:"GetList",async:!1,cacheXML:!0,webURL:i.webURL,listName:e[r],completefunc:function(t){n(t.responseXML).find("List").each(function(){u=n(this)})}}),n().SPServices({operation:"GetListItems",async:!1,webURL:i.webURL,listName:e[r],CAMLQuery:"<Query><Where><Neq><FieldRef Name='ContentType'/><Value Type='Text'>Folder<\/Value><\/Neq><\/Where><\/Query>",CAMLViewFields:"<ViewFields><FieldRef Name='Title'/><FieldRef Name='FileRef'/><\/ViewFields>",CAMLRowLimit:0,completefunc:function(t){n(t.responseXML).SPFilterNode("z:row").each(function(){var t=n(this).attr("ows_FileRef").split(";#")[1],r=n(this).attr("ows_Title"),f=typeof r!="undefined"?r:"";t.indexOf(".aspx")>0&&pt(i,u,"Page",f,l+t)})}});n("#SPScriptAudit tr[class='ms-alternating']:even").removeAttr("class")};n.fn.SPServices.SPArrangeChoices=function(t){var u=n.extend({},{listName:n().SPServices.SPListNameFromUrl(),columnName:"",perRow:99,randomize:!1},t),f=!1,e=[],i,o=n().SPServices({operation:"GetList",async:!1,cacheXML:!0,listName:u.listName});o.done(function(){n(o.responseXML).find("Field[DisplayName='"+u.columnName+"']").each(function(){return f=n(this).attr("FillInChoice")==="TRUE"?!0:!1,!1});var t=gi(u.columnName),h=n(t).find("tr").length,s=0,c,l;for(n(t).find("tr").each(function(){s++;f&&s===h-1?c=n(this).find("td").html():f&&s===h?l=n(this).find("td").html():e.push(n(this).html())}),i="<TR>",u.randomize&&e.sort(pr),r=0;r<e.length;r++)i+=e[r],(r+1)%u.perRow==0&&(i+="<\/TR><TR>");i+="<\/TR>";f&&(i+="<TR><TD colspan='99'>"+c+l+"<\/TD><\/TR>");n(t).find("tr").remove();n(t).find("table").append(i)})};n.fn.SPServices.SPAutocomplete=function(t){var i=n.extend({},{webURL:"",sourceList:"",sourceColumn:"",columnName:"",CAMLQuery:"",CAMLQueryOptions:"<QueryOptions><\/QueryOptions>",CAMLRowLimit:0,filterType:"BeginsWith",numChars:0,ignoreCase:!1,highlightClass:"",uniqueVals:!1,maxHeight:99999,slideDownSpeed:"fast",processingIndicator:"_layouts/images/REFRESH.GIF",debug:!1},t),e,u=n("input[Title='"+i.columnName+"']"),s,o,f;if(u.css("position",""),s=u.css("color"),o=u.css("width"),u.html()===null&&i.debug){c("SPServices.SPAutocomplete","columnName: "+i.columnName,"Column is not an input control or is not found on page");return}u.closest("span").find("br").remove();u.wrap("<div>");f=bt("SPAutocomplete",i.columnName);u.after("<div><ul id='"+f+"' style='width:"+o+";display:none;padding:2px;border:1px solid #2A1FAA;background-color:#FFF;position:absolute;z-index:40;margin:0'><\/div>");n("#"+f).css("width",o);n(u).keyup(function(){var h=n(this).val(),t,o,l;if(n("#"+f).hide(),h.length<i.numChars)return!1;for(u.css({"background-image":"url("+i.processingIndicator+")","background-position":"right","background-repeat":"no-repeat"}),t=[],o="<Query><OrderBy><FieldRef Name='"+i.sourceColumn+"'/><\/OrderBy><Where>",i.CAMLQuery.length>0&&(o+="<And>"),o+="<"+i.filterType+"><FieldRef Name='"+i.sourceColumn+"'/><Value Type='Text'>"+h+"<\/Value><\/"+i.filterType+">",i.CAMLQuery.length>0&&(o+=i.CAMLQuery+"<\/And>"),o+="<\/Where><\/Query>",n().SPServices({operation:"GetListItems",async:!1,webURL:i.WebURL,listName:i.sourceList,CAMLQuery:o,CAMLQueryOptions:i.CAMLQueryOptions,CAMLViewFields:"<ViewFields><FieldRef Name='"+i.sourceColumn+"' /><\/ViewFields>",CAMLRowLimit:i.CAMLRowLimit,completefunc:function(r){var u=i.ignoreCase?h.toUpperCase():h;n(r.responseXML).SPFilterNode("z:row").each(function(){var r=n(this).attr("ows_"+i.sourceColumn),f=i.ignoreCase?n(this).attr("ows_"+i.sourceColumn).toUpperCase():n(this).attr("ows_"+i.sourceColumn),e;i.filterType==="Contains"?(e=f.indexOf(u),e>=0&&(!i.uniqueVals||n.inArray(r,t)===-1)&&t.push(n(this).attr("ows_"+i.sourceColumn))):u!==f.substr(0,u.length)||i.uniqueVals&&n.inArray(r,t)!==-1||t.push(n(this).attr("ows_"+i.sourceColumn))})}}),l="",r=0;r<t.length;r++){if(i.highlightClass.length>0){var p=new RegExp(h,i.ignoreCase?"gi":"g"),c=t[r].match(p),v=0;for(e=0;e<c.length;e++){var a=t[r].indexOf(c[e],v),w=a+c[e].length,y="<span class='"+i.highlightClass+"'>"+c[e]+"<\/span>";t[r]=t[r].substr(0,a)+y+t[r].substr(w);v=a+y.length}}l+="<li style='display: block;position: relative;cursor: pointer;'>"+t[r]+"<\/li>"}n("#"+f).html(l);n("#"+f+" li").click(function(){n("#"+f).fadeOut(i.slideUpSpeed);u.val(n(this).text())}).mouseover(function(){n(this).css({cursor:"hand",color:"#ffffff",background:"#3399ff"})}).mouseout(function(){var t={cursor:"inherit",color:s,background:"transparent"};n(this).css(t)});t.length>0&&n("#"+f).slideDown(i.slideDownSpeed);u.css("background-image","")})};n.fn.SPServices.SPGetQueryString=function(t){for(var i,e,o=n.extend({},{lowercase:!1},t),u={},f=location.search.slice(1).split("&"),r=0;r<f.length;r++)i=f[r].split("="),e=o.lowercase?i[0].toLowerCase():i[0],u[e]=decodeURIComponent(i[1]||"");return u};n.fn.SPServices.SPListNameFromUrl=function(t){var i=n.extend({},{listName:""},t);if(i.listName.length>0)return v.thisList=i.listName,v.thisList;if(v.thisList.length>0)return v.thisList;var r=location.href,u=r.substring(0,r.indexOf(".aspx")),f=decodeURIComponent(u.substring(0,u.lastIndexOf(l)+1)).toUpperCase();return n().SPServices({operation:"GetListCollection",async:!1,completefunc:function(t){n(t.responseXML).find("List").each(function(){var t=n(this).attr("DefaultViewUrl"),i=t.substring(0,t.lastIndexOf(l)+1).toUpperCase();if(f.indexOf(i)>0)return v.thisList=n(this).attr("ID"),!1})}}),v.thisList};n.fn.SPServices.SPUpdateMultipleListItems=function(t){var i=n.extend({},{webURL:"",listName:"",CAMLQuery:"",batchCmd:"Update",valuepairs:[],completefunc:null,debug:!1},t),u,e=[],o=[],f,r;for(n().SPServices({operation:"GetListItems",async:!1,webURL:i.webURL,listName:i.listName,CAMLQuery:i.CAMLQuery,CAMLQueryOptions:"<QueryOptions><ViewAttributes Scope='Recursive' /><\/QueryOptions>",completefunc:function(t){n(t.responseXML).SPFilterNode("z:row").each(function(){e.push(n(this).attr("ows_ID"));var t=n(this).attr("ows_FileRef");t="/"+t.substring(t.indexOf(";#")+2);o.push(t)})}}),r="<Batch OnError='Continue'>",u=0;u<e.length;u++){for(r+="<Method ID='"+u+"' Cmd='"+i.batchCmd+"'>",f=0;f<i.valuepairs.length;f++)r+="<Field Name='"+i.valuepairs[f][0]+"'>"+ft(i.valuepairs[f][1])+"<\/Field>";r+="<Field Name='ID'>"+e[u]+"<\/Field>";o[u].length>0&&(r+="<Field Name='FileRef'>"+o[u]+"<\/Field>");r+="<\/Method>"}r+="<\/Batch>";n().SPServices({operation:"UpdateListItems",async:!1,webURL:i.webURL,listName:i.listName,updates:r,completefunc:function(n){i.completefunc!==null&&i.completefunc(n)}})};n.fn.SPServices.SPGetListItemsJson=function(t){var i=n.extend({},{webURL:"",listName:"",CAMLViewName:"",CAMLQuery:"",CAMLViewFields:"",CAMLRowLimit:"",CAMLQueryOptions:"",changeToken:"",contains:"",mapping:null,mappingOverrides:null,debug:!1},t),u,r={},f=[],e=n.Deferred(),o=n().SPServices({operation:"GetListItemChangesSinceToken",webURL:i.webURL,listName:i.listName,CAMLViewName:i.CAMLViewName,CAMLQuery:i.CAMLQuery,CAMLViewFields:i.CAMLViewFields,CAMLRowLimit:i.CAMLRowLimit,CAMLQueryOptions:i.CAMLQueryOptions,changeToken:i.changeToken,contains:i.contains});return o.done(function(){var h="SPGetListItemsJson"+i.webURL+i.listName,t=n(o.responseXML),s,c,l;if(u=t.find("Changes").attr("LastChangeToken"),t.find("listitems Changes Id[ChangeType='Delete']").each(function(){f.push(n(this).text())}),i.mapping===null?t.find("List > Fields > Field").each(function(){var t=n(this),i=t.attr("Type");n.inArray(i,rr)>=0&&(r["ows_"+t.attr("Name")]={mappedName:t.attr("Name"),objectType:t.attr("Type")})}):r=i.mapping,i.mappingOverrides!==null)for(s in i.mappingOverrides)r[s]=i.mappingOverrides[s];n.isEmptyObject(r)?r=n(document).data(h):n(document).data(h,r);c=t.SPFilterNode("z:row").SPXmlToJson({mapping:r,sparse:!0});l={changeToken:u,mapping:r,data:c,deletedIds:f};e.resolveWith(l)}),e.promise()};n.fn.SPServices.SPConvertDateToISO=function(t){var u=n.extend({},{dateToConvert:new Date,dateOffset:"-05:00"},t),i="",r=u.dateToConvert;return i+=r.getFullYear()+"-",i+=lt(r.getMonth()+1)+"-",i+=lt(r.getDate()),i+="T"+lt(r.getHours())+":",i+=lt(r.getMinutes())+":",i+(lt(r.getSeconds())+"Z"+u.dateOffset)};n.fn.SPFilterNode=function(n){return this.find("*").filter(function(){return this.nodeName===n})};n.fn.SPXmlToJson=function(t){var i=n.extend({},{mapping:{},includeAllAttrs:!1,removeOws:!0,sparse:!1},t),r,u=[];return this.each(function(){var f={},e=this.attributes;for(i.sparse||n.each(i.mapping,function(){f[this.mappedName]=""}),r=0;r<e.length;r++){var o=e[r].name,t=i.mapping[o],s=typeof t!="undefined"?t.mappedName:i.removeOws?o.split("ows_")[1]:o,h=typeof t!="undefined"?t.objectType:undefined;(i.includeAllAttrs||t!==undefined)&&(f[s]=yi(e[r].value,h))}u.push(f)}),u};n.fn.SPServices.SPFindPeoplePicker=function(t){var i=n.extend({},{peoplePickerDisplayName:"",valueToSet:"",checkNames:!0},t),f=n("nobr").filter(function(){return n(this).contents().eq(0).text()===i.peoplePickerDisplayName}).closest("tr"),r=f.find("div[name='upLevelDiv']"),e=f.find("img[Title='Check Names']:first"),o,u;return i.valueToSet.length>0&&r.html(i.valueToSet),i.checkNames&&e.click(),o=n.trim(r.text()),u=[],r.children("span").each(function(){var i=n(this).find("div[data]").attr("data"),t={},r,f;typeof i!="undefined"?(r=n.parseXML(i),f=n(r),f.find("DictionaryEntry").each(function(){var i=n(this).find("Key").text(),r=n(this).find("Value").text();t[i]=r}),u.push(t)):n().SPServices({operation:"GetUserInfo",async:!1,cacheXML:!0,userLoginName:n(this).attr("title"),completefunc:function(i){n(i.responseXML).find("User").each(function(){n.each(this.attributes,function(n,i){var r=i.name,u=i.value;t[r]=u});u.push(t)})}})}),{row:f,contents:r,currentValue:o,checkNames:e,dictionaryEntries:u}};n.fn.SPServices.Version=function(){return ir};n.fn.SPServices.SPDropdownCtl=function(t){var r=n.extend({},{displayName:""},t),i={},s=n().SPServices.SPGetStaticFromDisplay({listName:n().SPServices.SPListNameFromUrl(),columnDisplayName:r.displayName}),f,u,o;return i.Type=(i.Obj=n("select[Title='"+r.displayName+"']")).length===1?e.simple:(i.Obj=n("input[Title='"+r.displayName+"']")).length===1?e.complex:(i.Obj=n("select:regex(id, ("+s+")(_)[0-9a-fA-F]{8}(-))")).length===1?e.simple:(i.Obj=n("select[ID$='SelectCandidate'][Title^='"+r.displayName+" ']")).length===1?e.multiSelect:(i.Obj=n("select[ID$='SelectCandidate'][Title$=': "+r.displayName+"']")).length===1?e.multiSelect:(i.Obj=n("select[ID$='SelectCandidate'][Title$='\""+r.displayName+"\".']")).length===1?e.multiSelect:(i.Obj=n("select[ID$='SelectCandidate'][Title$=' "+r.displayName+"']")).length===1?e.multiSelect:null,i.Type===null&&(f=gi(r.displayName),f!==undefined&&(u=f.find("select[title^='"+r.displayName+"'][id$='$Lookup']"),u&&u.length===1&&(i.Type=e.simple,i.Obj=u))),i.Type===e.complex?i.optHid=n("input[id='"+i.Obj.attr("optHid")+"']"):i.Type===e.multiSelect&&(i.container=i.Obj.closest("span"),i.MultiLookupPickerdata=i.container.find("input[id$='"+ei+"_data'], input[id$='"+oi+"_data']"),o=i.container.find("[id$='AddButton']").attr("id"),i.master=window[o.replace(/AddButton/,ei+"_m")]||window[o.replace(/AddButton/,oi+"_m")]),i};nr={"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"};tr={"&amp;":"&","&quot;":'"',"&lt;":"<","&gt;":">"};n.expr[":"].regex=function(n,t,i){var r=i[3].split(","),u=/^(data|css):/,f={method:r[0].match(u)?r[0].split(":")[0]:"attr",property:r.shift().replace(u,"")},e=new RegExp(r.join("").replace(/^\s+|\s+$/g,""),"ig");return e.test(jQuery(n)[f.method](f.property))}}(jQuery);typeof NewsWebUIResources=="undefined"&&(window.NewsWebUIResources={DeleteSubscriptionFailed:"Failed to unsubscribe.",NewsInterestSettingsLink:"Edit News Interests",FeedAddedCloseWindow:"Added feed for '{0}'. You can now close this window.",EmailOption4Hours:"Every 4 Hours",DetailHeaderNewItems:"New Items",AddFeedsSectionTitle:"Add feeds:",NextPage:"Next Page",DeleteSubscriptionAction:"Unsubscribing...",DeleteFeedSuccess:"Feed was successfully deleted.",NoMatchingNewsInterestArticles:"There are no matching articles.",SubGrid_FeedName:"Feed Name",NoNewsItemsToDisplay:"There are no items to display.",FeedDetailsTooltip:"View feed details",SubGrid_AutoTag:"Tag",LikeVerb:"Like",PingFeedSuccess:"Feed was successfully updated.",AddFeedPageTitle:"Add {0} Feed",FeedSearchTooltip:"Search",GridView_SubscriptionEmpty:"No subscriptions are available to be managed.",DeleteVerb:"Delete",YammerPreauthInstructions:"You must be signed in to Yammer on this computer before attempting to subscribe to your feed.  If you are not currently signed in, click {0} and do so.",CredentialManageLabel:"Add or edit credentials",SubscriptionSettingsLink:"Edit Subscriptions",AddSubscriptionFromGoogleReader:"Google Reader",CommentSaveSuccess:"Your comment was successfully saved.",YammerLinkInstructions:"Authorize Yammer to access NewsGator by clicking {0}.",NewsInterestsPageTitle:"My News Interests",LikesThis:"{0} likes this.",DynamicsOnWord:"On",YouLikeThis:"You like this.",YammerTextInstructions:"Copy and paste Yammer code here",ManageFeeds:"Manage Feeds",HideCommentsLink:"Hide Comments",NewsInterestsDescription:"Articles matching your interests will be added to your newsfeed and/or emailed to you based on your settings. Enter your news interests separated by semi-colons.",CancelVerb:"Cancel",NewsStreamDigest:"News Stream Digest",EmptySearchTerm:"Please enter a search term.",UnexpectedError:"An unexpected error has occurred.",DetailHeaderServerId:"ServerId",ConfigureContentQuery:"Please select a news query.",PreviewNewsInterests:"Preview recent articles that match your interests.",NewsInterestsSubscriptions:"My Subscriptions",TagItLink:"Tag it",PingFeedFailed:"Feed failed to update.",AddSubscriptionFromYammer:"Yammer",PingFeedAction:"Pinging Feed...",AddSubscriptionFromDynamics:"Dynamics",PreviousPage:"Previous Page",SalesforceSSONotEnabled:"Salesforce Single Signon is not enabled.",LikeSaveSuccess:"Your like was successfully saved.",ViewLikesLink:"View likes",PageTitle:"Subscriptions",NoSubsForAudience:"There are no subscriptions associated with this audience.",FollowAllSubscribedFeeds:"Follow all subscriptions in your newsfeed",YammerLinkHereVerb:"here",DeleteFeedConfirmation:"The feed and all associated data will be deleted.  This operation cannot be undone.  Are you sure you would like to delete this feed?",ConfigureSearchLabel:"Please configure a search term.",oAuthAuthenticationPageTitle:"oAuth Authentication Page",EmailOptionNever:"Never",EmailOptionDaily:"Daily",SubGrid_Following:"Follow",FeedDeleteTooltip:"Delete this feed",AuthorizeVerb:"Authorize",EditExistingSubscriptionsLink:"Edit My Subscriptions",CloseVerb:"Close",AddSubscriptionByUrl:"By URL",ShareItLink:"Share it",ShareItDialogDescription:"NOTE: The article's link is automatically added to your message.",DeleteSubscriptionSuccess:"Successfully unsubscribed.",IncludeExistingSubscriptionsTitle:"Include existing subscriptions",YammerAuthInstructions:"Click to finalize authorization",DetailHeaderLastRetrieve:"Last Retrieved",AddFeedDescription_Dynamics:"To add a feed of your Dynamics wall, enter the username (in the form of domain\\username)  and password for your Dynamics account.",SaveVerb:"Save",DeleteFeedFailed:"Failed to delete feed.",DetailHeaderTotalTime:"Total Retrieval Time",AddSubscriptionFromTwitter:"Twitter",DynamicsWallWord:"'s wall.",FollowNoSubscribedFeeds:"Follow no subscriptions in your newsfeed",PingVerb:"Ping",AutoTagDescription:"The tag can only have alpha-numeric characters and the following punctuation: . – ‘ _ \\ The tag must end in an alphanumeric character.",BadlyFormedTag:"The tag is not well formed.  It may not contain spaces and must not end with punctuation.",NewsInterests:"My News Interests",Loading:"Loading",GetNewsError:"There was an error retrieving the news.",SubGrid_Delete:"Delete",DetailHeaderItemsUpdated:"Items Updated",StepPrerequisiteLabel:"Prerequisite",FollowSubscriptionFailed:"Failed to change your follow selection.",AddFeedDescription_SalesForce:"To add a feed of your SalesForce Chatter information, enter the username (usually an email address) and password for your SalesForce account.",DeleteFeedAction:"Deleting Feed...",NoNewsInterestsEntered:"Please enter an interest.",EmailOptionHourly:"Hourly",CommentVerb:"Comment",FeedSearchClearTooltip:"Clear",FollowNewsActivityOption:"Follow in your newsfeed",DetailHeaderHtmlCallDuration:"HTML Call Duration",PreviewContentTooltip:"View the most recent articles matching this query",NotConfiguredMessage:"NewsGator News Stream is not configured to run on this Web Application.",AddSubscriptionFromSalesForce:"SalesForce",AlternateSearchTerm:"actual search",SubGrid_Status:"Status",ViewCommentsLink:"View comments",PreviewVerb:"Preview",FollowSubscriptionSuccess:"Follow selection was changed.",DeleteSubscriptionConfirmation:"Your subscription will be removed.  Are you sure you want to continue?",DetailHeaderHttpStatusCode:"Http Status Code",FollowSubscriptionAction:"Updating...",AddANewSubscriptionTitle:"Add a new subscription",Step2Label:"Step 2",FollowSubscribedFeedsOption:"Follow in your newsfeed",Step1Label:"Step 1",FeedPingTooltip:"Ping/update this feed",Step3Label:"Step 3"});typeof ngText=="undefined"&&(window.ngText={TourNextVerb:"Next",NoFileAlert:"Please attach a file.",UnFollowUpVerb:"Clear Follow–up",ExchangeAccepted:"Accepted",DeleteComment:"Delete Comment",CalShortJuly:"Jul",CalShortJune:"Jun",CancelButtonText:"Cancel",CommentCommunityPrivacyWarning:"CAUTION: This post is public and can be seen by people outside of {0}.",ExchangeTask:"Task: {0}",ExchangeFrom:"From:",ExchangeTentative:"Tentative",TourAddTileTitle:"Add a new tile",timeAgoYear:"about a year ago",timeAgoHour:"about an hour ago",timeAgoDays:"%d days ago",ExchangePriorityLow:"Low",CalFridayMin:"Fr",OfflineError:"The NewsGator Social Platform is offline. Please reload the page in a few minutes.",CommPortal_PromotedVerb:"Promote this community",UpdateVerb:"Update",RibbonTileNoData:"At this time we could not find data for this tile.",FollowUpEmailBodyText:"Send this email to mark the activity event for follow-up.",TourFilterStreamDesc:"You can change what your main stream view displays, on the fly, using this dropdown menu.  Choose from a selection of preset filters, including one filter for each of your colleagues, communities, and spheres.",CommunityWebPartIncompatibility2:"The {0} is incompatible with sites that are not NewsGator Communities. ",IdeaStateDesc_Closed:"This idea has been closed.",SubscribeGroupQuestionInput:"Notify me when questions are posted to this sphere",TourTileColumnsTitle:"Tile columns",InvalidOperationError:"This operation is not valid.",ExchangeViewCalendarItemPageTitle:"Appointment",TourDirectQuestionTitle:"Send a Private Message",Filter_FollowUp:"Follow–up",TourSearchTitle:"Integrated search",Spheres:"Spheres",SuggestedTags:"Suggested Tags",TourFilterStreamTitle:"Filter your main stream view",PollOptionLengthError:"You must add at least two unique options.",SubscribeMicroblogInput:"Notify me when microblogs are posted to this community",CalJanuary:"January",CapabilityMustHaveNameMessage:"You must enter a name.",HideCommentsFormat:"Hide all {0} comments",ExchangeMyResponse:"My Response: {0}",RecommendationRecentColleague:"This person recently added you as a colleague.",VotesTextSingular:"1 vote",TourStreamItemControlsTitle:"Stream item controls",ExchangeStatusWaitingOnOthers:"Waiting On Others",AskMeAboutLabel:"Ask Me About",ExchangeStatusComplete:"Complete",TourTileSettingsTitle:"Manage tile",NotificationsLink:"Notifications",InterestsLabel:"Interests",Follow:"Follow",ExchangeBcc:"Bcc:",ExchangeTo:"To:",ExchangeCc:"Cc:",BackVerb:"Back",LikeVerb:"Like",MyCommunitiesDropDownLabel:"Go to my communities",RecentCommunitiesNoResult:"There are no available communities.",TimeoutError:"The request timed out.",ExchangeAllDayMeeting:"(All Day)",TagFilterStreamHeader:"Conversations",TopUserActivityReportEventsColumn:"Events",TourTileColumnsDesc:"This column, showing the main stream view, always remains visible.  Other tile's columns appear to the right of it, as you open them (or navigate to them) by clicking their tile. You can click any of the other columns on the header and drag to reposition them.",TourSearchDesc:"“Search” will let you look for information from your stream, communities, documents and people all in one spot.",ImageNofM:"{0} of {1}",UnFollowUpTitle:"Remove from my Follow–up filter",TourRecommendationsTileDesc:"The “recommendations” tile will help you find new colleagues and communities to follow.",CalMay:"May",ExchangeNewMailItemPageTitle:"New Email Message",TourManageColumnSettingsTitle:"Manage column",ExchangeAcceptButtonText:"Accept",CalSeptember:"September",GoneError:"This content has been removed.",FollowUpVerb:"Follow–up",CalShortDecember:"Dec",VoteVerb:"Vote",AskLabel:"Ask",NoVerb:"No",RecommendationColleagueColleague:"{0} of your colleagues are following this person.",TourStreamContentDeleteDesc:"Hover over the upper right corner of any stream item, and click, to get a content removal menu.  This lets you stop getting items like it in your stream and/or email digest. You may also have the choice to delete the item or report it as being inappropriate.",TopUserActivityReportNameColumn:"Name",ClearSearch:"Clear Search",ViewRemoveOptions:"View options",UnlockEventVerb:"Unlock",AddNoteTitle:"Add Note",SingularComment:"1 comment",ExchangeStatusNotStarted:"Not Started",EventNotificationNoResults:"There are no new notifications.",SubscriptionsLink:"Subscriptions",timeAgoMinutes:"%d minutes ago",ExchangeMeetingResponseSent:"Meeting Response Sent:",TourBeginVerb:"Begin",UserReportLastAction:"Actions in last",AddShareTitle:"Add a microblog and include a link to this page.",YouAndMultipleLikeThis:"You and {0} others like this.",DeleteVerb:"Delete",CommunityWebPartIncompatibility:"The {0} is incompatible with sites that are not communities.",CommonColleaguesLabelSingular:"1 common colleague",ExchangeSendButtonText:"Send",AddToDigestEmail:"Add {0} to my digest emails",PublicGroup:"Public Sphere",ReportNewUserStepCompletedTitle:"# Complete",YouAndAnotherLikeThis:"You and <a href='{0}' class='ngAuthorLink ngAuthorLikeLink' authorId='{1}'>{2}<\/a> like this.",GetLink:"Get Link",VotesNounPlural:"{0} votes",AnswerVerb:"Answer",RibbonTitleTooltip:"Open {0}",TourDirectQuestionDesc:"Click the padlocked speech bubble to send a message privately.  Your message will only be seen by people you mention with the @ symbol.",TourManageColumnSettingsDesc:"Click to toggle open and closed a menu of column viewing options.  Options include changing the width, refreshing the contents, and viewing it in its own window.",NoteTab:"Notes",WorkPhoneLabel:"Work Phone",AskQuestion:"Ask {0} a question about {1}",FullArticle:"FULL ARTICLE",CalTuesdayMin:"Tu",paging_more:"more",RecommendationCommunityPopularity:"This community is popular with {0} people.",NoResults:"There are no results",TourAskQuestionTitle:"Ask a question",TabDigestVerb:"digest",ExchangeViewTaskItemPageTitle:"Task",ReplyToPost:"Reply",UserReportLastByType:"Actions in last 90 days by type",CalMarch:"March",CommunitySpheresTitle:"communities and spheres",ExchangeUnableToRetrieveMessage:"Unable to retrieve email message from Exchange.",CalApril:"April",CalShortMarch:"Mar",ExchangeDeleteButtonText:"Delete",CalShortApril:"Apr",CalOctober:"October",AddTagTitle:"Add Terms",LicenseClearConfirm:"Are you sure? This will clear your current license.",TagTab:"Tags",DeleteAnswer:"Delete Answer",TabNotifyAboutVerb:"instant",ProfilePictureLabel:"Profile Picture",StepVerb:"Step",TourRecommendationsTileTitle:"Recommendations tile",SharePointSocial:"SharePoint",IdeaStateDesc_Pending:"This idea has not been published.",SwitchTo:"Switch to {0}",TourPostControlTitle:"Create stream content",EventsLink:"Events",TourManageSettingsDesc:"“Settings” lets you control what kind of information you see and get notified about.  Decide which event types appear in your main stream view, and manage your notifications, news articles, and spheres.",Following:"Following",CopyToClipboard:"Copy to Clipboard",TourAddTileDesc:"Click this button to create a new tile for yourself.  Choose from one of seven available tile types.  Depending on your choice, you may see additional customization options.",StatusPrompt:"What are you working on?",NoItemsToDisplayActive:"There are no items in the last 30 days.  ",ExchangeMessageSentDetails:"{0} at {1}.",CalSundayMin:"Su",UnLikeVerb:"Unlike",Search:"Search",Saving:"Saving",AddAllVerb:"Add All",CustomCapabilityType:"Custom",YouLikeThis:"You like this.",Filter_CommunityNewsfeed:"Newsfeed",ClearFilter:"Clear Filter",CommPortal_Promoted:"Promoted",TourNotificationsTileDesc:"“notifications” let you know when someone mentions you or responds to you. These items tend to be important.",ExportReportValidationError:"Please specify both a start and end date",AnonLikesThisFragment:"{0} likes this.",GoToCommunity:"Go to community",timeAgoSeconds:"less than a minute ago",PostVerb:"Post",CommunityPrivacyError:"ERROR: You are not allowed to target private communities in the same post as public communities or non-members, nor private communities in response to a public post, nor any other community or person in response to a private post.",SharingPrefix:"Sharing :",EventGroupingCustomTitle:"Custom & miscellaneous activities",ErrorBroadcast:"There was an error submitting your broadcast.",EventGroupingProfileTitle:"Profile updates",AddToInterests:"Add to Interests",CommPortal_UnPromotedVerb:"(Unpromote)",LicenseUpdateSuccessful:"License Successfully Updated.",RecommendationCommunityColleague:"{0} of your colleagues follow this community.",EventGroupingCommunicationTitle:"Communication",MyContentSetupComplete2010:"My Content Site Setup Complete.",MyContentSetupComplete2013:"Skydrive Site Setup Complete.",ExchangeDeleteSuccessful:'"{0}" has been has been moved to the Deleted Items folder.',ReportMessage:"Your name will be sent along with this report.",CommonColleaguesLabelPlural:"{0} common colleagues",TourIntroDesc:"You can restart this tour any time by clicking “tour”.",EditUrlText:"Url:",EditUrlVerb:"Edit Url",BlankAlert:"Cannot save a blank entry.",CommentCountTextPlural:"{0} comments",IgnoreRecommendationVerb:"Ignore this recommendation.",UnauthorizedError:"You do not have permission to perform this action.",LikeTextPlural:"{0} likes",BlankSearchTerm:"Please enter a search term.",paging_more_older:"see older items",ExchangeQueryStringError:"The 'uniqueid' and 'changekey' parameters are required.",AddPostTitle:"Add Post",TourAskQuestionDesc:"Click the question bubble when you want to ask a question or conduct a poll.",Filter_AllPublicItems:"All Public Items",SubscriptionSettingsTitle:"Notification Settings",MembershipNoBadges:"No community badges.",SharedFrom:"From",ExchangeReplyButtonText:"Reply",TourAddPostDesc:"Click the speech bubble to begin creating a public message that your followers will see in their streams.  Also select this to share files such as documents or pictures, or to share links to items in SharePoint.  Most of the time this will already be selected and you may simply begin typing in the box below.",SubscribeCommentInput:"Notify me when comments or answers are posted to this community",ExchangeStatus:"Status:",TourNewUserTileDesc:"If your new user meter isn’t at 100%, click this tile to finish creating your profile.  This will allow others in your organization to learn about your role, background, expertise, and interests, and to see what you look like.",ViewCommentsFormat:"View all {0} comments",ShareTitle:"Share This Post",CommonColleaguesLabelNone:"No common colleagues",AskQuestionTitle:"Ask a Question",KudosHeader:"Kudos",ColleagueIgnored:"Colleague ignored.",TourTileSettingsDesc:'Click to toggle open and closed a menu of tile options.  Options include repositioning or removing the tile, or changing what it displays. (To move, you must click down on and drag the "move tile" option.)',CalJune:"June",CalJuly:"July",CalNext:"Next",CalPrev:"Previous",ExchangeStatusDeferred:"Deferred",ExchangeError:"Error:",Colleagues:"Colleagues",TourAddTileAlternateDesc:"This button also lets you create a new tile.",YouVotedForThisVerb:"You voted for this.",ReportVerb:"Report",RecommendationIgnored:"Recommendation Ignored.",RibbonPostTooltip:"Post to Lookout",DigestFormatChronological:"list items in chronological order",ExchangeDeleteSuccessfulTitle:"Item Deleted:",TourColumnIndicatorDesc:"When there are more columns displayed than will fit on your screen, extra dots appear here, and left/right arrows appear in the upper right of the page.  Click on the dots or the arrows to scroll all the columns together to the left or the right.",LicenseUpdating:"Updating License",GoToOriginalItem:"Go to original item",timeAgoMonths:"%d months ago",timeAgoMinute:"about a minute ago",Filter_Popular:"Popular",PollOption:"Poll Option",SubscribeGroupMicroblogInput:"Notify me when microblogs are posted to this sphere",EditItemError:"You can no longer edit this item.",TourYourTilesDesc:"Each tile represents a unique, configurable slice of the items in your stream, or may contain something else like notifications or recommendations. When you click the tile, you'll be shown its contents in a column.  If the column is already open, any new items will be added above a bold line, helping you to focus on just what is new.  You can add, remove, and edit tiles to suit your stream-reading preferences, or just use the ones that have been pre-configured for you.",ColleagueCountLabelPlural:"You have {0} colleagues",ExpandVerb:"Expand",TotalVotesPrefix:"TOTAL VOTES:",QuestionInCommunityNotificationsLabel:"Questions in subscribed communities",ExchangeDeclineButtonText:"Decline",CapabilityDuplicateNameMessage:"Community tab names must be unique.",ShowLessVerb:"Show Less",CommunitiesOverviewNameColumnDisplay:"Name",ExchangeCancelButtonText:"Cancel",DigestFormatVerb:"format",CalShortFebruary:"Feb",NewsInterestsLink:"News",CollapseVerb:"Collapse",ResponseInCommunityNotificationsLabel:"Responses to an activity in a subscribed communities",Glassboards:"Glassboards",IdeaHeader:"Idea",DigestWhatVerb:"what",TourAddPostTitle:"Post a message",PublicCommunity:"Public community",LinkReplacementText:"(link)",LeavingCommunityConfirmation:"You have left {0}",CommentCountTextSingular:"1 comment",Filter_Newsfeed:"My Newsfeed",LicenseUpdateNotSuccessful:"An error occurred and we could not update your license.",AdministrativeNotifications:"You have administrative notifications.",HashtagAutocompletePrompt:"Type a hashtag",JoinVerb:"Follow",RibbonSettingsVerb:"Settings",TourPostControlDesc:"In this area you can let your colleagues know what you are doing, ask a question, create a poll, share documents, pictures, links, etc., and send private messages.",CommunityTagSavedMessage:"Tags were successfully saved.",DigestWhenVerb:"when",TourCreatePostDesc:"When you've selected the type of post you want to make, click this box to begin typing.  Buttons will appear in the lower left for optional add-ins such as files, links to SharePoint list items, or poll options.  You can use the @ symbol to target your message at people and communities. You can use the # symbol to create hashtags that help Social Sites get your message or question to the right people.",TourTileUnreadCountTitle:"Tile unviewed count",ProfileTermSetError:"Invalid Term: Terms must exist in the termset.",ReportDescription:"Report this item for being abusive or offensive.",TourStreamContentDeleteTitle:"Content removal",CalShortJanuary:"Jan",ExchangeMoreRecipients:"and {0} other recipients...",RecommendationColleagueCommunity:"This person shares {0} community memberships with you.",AddCapabilityButtonText:"Add Custom Tab",MembershipAvatarColumnName:"Avatar",TourNotificationsTileTitle:"Notifications tile",timeAgoDay:"a day ago",CalNovember:"November",Filter_Polls:"Polls",SkipVerb:"Skip",ErrorSavingChanges:"Problem saving changes",Filter_TopNews:"Top News",MembershipDescriptionColumnName:"Community Role",RibbonTitle:"Lookout360",Filter_MyActivities:"My Activities",RemoveHashTagTooltip:"Click to remove the hashtag.",PostLengthError:"The post is too long.  Please limit the number of characters and try again.",TourCreatePostTitle:"Create a post",TourStreamItemControlsDesc:"Every item in your stream has controls that let you do things such as comment, like and mark for follow-up.",TourFinishedTitle:"Tour is finished",ViewThread:"View Full Discussion Thread ",RemoveFromDigestEmail:"Remove {0} from my digest emails",MembershipSaveAction:"Save",RecommendationNoResults:"There are no recommendations",UserEventCountNoData:"There is no user activity to report.",ReportMessageAnonymous:"Your name will not be sent along with this report.",AddColleagues:"Add Colleagues",ExchangeFollowUpMessage:'<p>{1}<\/p><p><a href="{0}">View Item<\/a><\/p>',ConfirmDelete:"Are you sure you would like to delete this item?",GoToColleague:"Go to colleague",AddVerb:"Add",DigestOnOffVerb:"on/off",AddPollOption:"Add an option",CommentNonDiscoverableCommunityWarning:"CAUTION: This post is public and {0} is non-discoverable.  This could cause people outside of {0} to discover it.",ExchangeAcceptTentativeButtonText:"Tentatively Accept",RefreshVerb:"Refresh",PagingText:"Page {0} of {1}",CommentsFormat:"{0} comments",DigestFormatGroup:"group items by communities, colleagues, and my activities",ViewPost:"View Full Blog Post",ViewVerb:"View",CalShortSeptember:"Sep",MyColleagues:"My Colleagues",CommunityRequestAccess:"Request access to follow the {0} community",CalFebruary:"February",ExchangeImportanceSentWith:"This message was send with {0} importance.",MembershipUpdateAction:"Edit",StepFinishVerb:"Start the tour",AlertVerb:"Alert",NewUserValidationText:'To complete this step fill in the "{0}" above.',PrivateVerb:"Private",AttemptingToStopFollowingCommunity:"Attempting to Stop Following Community",CharactersRemaining:"{0} characters remaining",ReplyToThread:"Reply to Thread",ExchangeStatusInProgress:"In Progress",ExchangeViewMailItemPageTitle:"Email Message",CommunityPrivacyUserWarning:"WARNING: You are targeting a person from a private community.  Only people that are following this community will be able to see this post.",NoThumbnails:"No Thumbnail",LeaveVerb:"Stop Following",NoItemsInActivityFeed:"There are no items in your feed. To start socializing, add some colleagues and let people know what you are working on!",OkButtonText:"Ok",TourFinishedDesc:"You have completed the tour of the Lookout View.  Now go try it out!",MembershipBadgingColumnName:"Community Badges",Question:"Question",SubmittedByPrefix:"Submitted by",ShareTab:"Share",ShareWarning:"Warning : this item is private and sharing it will cause it to be publicly visible.",RequestError:"An unexpected error occurred. We were unable to process your request.",PeopleLikeThisFormat:"{0} people like this",NoItemsToDisplay:"There are no items to display.",ExchangeForwardButtonText:"Forward",TagFilterExpertHeader:"Experts",CloseVerb:"Close",Filter_Messages:"Private Messages",BroadcastImgAlt:"Broadcast Event",AddSummary:"Add summary text",HideActivities:"Hide all {0}",UserReport90Days:"90 days",ExchangeMeetingTime:"{0} to {1} {2}",RibbonPreventLoading:"Hide on this page",IgnoreVerb:"Ignore",ColleagueCountLabelSingular:"You have 1 colleague",SearchNoResults:"We did not find any results for '{0}'.",HideActivityTypeConfirmation:"You are choosing to hide all {0} activities in your personal Newsfeed. They will still appear in community Newsfeeds. You can show {0} activities by changing your profile's NewsFeed Settings.  Do you still want to continue?",DeleteActivityConfirmation:"Are you sure you want to delete this item?",PrivacyLevelChangedPublicToPrivate:"All authenticated users will no longer be able to access this site and security will no longer be inherited from the parent site.  No one will have access unless you give them access.",timeAgoYears:"%d years ago",MyContentPleaseWait:"Please Wait:",UpdateProfileLink:"Update Profile",timeAgoMonth:"about a month ago",RssImgAlt:"Rss Event",timeAgoHours:"about %d hours ago",Glassboard:"Glassboard",ExchangeMarkUnreadButtonText:"Mark Unread",LeaveCommunityText:"Stop Following Community",EventGroupingContentTitle:"Content",StepSaveContinueVerb:"Save and Continue",CapabilityTypeText:"Type:",TourExpandNewsDesc:"A general post",MembershipIsMemberColumnName:"Is Following",NoCommunityMembership:"You are not following any communities.",LookoutExpandVerb:"Expand",Communities:"Communities",ExchangeMarkCompleteButtonText:"Mark Complete",NoItemsToDisplayUserProfilePage:"{0} has no recent activities.",NewUserCompletedText:'Now that you have completed the new user setup you are ready to move on. Click "start the tour" to get a brief introduction of the site features. You can always come back to this setup to make changes or find them in your user profile.',EventGroupingSocialTitle:"Social networking",GetLinkInstructions:"Copy to clipboard (Ctrl+C, Enter)",CalWednesdayMin:"We",HideVerb:"Hide",FollowingCommunityConfirmation:"You are now following {0}",AboutMeLabel:"About Me",UserReport30Days:"30 days",ViewCommunities:"View All Communities",NoAdminNotifications:"There are no notifications for you to review.",IgnoringColleague:"Ignoring Colleague",RestartVerb:"Restart",ShareDefaultText:"Sharing >>>",UserReport60Days:"60 days",HideAnswersFormat:"Hide all {0} answers",TourMyCommunityTitle:"Go to my communities",SaveVerb:"Save",OkayVerb:"Okay",ClickToView:"Click here to view",SubscribeGroupCommentInput:"Notify me when comments or answers are posted to this sphere",NameVerb:"name",ViewDetailsVerb:"View Details",ExchangeStartDate:"Start Date:",ReportConfirmation:"Abuse report sent.",MembershipActionsColumnName:"Actions",EventNotFoundError:"The activity event was not found. It may have been deleted.",ExchangeFollowUpSubject:'Follow Up: "{0}"',ViewLessVerb_HideComments:"Hide comments",RibbonPromptAuth:"Authenticate with SocialSites",NoSubject:"(No Subject)",VideoHeader:"Video",EditVerb:"Edit",NoMatchesFound:"No matches were found.",LookoutLeaveVerb:"Leave",AttachFile:"Attach File",CommunityPrivacyWarning:"CAUTION: Your message will be seen by people outside of {communityName}. We recommend you remove other people and communities from this message.",ShowAllVerb:"Show All",ColleagueAdded:"Colleague was added successfully.",AddAllTagTooltip:"Click to add all suggestions as hashtags.",CalMondayMin:"Mo",TourNewUserTileTitle:"Profile setup tile",TourYourTilesTitle:"Your tiles",ExchangeTaskFollowUpTitle:"Follow-Up: {0}",StepFinishTitle:"Complete",YesVerb:"Yes",AdminNotificationsResolution:"Resolution Steps:",AnswerCountTextPlural:"{0} answers",ExchangeMarkReadButtonText:"Mark Read",CalThursdayMin:"Th",MembershipJoinDateColumnName:"Following Since",IdeaStateDesc_Promoted:"This idea has been promoted.",NoCommunitiesMessage:"There are no communities to display.",PersonalActivityNotValidFromHere:"Personal Activity Web Part is not allowed from here.",AttemptingToFollowCommunity:"Attempting to Follow Community",SubscribeQuestionInput:"Notify me when questions are posted to this community",IdeaStateDesc_Implemented:"This idea has been implemented.",ExchangePercentFormat:"{0}%",TourColumnIndicatorTitle:"Scrolling through columns",TourManageSettingsTitle:"Content settings",NewUserHeader:"New User Setup",ExchangeTaskFollowUpBody:'<p>Follow-up on Activity Stream Item: {0}<\/p><p><a href="{1}">View Item<\/a><\/p>',SendVerb:"Send",LikeEmailBodyText:"Send this email to like the activity event.",DirectMessageNoTargetError:"You must target at least one person.",Lookout:"Lookout",ViewAnswersFormat:"View all {0} answers",Loading:"Loading",LikeTextSingular:"1 like",EventNoSettingsAvailable:"No settings available at this time",MicroblogInCommunityNotificationsLabel:"Posts in subscribed communities",MyContentSetup2010:"Setting Up My Content Site...",MyContentSetup2013:"Setting Up Skydrive Site...",ViewCommentsFormat2:"View Comments ({0})",MarkAnswerVerb:"Mark as Answer",TourExpandNewsTitle:"Expand news",ConflictError:"The item could not be created because it already exists.",MembershipCancelAction:"Cancel",ViewLessVerb:"View less",ExchangePriorityHigh:"High",ExchangePriorityNormal:"Normal",AddToAskMeAbout:"Add to Ask Me About",SubmittingBroadcast:"Submitting Broadcast...",TourIntroTitle:"Resuming this tour",StepBackVerb:"Back",AdminNotificationsMessage:"Message:",UpdatingMemberNotification:"Updating Member",ExchangeDueDate:"Due Date:",BlankSendAlert:"Cannot send a blank entry.",suffixFromNow:"from now",TourStreamRefreshTitle:"Refresh the main view",CapabilityMustHaveNameMessage2:"All community tabs must have a name.",CommentPrivacyWarning:"CAUTION: This post is private and targeting a person or community could cause people outside of the intended audience to see the message.",AutocompletePrompt:"Type a person or community name",LockEventVerb:"Lock",AutocompleteNoResults:"No results found for {0}",TourStreamRefreshDesc:"The main stream view has a refresh button.  Click to update the contents of the currently-displayed filter.",NotCompleted:"not completed",ExchangeMessageSentTitle:"Message Sent:",MembershipNameColumnName:"Name",CommentVerb:"Comment",RecognitionHeader:"Recognition",AnswerCountTextSingular:"1 answer",UnMarkAnswerVerb:"Unmark as Answer",FollowVerb:"Follow",Filter_AllPublicMicroblogs:"All Public Microblogs",CalAugust:"August",DigestSendTimePlaceholder:"Choose a time",DirectMessageCommunitiesError:"You can only target people in a private message.",TourBackVerb:"Back",TourMyCommunityDesc:"After you’ve followed some communities and spheres, “go to my communities” gives you an easy way to go to them.",UserReportLastActivityDate:"Date of last activity",Community:"Community",VoteRemoveVerb:"Remove your vote",PrivateCommunity:"Private community",CommunityPageResetText:"Reset",AddingColleague:"Adding colleague",ExchangeReplyToAllButtonText:"Reply All",ShareVerb:"Share",JoinCommunityText:"Follow Community",PrivateMessageHeader:"Private Message",PrivateGroup:"Private Sphere",InvalidSearchInput:"The search term provided is invalid.",CopiedToClipboard:"Copied to Clipboard",MyContentSuccess:"Success:",ViewSingleComment:"View Comment",MiniBadge:"Recent Badges",RemoteSource:"Source: ",AddHashTagTooltip:"Click to add a hashtag, which will route this event to the appropriate people/communities. ",CalDecember:"December",SendEmailLabel:"Send an email",DeleteEvent:"Delete this activity event",AutocompletePersonPrompt:"Type a person's name",ExchangePercentComplete:"Percent Complete:",SocialSitesProfileWebPartTitle:"My Social Sites Profile",UpdateSaved:"Update saved.",MicroblogPostFailed:"Your message didn’t go through-- there was an error adding your post.",ExchangeOrganizer:"Organizer: {0}",StopFollowing:"Stop Following",AddColleague:"Add as colleague",CalShortNovember:"Nov",PrivacyLevelChangedPrivateToPublic:"After you click Save, you will need to add a default group through the Site Permissions menu with at least view permissions.  For a Public community, you will typically add the group (NT Authority\\\\Authenticated Users) or a similar group used within your company.  Until you do this, no one will have access.",CalShortAugust:"Aug",SpheresLink:"Spheres",ExchangeDeclined:"Declined",ExchangeForwardReplyNote:"The original message will be included at the end of this message.",ExchangeMeetingWorkspaceUrl:'Meeting Workspace: <a href="{0}" target="_blank">{0}<\/a>',SuccessfulBroadcast:"Broadcast Successful",AddPollOptions:"Add Poll Options",CalShortMay:"May",YourVotesPrefix:"Your votes: ",Filter_Questions:"Questions",LikesThisFragment:"<a href='{0}' class='ngAuthorLink ngAuthorLikeLink' authorId='{1}'>{2}<\/a> likes this.",CalShortOctober:"Oct",ExchangePriority:"Priority:",TourTileUnreadCountDesc:"The unviewed count tells you how many new items have appeared since you last clicked on the tile to check its contents.  This also appears at the top of the column that goes with the tile.",GoToCommunityTooltip:"Go to {0}",Tags:"Tags",Poll:"Poll",CalSaturdayMin:"Sa",MoreLabel:"More",ExitTourVerb:"Try this now",NotFoundError:"We could not find the data for your request.",FollowUpTitle:"Add to my Follow–up filter"});United=United||{};United.AnchorSlide=function(n){"use strict";function t(){n("a[href*=#]").click(function(){var t,i;if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname&&(t=n(this.hash),this.hash&&(t=t.length&&t||n("[name="+this.hash.slice(1)+"]"),t.length)))return i=t.position().top,n("#s4-workspace").animate({scrollTop:i},500),!1})}return{handleAnchorSlide:t}}(jQuery),function(n){n(document).ready(function(){function i(){t.scrollTop(0)}var t=n("body");t.on("scroll",i);t.trigger("scroll");United.AnchorSlide.handleAnchorSlide();n("a[href='#top']").click(function(){return n("#s4-workspace").animate({scrollTop:0},"slow"),!1})})}(window.jQuery);United=United||{};United.TopBarSearchBox=function(){"use strict";function h(){n.topBarOverlay.fadeIn();n.searchButtonActual.animate({height:"32px","margin-top":"10px","background-color":"#9cb647",color:"#ffffff"});n.searchButton.animate({color:"#ffffff"});n.searchText.animate({width:"264px","padding-left":"9px","border-top-width":"1px","border-top-color":"#B0B0B0","border-top-style":"solid","border-right-width":"1px","border-right-color":"#B0B0B0","border-right-style":"solid","border-bottom-width":"1px","border-bottom-color":"#B0B0B0","border-bottom-style":"solid"}).promise().done(c);r()}function r(){n.searchText.val()===""&&setTimeout(function(){n.searchText.focus()},50)}function c(){n.searchDropDown.hasClass(n.hoverDropClass)||(n.searchDropDown.addClass(n.hoverDropClass),n.searchDropDown.slideDown("fast"))}function u(){n.searchDropDown.removeClass(n.hoverDropClass);n.searchDropDown.stop().slideUp("fast").promise().done(function(){n.searchText.animate({width:"0","padding-left":"0"}).promise().done(function(){n.searchButtonActual.animate({height:"50px","margin-top":"0",color:"#4D5052"});n.searchButtonActual.css("background-color","");n.searchButton.css("color","");n.searchText.css("border","none")})})}function l(u){u.stopPropagation();n.activeUrl=n.thisSiteUrl;n.unitedScope.addClass(n.activeClass);n.peopleScope.removeClass(n.activeClass);n.thisSiteScope.removeClass(n.activeClass);i()?r():t()}function a(u){u.stopPropagation();n.activeUrl=n.thisSiteUrl;n.unitedScope.removeClass(n.activeClass);n.peopleScope.addClass(n.activeClass);n.thisSiteScope.removeClass(n.activeClass);i()?r():t()}function v(u){u.stopPropagation();n.activeUrl=n.thisSiteUrl;n.unitedScope.removeClass(n.activeClass);n.peopleScope.removeClass(n.activeClass);n.thisSiteScope.addClass(n.activeClass);i()?r():t()}function y(){n.searchDropDown.hasClass(n.hoverDropClass)?i()?(u(),n.topBarOverlay.fadeOut()):t():h()}function t(){var t=location.hostname.split("."),i=t.shift(),r=i.split("-");switch(r[1]){case"dev":n.activeUrl="https://united-dev.wwt.com"+n.activeUrl;n.peopleResultsUrl="https://united-dev.wwt.com"+n.peopleResultsUrl;break;case"test":n.activeUrl="https://united-test.wwt.com"+n.activeUrl;n.peopleResultsUrl="https://united-test.wwt.com"+n.peopleResultsUrl;break;case"vm":n.activeUrl="https://united-vm.wwt.com"+n.activeUrl;n.peopleResultsUrl="https://united-vm.wwt.com"+n.peopleResultsUrl;break;default:n.activeUrl="https://united.wwt.com"+n.activeUrl;n.peopleResultsUrl="https://united.wwt.com"+n.peopleResultsUrl}window.location=p()?n.activeUrl+encodeURIComponent(n.searchText.val()):w()?n.activeUrl+encodeURIComponent(n.searchText.val())+"&u="+n.webUrl:n.peopleResultsUrl+encodeURIComponent(n.searchText.val()+"*")}function p(){return n.unitedScope.hasClass(n.activeClass)}function w(){return n.thisSiteScope.hasClass(n.activeClass)}function i(){return n.searchText.val()!==""?!1:!0}function b(){n.searchButtonActual.addClass("submitHover")}function k(){n.searchButtonActual.removeClass("submitHover")}function d(r){var u=n.searchLiItems.filter("."+n.activeClass);if(r.keyCode===o)return i()||t(),!1;r.keyCode===f?u.prev().length!==0?u.removeClass(n.activeClass).prev().addClass(n.activeClass):(u.removeClass(n.activeClass),n.searchLiItems.last().addClass(n.activeClass)):r.keyCode===e&&(u.next().length!==0?u.removeClass(n.activeClass).next().addClass(n.activeClass):(u.removeClass(n.activeClass),n.searchLiItems.first().addClass(n.activeClass)))}var n,f=38,e=40,o=13,s=function(t){n=t;n.unitedScope.click(l);n.peopleScope.click(a);n.thisSiteScope.click(v);n.searchButton.click(y);n.searchButton.on("mouseover",b);n.searchButton.on("mouseout",k);n.searchText.keypress(d)};return{init:s,close:u}}(jQuery);United=United||{};United.TopBarMainNav=function(n){"use strict";function p(){var i=n(this),u=i.parent().attr("id"),f=i.parent().data("category"),e=i.parent().data("altkeywords"),o=i.parent().children().first().attr("href"),s=i.parent().attr("title"),c=i.parent().data("favid"),h=i.parent().data("tab")=="True"?1:0;n(this).children().hasClass(t.emptyStarClass)?r||b(f,e,o,s,h,u,i):t.favoritesHolder.find("#"+u).length&&(r||w(i,u))}function w(n,i){var u=t.favoritesHolder.find('[data-navid="'+i+'"]'),e=t.favoritesHolder.find('[data-navid="'+i+'"]').data("favid");n.children().removeClass(t.fullStarClass);n.children().addClass(t.emptyStarClass);u.remove();t.contentWrapper.find("#"+i).find(t.starLinkControl).children().removeClass(t.fullStarClass);t.contentWrapper.find("#"+i).find(t.starLinkControl).children().addClass(t.emptyStarClass);d(n,e);f();r=!0}function b(n,i,u,e,o,s,h){h.children().removeClass(t.emptyStarClass);h.children().addClass(t.fullStarClass);var c=h.parent().clone(!0);c.appendTo(t.favoritesHolder);k(n,i,u,e,o,s,h,c);f();r=!0}function k(i,u,f,e,o,s,h,c){o=o?"true":"false";var l=encodeURI("category="+i+"&keywords="+u+"&url="+f+"&title="+e+"&newtab="+o+"&id="+s);n.ajax({type:"POST",data:l,url:v("post"),success:function(n){var i=n.childNodes[0].innerHTML;h.parent().attr("data-favid",i).attr("data-navid",s);c.attr("data-favid",i).attr("data-navid",s);h.children().removeClass(t.emptyStarClass);h.children().addClass(t.fullStarClass);r=!1},error:function(){h.children().removeClass(t.fullStarClass);h.children().addClass(t.emptyStarClass);r=!1}})}function d(i,u){n.ajax({type:"POST",data:"id="+u,url:v("delete"),success:function(){i.children().removeClass(t.fullStarClass);i.children().addClass(t.emptyStarClass);r=!1},error:function(){i.children().removeClass(t.emptyStarClass);i.children().addClass(t.fullStarClass);r=!1}})}function g(i){var r=i.data("navid");t.favoritesHolder.each(function(){n("#"+r).parents(".contentWrapper").length==1&&(t.contentWrapper.find("#"+r).find(t.starLinkControl).children().removeClass(t.emptyStarClass),t.contentWrapper.find("#"+r).find(t.starLinkControl).children().addClass(t.fullStarClass))})}function f(){t.favoritesHolder.children().length?t.favoriteCheck.hide():t.favoriteCheck.show()}function nt(){t.favoritesHolder.children().length?(f(),t.allSitesTab.removeClass(t.activeNavLinkClass),t.contentWrapper.hide(),t.favoritesTab.addClass(t.activeNavLinkClass),t.favoritesWrapper.show()):(e(),f())}function e(){t.favoritesTab.removeClass(t.activeNavLinkClass);t.favoritesWrapper.hide();t.allSitesTab.addClass(t.activeNavLinkClass);t.contentWrapper.show()}function h(){n(this).hasClass("allSites")?n(".contentWrapper:visible").length==0&&(e(),o()):n(this).hasClass("favorites")&&n(".favoritesWrapper:visible").length==0&&(t.allSitesTab.removeClass(t.activeNavLinkClass),t.contentWrapper.hide(),t.favoritesTab.addClass(t.activeNavLinkClass),t.favoritesWrapper.show(),o())}function c(){t.categoryTitle.not(this).next().children("ul").slideUp();t.categoryTitle.children("span").not(n(this).children("span")).removeClass(t.arrowDownClass)}function tt(){t.mainNav.stop().slideUp(250);t.navIcon.removeClass(t.navIconHoverClass)}function it(){n(this).next().children().slideToggle();n(this).children("span").toggleClass(t.arrowDownClass)}function rt(){var i=t.mainNav;i.is(":hidden")?(i.css("height","0").show().animate({height:n(window).height()-55+"px"},250),t.topBarOverlay.fadeIn(),t.navIcon.addClass(t.navIconHoverClass),t.searchInput.focus(),i.scrollTop(0)):(t.topBarOverlay.fadeOut(),t.navIcon.removeClass(t.navIconHoverClass),i.slideUp(250))}function ut(i,r,u){var f=i.children("span"),e=i,o=!1;f.empty();n.each(r,function(n){this.trim().startsWith(u)&&(f.append("<span>"+r[n].trim()+"<\/span>"),o=!0,e.addClass(t.tallNavItemClass));o||e.removeClass(t.tallNavItemClass)})}function ft(r){if(r.keyCode===38&&i>0&&(r.preventDefault(),u(),i--,n(n(".navItems > ul > li:visible")[i]).addClass(t.activeNavItemClass)),r.keyCode===40&&i<n(".navItems > ul > li:visible").length-1&&(r.preventDefault(),u(),i++,n(n(".navItems > ul > li:visible")[i]).addClass(t.activeNavItemClass)),r.keyCode===13){r.preventDefault();var f=n(n(".navItems > ul > li:visible")[i]).find("a").attr("href");window.open(f)}r.keyCode===27&&(r.preventDefault(),n("#tbmn > #panel:visible")&&t.searchInput.val()!==""&&(o(),a()))}function u(){n(".navItems > ul > li").removeClass(t.activeNavItemClass);n("#favoritesHolder > li").removeClass(t.activeNavItemClass)}function l(){t.searchInput.val()!==""?t.clearSearchIcon.addClass("clearSearchIcon"):(t.clearSearchIcon.removeClass("clearSearchIcon"),u())}function o(){t.searchInput.val("");t.clearSearchIcon.removeClass("clearSearchIcon");t.emptyResultsContainer.hide();t.categoryTitle.show();t.listItemsHolder.children().show();t.listItemsHolder.hide();t.navItems.find("ul > li > span").empty();t.navItems.find("ul > li").removeClass("expandLi");u();c()}function et(t){var r="";t.keyCode!=38&&t.keyCode!=40&&t.keyCode!=13&&(i=-1,u());r=n(this).val().toLowerCase();r===""?t.keyCode!=38&&t.keyCode!=40&&t.keyCode!=13&&a():(e(),ot(r))}function ot(i){var r,u;l();r=[];window.keycodeArray=[];u={found:!1};t.listItemsHolder.children().hide();t.categoryTitle.hide();t.listItemsHolder.children().each(function(){st(n(this),r,u,i)})}function st(i,r,u,f){var s=i,e=i.data("altkeywords").toLowerCase(),o=!1;e=e.split(",");n.each(e,function(n){e[n].trim().startsWith(f)&&(o=!0)});i.text().toLowerCase().startsWith(f)||o?(ht(r,i,u),ut(i,e,f)):(i.hide(),s.removeClass(t.tallNavItemClass));u.found!==!0?t.emptyResultsContainer.show():t.emptyResultsContainer.hide()}function ht(n,i,r){var u=i.text(),e,f;if(i.children("span").text()&&(u=i.text().split(i.children("span").text()).shift()),n.length===0)i.show(),n.push(u),t.listItemsHolder.show(),r.found=!0;else{for(i.hide(),e=!0,f=0;f<n.length;f++)n[f]===u&&(e=!1);e&&(i.show(),n.push(u),t.listItemsHolder.show(),r.found=!0)}}function a(){l();t.arrowRight.removeClass(t.arrowDownClass);t.listItemsHolder.hide();e();t.categoryHolder.show();t.listItemsHolder.children().show().removeClass(t.tallNavItemClass);t.categoryTitle.show();t.emptyResultsContainer.hide();u()}function v(n){var t,r,i;return n=="post"?i="AddFavorite":n=="delete"&&(i="DeleteFavorite"),window.location.href.indexOf("-vm.wwt.com")>-1?(t="-vm.wwt.com",r=s()+t+"/_layouts/United/ApplicationPages/WebServices/FavoritesWebService.asmx/"+i):window.location.href.indexOf("-dev.wwt.com")>-1?(t="-dev.wwt.com",r=s()+t+"/_layouts/United/ApplicationPages/WebServices/FavoritesWebService.asmx/"+i):window.location.href.indexOf("-test.wwt.com")>-1?(t="-test.wwt.com",r=s()+t+"/_layouts/United/ApplicationPages/WebServices/FavoritesWebService.asmx/"+i):window.location.href.indexOf(".wwt.com")>-1&&(t=".wwt.com",r=s()+t+"/_layouts/United/ApplicationPages/WebServices/FavoritesWebService.asmx/"+i),r}function s(){if(window.location.href.indexOf("united2")>-1)var n="https://united2";else window.location.href.indexOf("mysites")>-1?n="https://mysites":window.location.href.indexOf("connect")>-1?n="https://connect":window.location.href.indexOf("united")>-1&&(n="https://united");return n}function ct(){n(this).data("tab")==="True"&&n(this).children().attr("target","_blank");n(this).detach();n("#"+n(this).data("category")).append(this)}function lt(){var i=n(this);i.detach();t.favoritesHolder.append(i);g(i)}function at(){!t.categoryHolder.length>0&&(t.mainNav.append('<div id="noData">Oops, stuff broke! Looks like it could be that the navigation list doesn\'t exist, or is named incorrectly, or there are no items in it!<\/div>'),t.searchWrapper.hide())}var t,i=-1,r=!1,y=function(n){t=n;t.hiddenNavLinkContainer.each(ct);t.hiddenFavoritesLinkContainer.each(lt);t.navIcon.click(rt);t.categoryControl.click(it);t.searchInput.on("keyup",et);t.searchInput.keydown(ft);t.clearSearchIcon.click(o);t.favoritesTab.click(h);t.allSitesTab.click(h);t.starLink.click(p);t.categoryTitle.click(c);at();nt()};return{init:y,close:tt}}(jQuery);United=United||{};United.TopBarActivityStream=function(n){"use strict";function u(){t.streamNav.is(":hidden")?f():o()}function f(){t.topBarOverlay.fadeIn();s();t.streamIcon.addClass(t.streamIconHoverClass);t.streamNav.css("height","0").show().animate({height:n(window).height()-55+"px"},350).promise().done(function(){n("iframe#streamRemoteFrame").height("100%");n("iframe#streamRemoteFrame").height("-=35")})}function e(){if(jQuery("#ngSettings").length==0)jQuery("body").append('<div id="ngSettings" style="display:none;"><div id="ngSettingsContainer"><\/div><\/div>');jQuery(this).ngsettings({dialogWidth:1e3})}function o(){t.topBarOverlay.fadeOut();t.streamIcon.removeClass(t.streamIconHoverClass);t.streamNav.slideUp(250)}function s(){i===!1&&(t.streamIframeContainer.append(t.iframe).promise().done(function(){n(".ngAuthorLink").attr("target","_blank");n(".ngActivityProfileIcon").parent().attr("target","_blank")}),i=!0)}function h(){var i=n(window).height();window.open("/_layouts/United/ApplicationPages/ActivityStream.aspx","","toolbar=0, scrollbars=1, resizable=1, status=0, titlebar=0, menubar=0, location=0, directories=0, top=0, left=0, width=500, height="+i+"");t.streamIcon.trigger("click")}function c(){t.streamNav.stop().slideUp(250);t.streamIcon.removeClass(t.streamIconHoverClass)}var t,i=!1,r=function(n){t=n;t.streamIcon.click(u);t.streamPopoutIcon.click(h);t.streamSettingsIcon.click(e)};return{init:r,close:c}}(jQuery);United=United||{};United.TopBarHelpCenter=function(n){"use strict";function r(){var n=!1;t.li1.click(function(){n==!1?(t.answer1.fadeIn(),n=!0):(t.answer1.fadeOut(),n=!1)})}function u(){n(".faqBody li").click(function(){n(this).find(".answer").is(":hidden")?(n(this).find(".answer").slideDown(),n(this).find("i").addClass("fa-minus-square-o"),n(this).find("i").removeClass("fa-plus-square-o"),n(this).find("i").css("color","#ffffff;"),n(this).find("span").css("color","#ffffff;"),n(this).find(".questionContainer").css("background-color","#B56EBC;")):(n(this).find(".answer").slideUp(),n(this).find("i").addClass("fa-plus-square-o"),n(this).find("i").removeClass("fa-minus-square-o"),n(this).find("i").css("color",""),n(this).find("span").css("color",""),n(this).css("background-color",""),n(this).find(".questionContainer").css("background-color",""))})}function f(){t.helpCenterContainer.css("width")=="40px"?(t.helpCenterContainer.animate({width:"80px"}),t.helpCenterIcon.css("background-color","#b56ebb;"),t.serviceTicketIcon.css("background-color","#b56ebb;"),t.helpCenterIcon.css("color","#ffffff;"),t.serviceTicketIcon.css("color","#ffffff;"),t.mainPanel.css("border-bottom","2px solid #b56ebc").css("border-top","2px solid #b56ebc"),t.mainPanel.animate({height:t.mainPanel.get(0).scrollHeight},function(){t.mainPanel.css("height","auto")}),t.topBarOverlay.fadeIn()):(t.helpCenterContainer.animate({width:"40px"}),t.helpCenterIcon.css("background-color",""),t.helpCenterIcon.css("color",""),t.helpCenterContainer.css("background-color",""),t.mainPanel.animate({height:"0"},function(){t.mainPanel.css("border","none")}),t.topBarOverlay.fadeOut())}var t,i=function(n){t=n;r();u();t.helpCenterIcon.click(f)};return{init:i}}(jQuery);United=United||{};United.AlertModule=function(n){"use strict";function e(){r.css({height:n(window).height()-(u+f)})}function o(){r.css({height:n(window).height()-(u+l+f)})}function a(){t.warnings.length!==0?t.warnings.each(s).promise().done(c):t.information.each(s);t.warningDismiss.on("click",h);t.informationDismiss.on("click",h)}function s(){var t=n(this).attr("alertid");i[t]!=="dismissed"?n(this).slideDown().promise().done(o):n(this).remove()}function v(){var t=new Date,r=new Date(t.getFullYear(),t.getMonth(),t.getDate(),23,59,59);n.cookie("UnitedAlertBar",i,{path:"/",expires:r})}function y(n){i[n]="dismissed";v()}function h(){var t=n(this).parent().parent();t.slideUp().promise().done(function(){e();p(t,t.attr("alertid"))})}function p(n,t){n.remove();y(t);c()}function c(){if(n(".unitedAlert.Critical").length===0){var t=n(".unitedAlert.Informational").first().attr("alertid");t&&(!i[t]||i[t]!=="dismissed")?n(".unitedAlert.Informational").first().slideDown().promise().done(o):(n(".unitedAlert.Informational").first().remove(),e())}}n.cookie.json=!0;var r,u,f=50,l=31,i=n.cookie("UnitedAlertBar")||{},t={};return{init:function(i){n("html").hasClass("ms-dialog")||(t=i,u=n(".ms-cui-topBar2").height(),r=n("#s4-workspace"),a())}}}(jQuery);United=United||{};United.TopBarSharePointActions=function(n){"use strict";function l(){n(t.siteActionMenu).length?v():y()}function a(){t.siteActionContainer.children().length||(t.siteActionContainer.hide(),t.gearIconOverlay.hide())}function v(){var i=g_menuHtc_lastMenu;n(i).attr("id").indexOf("PersonalActionMenu")=="-1"?(window.MenuHtc_hide(),t.topBarOverlay.fadeOut(),t.gearIconOverlay.removeClass(t.gearIconOverlayHoverClass)):(window.MenuHtc_hide(),e())}function y(){t.topBarOverlay.fadeIn();t.gearIconOverlay.addClass(t.gearIconOverlayHoverClass);setTimeout(function(){t.gearIcon.trigger("onclick");i();n(t.siteActionMenu).attr("title","")},1);window.HideMenu.toString()!==r.toString()&&(window.HideMenu=r);window.PopupMouseLeave.toString()!==f.toString()&&(window.PopupMouseLeave=f)}function e(){setTimeout(function(){g_menuHtc_lastMenu?e():(t.gearIcon.trigger("onclick"),t.gearIconOverlay.addClass(t.gearIconOverlayHoverClass),i())},200)}function p(){if(n(t.siteActionMenu).length){var r=g_menuHtc_lastMenu;n(r).attr("id").indexOf("SiteActionsMenuMain")=="-1"?(window.MenuHtc_hide(),t.topBarOverlay.fadeOut()):(window.MenuHtc_hide(),t.gearIconOverlay.removeClass(t.gearIconOverlayHoverClass),o())}else t.topBarOverlay.fadeIn(),setTimeout(function(){t.nameButton.trigger("onclick");i()},1)}function o(){setTimeout(function(){g_menuHtc_lastMenu?o():(t.nameButton.trigger("onclick"),i())},200)}function w(e){var x=n(this).attr("onMenuClick");eval(x);setTimeout(function(){United.Controller.closeAll(e)},1)}function i(){setTimeout(function(){var i=n(t.siteActionMenu);i.addClass("siteActionBorder");g_menuHtc_lastMenu&&(n(g_menuHtc_lastMenu).attr("id").indexOf("SiteActionsMenuMain")!=-1?i.css({top:"50px",left:"0"}):n(g_menuHtc_lastMenu).attr("id").indexOf("PersonalActionMenu")!=-1&&i.css({top:"50px",left:"auto",right:"-40px"}));i.children().on("click",w);i.css({height:"0"});i.addClass("visible");i.animate({height:n(window).height()-55+"px"},250,function(){g_menuHtc_lastMenu&&n(g_menuHtc_lastMenu).attr("id").indexOf("SiteActionsMenuMain")!=-1?i.css({"overflow-y":"visible"}):n(g_menuHtc_lastMenu).attr("id").indexOf("PersonalActionMenu")!=-1&&i.css({"overflow-y":"visible"})})},1)}function s(){window.HideMenu?window.HideMenu=r:setTimeout(s,500)}function r(n,i){var r,u;;if(ClearTimeOutToHideMenu(),t.gearIconOverlay.removeClass(t.gearIconOverlayHoverClass),i==null&&(i=0),i==2){n._onDestroy!=null&&(n._onDestroy(),n._onDestroy=null);return}IsOpen(n)&&!IsAccessibilityFeatureEnabledProxy()&&(n._oParent!=null&&(n._oParent.onclick=n._oParent._onclick,n._oParent.onmouseover=n._oParent._onmouseover,n._oParent.onmouseout=n._oParent._onmouseout,n._oParent.onmousedown=n._oParent._onmousedown,n._oParent.oncontextmenu=n._oParent._oncontextmenu,typeof _fV4UI!="undefined"&&_fV4UI&&(n._oParent.onkeydown=n._oParent._onkeydown)),SetBodyEventHandlers(null),UpdateLevel(n,0),r=n._arrPopup[0],r!=null&&(u=document.getElementById(r._backgroundFrameId),u!=null&&u.parentNode.removeChild(u),r.parentNode!=null&&r.parentNode.removeChild(r),n._arrPopup[0]=null,i==0&&n._onDestroy!=null&&typeof n._onDestroy=="function"&&(n._onDestroy(),n._onDestroy=null)),g_menuHtc_lastMenu=null,RenderECBBackwardCompatibilityMode(!1))}function h(){window.MenuHtc_hide?window.MenuHtc_hide=function(){;ClearTimeOutToHideMenu();var n=g_menuHtc_lastMenu;n!=null&&(n._accessibleMenu!=null?CloseAccessibleMenu(n):HideMenu(n));g_menuHtc_lastMenu=null}:setTimeout(h,500)}function u(){window.PopupMouseLeave?window.PopupMouseLeave=function(t){;var i;return i=GetEventPopup(t),i!=null&&n(g_menuHtc_lastMenu).attr("id").indexOf("PersonalActionMenu")===-1&&n(g_menuHtc_lastMenu).attr("id").indexOf("SiteActionsMenuMain")===-1&&(UnselectCurrentOption(i.master),SetTimeOutToHideMenu()),!1}:setTimeout(u,250)}function u(){window.PopupMouseLeave?window.PopupMouseLeave=f:setTimeout(u,250)}function f(t){;var i;return i=GetEventPopup(t),i!=null&&n(g_menuHtc_lastMenu).attr("id").indexOf("PersonalActionMenu")===-1&&n(g_menuHtc_lastMenu).attr("id").indexOf("SiteActionsMenuMain")===-1&&(UnselectCurrentOption(i.master),SetTimeOutToHideMenu()),!1}var t,c=function(n){t=n;t.gearIconOverlay.on("click",l);t.nameOverlay.on("click",p);a()};return{init:c,updateHideMenu:s,updateMenuHtc_hide:h,updatePopMouseLeave:u}}(jQuery),function(n){n(document).ready(function(){United.TopBarSharePointActions.init({siteActionContainer:n("#siteactiontd"),gearIcon:n("#siteactiontd > span.ms-siteactionsmenuinner"),siteActionMenu:".ms-MenuUIPopupBody.ms-MenuUIPopupScreen",gearIconOverlay:n("#siteActionsMenu"),gearIconOverlayHoverClass:"siteActionsMenuHover",topBarOverlay:n("#topBarOverlay"),streamNav:n("#streamNavPanel"),streamIconHoverClass:"streamNavIconOrange",mainNav:n("#tbmn > #panel"),navIcon:n("#mainNavIcon"),navIconHoverClass:"mainNavIconBlue",searchDropDown:n("#scopesDropdown"),hoverDropClass:"hoverDrop",searchClick:n("#unitedSubmitCover"),nameOverlay:n("#userDropdownCover"),nameButton:n(".welcomemenu .ms-welcomeMenu")});United.TopBarSharePointActions.updateHideMenu();United.TopBarSharePointActions.updateMenuHtc_hide();United.TopBarSharePointActions.updatePopMouseLeave()})}(jQuery);United=United||{};United.Controller=function(n,t,i,r){function s(n){u=n;h()}function h(){n(u.nameMenuMouseOver).attr("onmouseover","");n(u.siteActionMouseOver).attr("onmouseover","");u.mainNavIcon.on("click",l);u.streamNavIcon.on("click",a);u.siteActionsMenu.on("click",o);u.submitCover.on("click",v);u.overlay.on("click",e);u.nameButton.on("click",o);u.sideNavButton.on("click",e);u.topBarContainer.on("click",c)}function c(n){n.stopPropagation()}function l(){f();u.streamNav.css("z-index","20");u.mainNav.css("z-index","25");n(u.spSiteActionPanel).css("z-index","20");t.close();r.close()}function a(){f();u.streamNav.css("z-index","25");u.mainNav.css("z-index","20");n(u.spSiteActionPanel).css("z-index","20");i.close();t.close()}function o(){u.streamNav.css("z-index","20");u.mainNav.css("z-index","20");n(u.spSiteActionPanel).css("z-index","25");r.close();i.close();t.close()}function v(){f();r.close();i.close()}function e(n){f();t.close();i.close();r.close();n.target.className!==u.siteActionsButton&&n.target.className!==u.siteActionsButtonWithHover&&n.target.id!==u.nameMenuButton&&u.overlay.fadeOut()}function f(){window.MenuHtc_hide()}var u;return{init:s,closeAll:e}}(jQuery,United.TopBarSearchBox,United.TopBarMainNav,United.TopBarActivityStream),function(n){n(document).ready(function(){United.Controller.init({overlay:n("#topBarOverlay"),mainNavIcon:n("#mainNavIcon"),streamNavIcon:n("#streamNavIcon"),siteActionsMenu:n("#siteActionsMenu"),siteActionMouseOver:n(".ms-siteactionsmenuinner"),submitCover:n("#unitedSubmitCover"),nameButton:n("#userDropdownCover"),sideNavButton:n("#snp-toggle"),topBarContainer:n("#united2TopBarContainer"),siteActionsButton:"siteActionsMenu",siteActionsButtonWithHover:"siteActionsMenu siteActionsMenuHover",nameMenuButton:"userDropdownCover",nameMenuMouseOver:".ms-SPLink.ms-SpLinkButtonInActive.ms-welcomeMenu",mainNav:n("#tbmn > #panel"),streamNav:n("#streamNavPanel"),spSiteActionPanel:".ms-MenuUIPopupBody.ms-MenuUIPopupScreen"})})}(jQuery);United=United||{};United.WorldClock={},function(n){United.WorldClock.UpdateAll=function(){n(".worldClockTime").each(function(){United.WorldClock.Update(this)})};United.WorldClock.Update=function(n){var i=new Date(Date.parse("1/1/2000 "+n.innerHTML)),t,r;i.setMinutes(i.getMinutes()+1);t=i.getHours();r=i.getMinutes();n.innerHTML=(t===0?12:t>12?(t-12).toString():t.toString())+":"+(r<10?"0":"")+r.toString()+" "+(t<12?"AM":"PM")};n(document).ready(function(){setTimeout(function(){United.WorldClock.UpdateAll();setInterval(function(){United.WorldClock.UpdateAll()},6e4)},(60-United.WorldClock.SecondsInCurrentMinute)*1e3)})}(jQuery);jQuery(function(n){var u=n("#divSiteIcon"),t=n("#NGSS_CommunityStatusDiv .Description"),o=n("#s4-topheader2 ul#navigation"),f=n("#NGSS_CommunityStatusDiv br"),s=t.html(),i,r,e;t.html("");t.append(u);t.append("<div id='divSiteDesc'>"+s+"<\/div>");t.append("<div style='clear: both;'><\/div>");u.show();i=o.find("li:last");i.length>0&&(r=i.find("span"),r.length>0&&(e=r.html(),e=="Admin"&&i.remove()));f.length>0&&f.remove();n("ul.dfwp-column li:last").attr("class","dfwp-item last")}),function(n,t,i){"use strict";function tt(n){var i=location.hostname.split(".")[0],t=it()+"://";return t+=n||"www",i.indexOf("-dev")!==-1||i==="localhost"?t+="-dev":i.indexOf("-test")!==-1&&(t+="-test"),t+".wwt.com"}function ot(){var i=tt()+"/portalWeb/comergent/logout.do",n;return n='<div id="side-nav-panel"><div class="snp-logout"><a href='+i+' class="logout">Logout<\/a><i id="toggleClose"><\/i><\/div><div id="snp-search"><input type="text" placeholder="Find apps and reports..."><\/div><ul class="snp-tabs"><li>Favs<\/li><li>Apps<\/li><li>Reports<\/li><\/ul><div class="snp-no-results">No Results Found<\/div><\/div>',t("body").prepend(n),t("#side-nav-panel")}function it(){var n=window.location.href,t=n.split(":");return t[0]}function st(){return'<iframe src="'+tt("reports")+'/ibi_apps/bid-login?" width="0" height="0" frameborder="0"><\/iframe>'}function d(){return"/apirouter/api/forward/user"}function rt(n){return n.indexOf("://")===-1?it()+"://"+n:n}function ut(){var n=document.createElement("div").style;return"transition"in n||"WebkitTransition"in n||"MozTransition"in n||"msTransition"in n||"OTransition"in n}function ft(){var n=document.createElement("input");return n.placeholder!==i}function ht(n){var t=n.attr("placeholder");n.focus(function(){n.val()===t&&n.val("")});n.blur(function(){n.val()!==t&&n.val()===""&&n.val(t)});n.blur()}function et(n,t){if(navigator.userAgent.indexOf("MSIE")===-1)return n;var i=n.substring(0,Math.min(t,n.length));return i.length>=t?i+"...":i}var r,v,y,p,u,l,f,o,g={},w,s,e,b,nt,h,c,k,a;n.addFavorite=function(n,i,r,u){t("#bk"+n.replace(/\s/g,"_")).removeClass("snp-star-o");t("#bk"+n.replace(/\s/g,"_")).addClass("snp-star");t("#FavApps_content").append('<li class="favapps" id="FavApps_'+n.replace(/\s/g,"_")+'"><a class="a-link" href="'+rt(r)+u+'"><i class="snp-'+i+'"><\/i>'+et(n,26)+"<\/a><\/li>");t("#favSet_"+n.replace(/\s/g,"_")).attr("href","javascript:sideNavPanel.removeFavorite('"+n+"', '"+i+"', '"+r+"', '"+u+"');");t.ajax({url:d()+"/sidenav/addfav/"+n.replace(/ /g,"+"),success:function(){},dataType:"jsonp"})};n.removeFavorite=function(n,i,r,u){t("#FavApps_"+n.replace(/\s/g,"_")).remove();t("#bk"+n.replace(/\s/g,"_")).removeClass("snp-star");t("#bk"+n.replace(/\s/g,"_")).addClass("snp-star-o");t("#favSet_"+n.replace(/\s/g,"_")).attr("href","javascript:sideNavPanel.addFavorite('"+n+"', '"+i+"', '"+r+"', '"+u+"');");t.ajax({url:d()+"/sidenav/removefav/"+n.replace(/ /g,"+"),success:function(){},dataType:"jsonp"})};n.createSideNavPanel=function(n,tt){function at(n,t){var u=t,f;f=u==i?"":" ("+u+")";r.append('<div class="snp-login-error" id="snp-nam-check">'+n+f+"<\/div>");r.find(".snp-logout").add("#snp-search").hide()}function yt(){at("Oops, we lost your connection!  Please click HERE to log in.");t("#snp-nam-check").on("click",function(){pt()})}function pt(){window.location.href.indexOf("-dev.wwt.com")>-1?ct("-dev.wwt.com"):window.location.href.indexOf("-test.wwt.com")>-1?ct("-test.wwt.com"):window.location.href.indexOf(".wwt.com")>-1&&ct(".wwt.com")}function ct(n){var t=document.location.href;window.location.href="https://secure"+n+"/nidp/idff/sso/?target="+encodeURIComponent(t)}function lt(n,i){var r="",u;return r+='<li class="snp-group">My '+(i==="FavApps"?"Favorites":i)+"<\/li>",t.each(n,function(n,e){t.each(e,function(n,t){u=t.iconName||"globe";r+='<li class="'+i.toLowerCase()+'" id="'+i+"_"+t.name.replace(/\s/g,"_")+'">';r+='<a class="a-link" href="'+rt(t.baseUrl)+t.location+'"><i class="snp-'+u+'"><\/i>'+et(t.name,26)+"<\/a>";i==="FavApps"?(o=f.eq(0),w=0,g[t.name]=!0):i==="Applications"&&(r+=g.hasOwnProperty(t.name)?'<a class="snp-fav" id="favSet_'+t.name.replace(/\s/g,"_")+'" href="javascript:sideNavPanel.removeFavorite(\''+t.name+"', '"+u+"', '"+t.baseUrl+"', '"+t.location+'\');"><i id="bk'+t.name.replace(/\s/g,"_")+'" class="snp-star"><\/i><\/a>':'<a class="snp-fav" id="favSet_'+t.name.replace(/\s/g,"_")+'" href="javascript:sideNavPanel.addFavorite(\''+t.name+"', '"+u+"', '"+t.baseUrl+"', '"+t.location+'\');"><i id="bk'+t.name.replace(/\s/g,"_")+'" class="snp-star-o"><\/i><\/a>');r+="<\/li>"})}),'<ul id="'+i+'_content" class="snp-tab-content">'+r+"<\/ul>"}function wt(n){var t=lt(n.FavApps,"FavApps"),i=lt(n.Applications,"Applications"),u=lt(n.Reports,"Reports");r.append(t);r.append(i);r.append(u);r.append(st())}function bt(){h=r.find(".snp-tab-content");c=h.find("li");k=c.not(".snp-group").not(".favapps");a=c.filter(function(){return t(this).find("a").attr("href")===location.href});ft()||ht(u);o.addClass(e);a.addClass(e);h.eq(w).show()}function it(n){var i="snp-open";window.scrollTo(0,0);r.show();s=!s;t("body").addClass(i);setTimeout(function(){v.toggleClass(b).one(nt,function(){s||(r.hide(),t("body").removeClass(i))})},50);ut()||s||(r.hide(),t("body").removeClass(i));n.preventDefault()}function vt(n){var i=n,r=i.index();i.addClass(e).siblings().removeClass();h.hide().eq(r).show();o=f.eq(r);u.val().length&&(l.hide(),a.addClass(e),c.show(),t(".favapps").show(),ft()?u.val(""):u.val(u.attr("placeholder")))}r=ot();v=n;y=tt;p=t("#toggleClose");u=r.find("#snp-search input");l=r.find(".snp-no-results");f=r.find(".snp-tabs li");o=f.eq(1);w=1;s=!1;e="active";b=ut()?"togglePanel":"togglePanelFallback";nt="transitionend webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd";t.ajax({url:d()+"/sidenav",success:function(n){wt(n)},error:function(n){switch(n.status){case 0:yt();break;default:at("Oops, there appears to be a problem! Please contact your application's administrator.",n.status)}u.hide();f.hide();r.find(".snp-error").show()},complete:function(){bt()},dataType:"jsonp"});y.bind("touchend",function(n){it(n)});y.bind("click",function(n){it(n)});p.bind("touchend",function(n){it(n)});p.bind("click",function(n){it(n)});f.bind("touchend",function(){vt(t(this))});f.bind("click",function(){vt(t(this))});u.keyup(function(){var i=t.trim(t(this).val()).toLowerCase()||"",n;i.length?(o.siblings().hasClass(e)||(f.addClass("active"),k.removeClass(),h.show()),t(".favapps").hide(),c.hide(),n=k.filter(function(){return t(this).text().toLowerCase().indexOf(i)>-1}),n.length?(l.hide(),n.show()):l.show()):(t(".favapps").show(),l.hide(),f.removeClass(),o.addClass(e),a.addClass(e),h.hide().eq(o.index()).show(),c.show())});r.on("click",".a-link",function(n){n.preventDefault();s=!1;var t=this;v.toggleClass(b);u.val("");window.open(t.href,"")})}}(window.sideNavPanel=window.sideNavPanel||{},window.jQuery);$(document).ready(function(){Type.registerNamespace("NGCustom");NGCustom.Events=jQuery(document.createElement("DIV"));NGCustom.ColleagueList=null;NGCustom.CommunityList=null;NGCustom.HashTags=[];NGCustom.UserSuggestions={},function(n,t,r){var u={init:function(t){var i=n.extend({},n.fn.ngsettings.defaults,t),r=n(this).data("options",i);return this.each(function(){if(n(i.settingsContainer).length!==0)try{NGCustom.NM&&NGCustom.NM.SubscriptionsAllowed&&i.subscriptionsAllowed==null?NGCustom.NM.SubscriptionsAllowed(function(n){i.subscriptionsAllowed=n;u.show.call(r)}):u.show.call(r)}catch(t){Sys.Debug.trace("Error checking NewsManager SubscriptionsAllowed");u.show.call(r)}})},show:function(){var e=this,r=this.data("options"),i=n.extend({newsInterestsEndPointUri:"/_layouts/ng/nm/pages/newsinterests.aspx?IsDlg=1&autoclose=0",userSubscriptionsEndPointUri:"/_layouts/ng/nm/pages/usersubscription.aspx?IsDlg=1",sphereEndPointUri:"/_layouts/ng/pages/managegroups.aspx?IsDlg=1",communitiesEndPointUrl:"/_layouts/ngc/communities.aspx?IsDlg=1",newsInterestsContentId:"ngNewsIntegrations",userSubscriptionsContentId:"ngSubscriptions",sphereContentId:"ngSphereFrame",settingsNavContainer:"ngSettingsNav",communitiesContentId:"ngCommunityResults",dialogMinHeight:700,dialogResize:!0,dialogIsModal:!0,dialogPosition:"top"},r||{}),s={},f=[],o;f.push({display:ngText.EventsLink,call:function(){u.renderEventSettings.call(e)}});f.push({display:ngText.NotificationsLink,call:function(){u.renderNotificationSettings.call(e)}});NGCustom.NM&&(f.push({display:ngText.NewsInterestsLink,call:function(){u.renderFrameTab.call(e,{endPointUri:i.newsInterestsEndPointUri,contentId:i.newsInterestsContentId})}}),r.subscriptionsAllowed&&f.push({display:ngText.SubscriptionsLink,call:function(){u.renderFrameTab.call(e,{endPointUri:i.userSubscriptionsEndPointUri,contentId:i.userSubscriptionsContentId})}}));t.ngSpheresEnabled&&f.push({display:ngText.SpheresLink,call:function(){u.renderFrameTab.call(e,{endPointUri:i.sphereEndPointUri,contentId:i.sphereContentId})}});f.push({display:ngText.Communities,call:function(){u.renderFrameTab.call(e,{endPointUri:i.communitiesEndPointUrl,contentId:i.communitiesContentId})}});s[ngText.CloseVerb]=function(){n(this).dialog("close")};n("#ngSettings").dialog({minHeight:i.dialogMinHeight,resize:i.dialogResize,width:i.dialogWidth,modal:i.dialogIsModal,dialogClass:"ng-ui-wrapper",position:i.dialogPosition,buttons:s,draggable:!1,create:function(){n(r.dialogButtonContainer).empty();n(function(){n(t).resize(function(){$dialog=n(r.parent).parent();$dialog.height()>n(t).height()?$dialog.height(n(t).height()*.95):$dialog.height("auto");n(r.settingsContainer).css("height",$dialog.height()-n(r.settingsContainer).position().top-15-n(".ui-dialog-titlebar",$dialog).height())})})},open:function(){$dialog=n(r.parent).parent();$dialog.height()>n(t).height()&&$dialog.height(n(t).height()*.95);n(r.parent).prepend(n("<ul/>").prop("id",i.settingsNavContainer).css("float","left"));o=$dialog.find("#"+i.settingsNavContainer);n.each(f,function(t,i){o.append(n("<li/>").text(i.display))});n(r.settingsContainer).css("height",$dialog.height()-n(r.settingsContainer).position().top-15-n(".ui-dialog-titlebar",$dialog).height());o.on("click","li",function(){var t=n(this),i=n.grep(f,function(n){return n.display==t.text()})[0];t.parent().find("li").removeClass("active");t.addClass("active");n(r.settingsContainer).html("");i.call();n(r.dialogButtonContainer).empty()});o.find("li").first().trigger("click")},close:function(){n(this).dialog("destroy");n(r.settingsContainer).empty();n("#"+i.settingsNavContainer).remove()}})},renderFrameTab:function(i){var c=this,e=this.data("options"),u=n.extend({endPointUri:r,contentId:r,title:r,iframeHeight:"500",iframeWidth:"100%",iframeScrolling:"no",iframeBorder:0},i),f;if(u.endPointUri!==r&&u.contentId!==r){var o=n("<div/>").prop("id",u.contentId+"Wrapper"),h=n("<span/>").addClass("ngLoading").appendTo(o),s=n(e.dialogButtonContainer);s.find(".tempButton").remove();u.title&&o.append(n("<h3/>").append(n("<a/>").prop("href","#").text(u.title)));o.append(n("<div/>").append(n("<iframe/>").attr({id:u.contentId,src:t.spWebUrl+u.endPointUri+"&dashboard=1",scrolling:u.iframeScrolling,frameborder:u.iframeBorder,width:u.iframeWidth,height:u.iframeHeight})));n(e.settingsContainer).empty().append(o);f=n(e.settingsContainer).find("iframe#"+u.contentId);f.hide();f.ready(function(){var t,i,r;f.show();t=f.contents();f.hide();i=t.find(".ngButtons").children();i.hide();s.find(".tempButton").remove();n.each(i,function(t,i){var r=n(i),u;if(r.prop("id").indexOf("ngCancel")<0){u=n("<button/>",{id:"iframe_"+r.prop("id"),href:"javascript:void(0);","class":"ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only tempButton",style:"",html:'<span class="ui-button-text">'+r.prop("value")+"<\/span>",role:"button","aria-disabled":!1}).appendTo(s);u.on("click",function(){r.trigger("click")})}});n("a#lnkFeed, .ngPreview .ngNewsArticles a",t).attr("target","_blank");r=n(e.settingsContainer).height()*.98;h.remove();f.height(n(e.settingsContainer).height()*.98).show(400,function(){u.contentId==="ngSphereFrame"&&setTimeout(function(){f.contents().find("#s4-workspace").css({height:r+"px"})},1e3)})});n(t).resize(function(){f.height(n(e.settingsContainer).height()*.98)})}},renderEventSettings:function(i){var e=this,f=this.data("options"),u=n.extend({endPointUri:"_vti_bin/ng/activityfeed.svc/ActivityTypes/",hideActivityTypeUri:"_vti_bin/ng/activityfeed.svc/Hide/",followActivityTypeUri:"_vti_bin/ng/activityfeed.svc/Follow/",eventSettingsContainer:"ngEventSettings",eventGrouping:{communication:{title:ngText.EventGroupingCommunicationTitle,htmlStaging:"<ul/>"},content:{title:ngText.EventGroupingContentTitle,htmlStaging:"<ul/>"},social:{title:ngText.EventGroupingSocialTitle,htmlStaging:"<ul/>"},profile:{title:ngText.EventGroupingProfileTitle,htmlStaging:"<ul/>"},custom:{title:ngText.EventGroupingCustomTitle,htmlStaging:"<ul/>"}},eventList:{NewsGatorV15Microblogging:"communication",StatusMessage:"communication",NoteboardPosts:"communication",NewsGatorV15NewsGatorQA:"communication",NewsGatorV15Blog:"content",BlogUpdate:"content",NewsGatorV15BlogComment:"content",NewsGatorV15Document:"content",NewsGatorV15EditDocument:"content",NewsGatorV15Wiki:"content",NewsGatorV15Picture:"content",NewsGatorV15Task:"content",NewsGatorV15Event:"content",NewsGatorV15Announcements:"content",NewsGatorV15Discussion:"content",NewsGatorV15DiscussionReply:"content",NewsGatorV15Contact:"content",SocialTaggingByColleague:"content",SocialTaggingByAnyone:"content",SocialRatings:"content",NewsGatorV15Link:"content",ColleagueAddition:"social",NewsGatorV15JoinCommunity:"social",ProfilePropertyChange:"profile",Birthday_Today:"profile",Birthday_Reminder:"profile",WorkplaceAnniversary_Reminder:"profile",WorkplaceAnniversary_Today:"profile",TitleChange:"profile",ManagerChange:"profile",DLMembershipChange:"profile",NewsGatorRssModuleRssModule:"custom",SharingInterest:"profile",NewsGatorSpotlightModuleNGBadging:"custom",NewsGatorSpotlightModuleNGKudos:"custom",NewsGatorIdeaModuleIdea:"custom",NewsGatorV15ModerationNotification:"custom",NewsGatorV15SysNotification:"custom",NewsGatorVideoStreamModuleVideoAuthor:"custom",NewsGatorLearningModuleNgKnowledgeBase:"custom",NewsGatorVideoStreamModuleVideo:"custom"}},i),o=n("<span/>").addClass("ngLoading").appendTo(n(f.settingsContainer));n.ajax({type:"GET",contentType:"application/json; charset=utf-8",url:String.format("{0}/"+u.endPointUri,t.spWebUrl),success:function(i){var e,o;n(f.settingsContainer).empty().append(n("<div/>").prop("id",u.eventSettingsContainer).addClass("accordion"));e=n("#"+u.eventSettingsContainer);i.length>0?($settingsContent=n("<ul>"),n.each(i,function(t,i){var f=u.eventList[i.Name],e=n("<li>").append(n("<input>").attr({type:"checkbox",name:"ngSetting_"+i.Id,id:i.Name+"_"+i.Id}).addClass("chk ngNotificationSetting")).append(n("<label>").append(i.DisplayName));i.IsFollowing&&e.find("input#"+i.Name+"_"+i.Id).attr("checked","checked");f===r?$settingsContent.append(e):u.eventGrouping[f].htmlStaging=n(u.eventGrouping[f].htmlStaging).append(e)})):$settingsContent=n('<div class="ngAlertContainer">'+ngText.EventNoSettingsAvailable+"<\/div>");n.each(u.eventGrouping,function(t,i){e.append(n("<h3/>").text(i.title).addClass("head").append(n("<span/>").addClass("spriteStream")));e.append(i.htmlStaging)});e.append($settingsContent);o=n(f.settingsContainer).find(".accordion h3");o.click(function(){return o.filter(".down").removeClass("down").next().toggle(),n(this).addClass("down").next().toggle(),!1}).next().hide();o.first().trigger("click");n(f.settingsContainer).find("input").change(function(){var i=n(this),f=i.prop("name").replace("ngSetting_",""),r;r=i.is(":checked")?u.followActivityTypeUri:u.hideActivityTypeUri;n.ajax({type:"POST",contentType:"application/json; charset=utf-8",url:String.format("{0}/{1}{2}/",t.spWebUrl,r,f),success:function(){i.parent().find("label").animate({color:"Green",duration:"800"}).delay(1e3).animate({color:"#00000",duration:"800"})},error:function(){i.parent().find("label").append('<span class="ngSettings-error">'+ngText.ErrorSavingChanges+"<\/span>").find("span").fadeOut(4e3)}})})},error:function(n){alert(NGCustom.GetDefaultErrorMessage(n.status))}})},renderNotificationSettings:function(r){var g=this,h=this.data("options"),u=n.extend({endPointUri:"_vti_bin/ng/eventnotification.svc/Settings/",groupEndPointUri:"_vti_bin/ng/eventnotification.svc/Settings/Groups/",digestEndPointUri:"_vti_bin/ng/userprofile.svc/Settings/Digest/",contentWrapper:"ngSettingsNotifications"},r),nt=n("<span/>").addClass("ngLoading").appendTo(n(h.settingsContainer)),f=n('<div id="'+u.contentWrapper+'">'),c=n("<ul/>").addClass("ngTabs");n("<li/>").prop({id:"ngTabDigest","class":"head",ngTabContent:"#ngDigest"}).text(ngText.TabDigestVerb).appendTo(c);n("<li/>").prop({id:"ngTabNotifyAbout","class":"head",ngTabContent:"#ngInstant"}).text(ngText.TabNotifyAboutVerb).appendTo(c);var e=n("<div/>").prop({id:"ngDigest","class":"ngTabContent"}).hide(),y=n("<ul>").appendTo(e.append(n("<span/>").text(ngText.DigestOnOffVerb))),p=n("<div />").appendTo(e.append(n("<span/>").text(ngText.DigestWhenVerb))),v=n("<ul>").appendTo(e.append(n("<span/>").text(ngText.DigestWhatVerb))),l=n("<ul>").appendTo(e.append(n("<span/>").text(ngText.DigestFormatVerb))),a=n("<div/>").prop({id:"ngInstant","class":"ngTabContent accordion"}).hide(),w=n("<ul>").appendTo(a.append(n("<span/>").text(ngText.DigestOnOffVerb))),o=a.append(n("<span/>").text(ngText.DigestWhatVerb)),s=n("<ul/>").prop({id:"ngCommunitySpheres","class":"subhead"}),b=n.ajax({type:"GET",contentType:"application/json; charset=utf-8",url:String.format("{0}/{1}",t.spWebUrl,u.endPointUri),success:function(i){n.each(i,function(t,i){if(i.Id==="00000000-0000-0000-0000-000000000000")n.each(i.Settings,function(t,i){checkbox=n("<input>").attr({type:"checkbox",name:"ngSetting_"+i.InternalName}).addClass("chk ngNotificationSetting");i.Enabled&&checkbox.attr("checked","checked");i.InternalName=="NGReceiveDigestEmail"?n("<li/>").append(checkbox).append(n("<label>").append(i.DisplayName)).appendTo(y):n("<li/>").append(checkbox).append(n("<label>").append(i.DisplayName)).appendTo(w)});else{o.append(n("<h3>").text(i.DisplayName).addClass("head subhead").append(n("<span/>").addClass("spriteStream")));var r=n("<ul/>").addClass("subhead");n.each(i.Settings,function(t,i){checkbox=n("<input>").attr({type:"checkbox",name:"ngSetting_"+i.InternalName}).addClass("chk ngNotificationSetting");i.Enabled&&checkbox.attr("checked","checked");r.append(n("<li/>").append(checkbox).append(n("<label>").append(i.DisplayName)).append("<br/>"))});o.append(r)}});f.append(a);f.not("#ngCommunitySpheres").find("input.ngNotificationSetting").change(function(){var i=n(this),r=i.prop("name").replace("ngSetting_",""),u=String.format("{0}/{1}{2}/?enable={3}",t.spWebUrl,"_vti_bin/ng/eventnotification.svc/Settings/",r,i.is(":checked").toString());n.ajax({type:"POST",contentType:"application/json; charset=utf-8",url:u,success:function(){},error:function(n){alert(NGCustom.GetDefaultErrorMessage(n.status))}})})},error:function(){}}),k=n.ajax({type:"GET",contentType:"application/json; charset=utf-8",url:String.format("{0}/{1}",t.spWebUrl,u.groupEndPointUri),success:function(i){var u;if(i.length>0){var r=[],e=n("<table/>").appendTo(s),f=n("<tr/>").appendTo(n("<thead />"));f.appendTo(e);u=n("<tbody/>");e.append(u);f.append(n("<th/>").text(ngText.NameVerb));n.each(i,function(t,i){var e=n("<tr/>"),o;for(u.append(e),e.append(n("<td/>").text(i.DisplayName)),o=0;o<r.length;++o)e.append(n("<td/>"));n.each(i.Settings,function(t,i){var o=n.inArray(i.DisplayName,r),s;o==-1&&(r.push(i.DisplayName),o=n.inArray(i.DisplayName,r),f.append(n("<th/>").text(i.DisplayName)),u.find("tr").append(n("<td/>")));s=n(e[0].cells[o+1]);checkbox=n("<input>").attr({type:"checkbox",name:"ngSetting_"+i.InternalName}).addClass("chk");i.Enabled&&checkbox.attr("checked","checked");s.attr("DiaplayName",i.DisplayName).append(checkbox)})});s.find("input").change(function(){var i=n(this),r=i.prop("name").replace("ngSetting_",""),u=String.format("{0}/{1}{2}",t.spWebUrl,r,i.is(":checked")?"":"x/");n.ajax({type:"POST",contentType:"application/json; charset=utf-8",url:u,success:function(){},error:function(n){alert(NGCustom.GetDefaultErrorMessage(n.status))}})})}else n('<li class="ngNoMaxWidth">'+ngText.NoCommunitiesMessage+"<\/li>").appendTo(s)},error:function(){}}),d=n.ajax({type:"GET",contentType:"application/json; charset=utf-8",url:String.format("{0}/{1}",t.spWebUrl,u.digestEndPointUri),success:function(r){var s,h,c,o,f,e;n.each(r.DigestSections,function(t,i){checkbox=n("<input>").attr({type:"checkbox",name:"ngDigestSetting_"+i.InternalName}).addClass("chk");i.Enabled&&checkbox.attr("checked","checked");n("<li/>").append(checkbox).append(n("<label>").append(i.DisplayName)).appendTo(v)});v.find("input").change(function(){var i=n(this),r=i.prop("name").replace("ngDigestSetting_",""),f=String.format("{0}/{1}Section/{2}/{3}/",t.spWebUrl,u.digestEndPointUri,r,i.is(":checked")?"Add":"Remove");n.ajax({type:"POST",contentType:"application/json; charset=utf-8",url:f,success:function(){},error:function(n){alert(NGCustom.GetDefaultErrorMessage(n.status))}})});s=n('<input type="radio" name="ngDigestSettingGroupSections" />').attr({value:"false"});n("<li/>").addClass("radio").append(s).append(n("<label>").append(ngText.DigestFormatChronological)).appendTo(l);h=n('<input type="radio" name="ngDigestSettingGroupSections" />').attr({value:"true"});n("<li/>").addClass("radio").append(h).append(n("<label>").append(ngText.DigestFormatGroup)).appendTo(l);r.DisplayGrouped?h.attr("checked","checked"):s.attr("checked","checked");l.find(":radio").change(function(){var i=n(this),r=String.format("{0}/{1}GroupSections/{2}/",t.spWebUrl,u.digestEndPointUri,i.attr("value"));n.ajax({type:"POST",contentType:"application/json; charset=utf-8",url:r,success:function(){},error:function(n){alert(NGCustom.GetDefaultErrorMessage(n.status))}})});try{for(c=r.SendTime.split(":"),o=new Date,o.setUTCHours(c[0]),f=new Date,f.setHours(0),e=n('<select data-placeholder="'+ngText.DigestSendTimePlaceholder+'" id="ngDigestSendTime" class="chosendelay" />'),n("<option>").prop({value:f.getUTCHours()+":00",selected:0==o.getHours()}).text("midnight").appendTo(e),i=1;i<24;++i)f.setHours(i),n("<option>").prop({value:f.getUTCHours()+":00",selected:i==o.getHours()}).text(i+":00").appendTo(e);e.appendTo(p);e.change(function(){var i=n(this),r=String.format("{0}/{1}Schedule/?timeUTC={2}",t.spWebUrl,u.digestEndPointUri,encodeURIComponent(i.attr("value")));n.ajax({type:"POST",contentType:"application/json; charset=utf-8",url:r,success:function(){},error:function(n){alert(NGCustom.GetDefaultErrorMessage(n.status))}})})}catch(a){}},error:function(){}});f.append(c).append(e);n.when(b,k,d).done(function(){n("<h3 />").addClass("head subhead").text(ngText.CommunitySpheresTitle).append(n("<span/>").addClass("spriteStream")).appendTo(o);o.append(s);f.find(".ngTabs li").unbind("click").on("click",function(t){n(this).parent().children().removeClass("active");n(this).addClass("active");f.find("h3.head").filter(".down").removeClass("down").next().toggle();f.find(".ngTabContent").hide().filter(n(this).prop("ngTabContent")).show();var i=n(n(this).prop("ngTabContent")).find("h3.head");i.unbind("click").on("click",function(t){n(this).hasClass("down")?n(this).removeClass("down").next().toggle():(i.filter(".down").removeClass("down").next().toggle(),n(this).addClass("down").next().toggle());t.preventDefault()}).next().hide();i.first().trigger("click");t.preventDefault()}).first().trigger("click");n(h.settingsContainer).empty().append(f);n().chosen&&n("#ngDigestSendTime").chosen({disable_search_threshold:9999});n(h.settingsContainer).find('input[name="ngSetting_notification_emails"]').change(function(){var t=n(this);t.parent().find("div").first().show()})})}};n.fn.ngsettings=function(t){if(u[t])return u[t].apply(this,Array.prototype.slice.call(arguments,1));if(typeof t!="object"&&t)n.error("Method "+t+" does not exist on jQuery.NGCustom.Settings");else return u.init.apply(this,arguments)};n.fn.ngsettings.defaults={parent:"#ngSettings",settingsContainer:"#ngSettingsContainer",dialogButtonContainer:".ui-dialog-buttonset",spWebUrl:t.spWebUrl,subscriptionsAllowed:null,dialogWidth:700}}(jQuery,window)});
/*
